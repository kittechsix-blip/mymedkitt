...
let spotlightInput: HTMLInputElement | null = null;
let spotlightResults: HTMLElement | null = null;
let selectedIndex = -1;
...
export function closeSpotlight(): void {
  if (!isOpen || !spotlightOverlay) return;
  isOpen = false;
...
export function initSpotlightShortcut(): void {
