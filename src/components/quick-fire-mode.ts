...
export function isQuickFireMode(): boolean {
  return localStorage.getItem(STORAGE_KEY) === 'true';
}

/** Toggle quick fire mode */
export function toggleQuickFireMode(): boolean {
...
export function renderQuickFireToggle(): HTMLElement {
