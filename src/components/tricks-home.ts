...
interface FlatTrick extends TrickListItem {
  specialtyId: string;
...
function openTrick(infoPageId: string, anchorId: string): void {
...
function trickRow(title: string, blurb: string, specialtyLabel: string | null, onClick: () => void): HTMLButtonElement {
...
// ===================================================================
export function renderTricksHome(container: HTMLElement): void {
  container.innerHTML = '';
  ...
  const renderResults = (q: string): void => {
...
// ===================================================================
export function renderTricksSpecialty(container: HTMLElement, specialtyId: string, anchorId?: string): void {
  container.innerHTML = '';
