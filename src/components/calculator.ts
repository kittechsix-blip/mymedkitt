...
// Detailed anatomical adult body - front view (E-burn style)
// Includes head with features, torso with muscle definition, arms with hands, legs with feet
const ADULT_BODY_FRONT_PATH = `
M65,5
C56,5 50,12 50,22 C50,30 54,36 60,40 L60,45 L70,45 L70,40 C76,36 80,30 80,22 C80,12 74,5 65,5 Z
M60,46 L60,52 C48,55 42,62 42,72 L42,120
L32,124 C26,126 22,132 22,140 L22,175 C22,180 24,184 28,186 L36,190
C32,205 26,235 22,260 L22,268 C22,272 25,275 30,275 L42,272 L44,195
L46,195 L46,290 C44,320 42,355 42,390 C42,410 44,430 48,445 L48,478
C48,486 52,492 58,492 L62,492 L62,445 C60,430 58,410 58,390 C58,360 60,330 62,300
L68,300 C70,330 72,360 72,390 C72,410 70,430 68,445 L68,492 L72,492
C78,492 82,486 82,478 L82,445 C86,430 88,410 88,390 C88,355 86,320 84,290
L84,195 L86,195 L88,272 L100,275 C105,275 108,272 108,268 L108,260
C104,235 98,205 94,190 L102,186 C106,184 108,180 108,175 L108,140
C108,132 104,126 98,124 L88,120 L88,72 C88,62 82,55 70,52 L70,46 Z
`;
...
// Pediatric body (larger head, shorter limbs, chubbier proportions)
const PEDS_BODY_FRONT_PATH = `
M65,4
C52,4 44,14 44,28 C44,40 50,50 58,55 L58,60 L72,60 L72,55 C80,50 86,40 86,28 C86,14 78,4 65,4 Z
M58,62 L58,68 C44,72 38,82 38,94 L38,135
L28,140 C22,142 18,150 18,160 L18,195 C18,202 20,208 26,210 L34,215
C30,232 24,262 20,290 L20,300 C20,306 24,310 30,310 L44,306 L46,220
L48,220 L48,320 C46,352 44,385 44,415 C44,438 46,458 50,475 L50,510
C50,520 54,528 62,528 L68,528 C76,528 80,520 80,510 L80,475
C84,458 86,438 86,415 C86,385 84,352 82,320 L82,220 L84,220 L86,306
L100,310 C106,310 110,306 110,300 L110,290 C106,262 100,232 96,215
L104,210 C110,208 112,202 112,195 L112,160 C112,150 108,142 102,140
L92,135 L92,94 C92,82 86,72 72,68 L72,62 Z
`;
...
function buildEburnPainter(
  ...
  // Full-width canvas for single body view - sized to fit phone screens
  const CANVAS_WIDTH = 300;
  const CANVAS_HEIGHT = 540;
  const SVG_VIEWBOX_WIDTH = 130;
  const SVG_VIEWBOX_HEIGHT = calculatorType === 'peds' ? 540 : 500;
