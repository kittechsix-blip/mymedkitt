...
export const ELECTROCUTION_NODES: DecisionNode[] = [
...
export const ELECTROCUTION_CITATIONS: Citation[] = [
  ...
  { num: 5, text: 'Beyene R (content expert). Electrical Injury Practice Management Guideline. Vanderbilt University Medical Center Burn Center. Revised July 2026 (review July 2028). https://www.vumc.org/burn/sites/default/files/public_files/Protocols/Electrical-Injury-July-2026.pdf' },
