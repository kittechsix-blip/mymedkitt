...
export const INTUSSUSCEPTION_CITATIONS: Citation[] = [
...
export const INTUSSUSCEPTION_CRITICAL_ACTIONS: CriticalAction[] = [
...
export const INTUSSUSCEPTION_NODES: DecisionNode[] = [
