...
export type Citation = { num: number; text: string };
...

  {
    ...
    treatment: {
      ...
      pcnAllergy: {
        ...
        frequency: 'Daily',
        duration: '10-14 days',
        notes: 'Limited data. Desensitization to PCN preferred if possible. CDC 2021: ceftriaxone 1-2 g IM/IV daily x 10-14 days.',
      },
...

  {
    ...
    treatment: {
      ...
      pcnAllergy: {
        ...
        frequency: 'Daily',
        duration: '10-14 days',
        notes: 'Limited data. Desensitization to PCN preferred. CDC 2021: ceftriaxone 1-2 g IM/IV daily x 10-14 days.',
      },
