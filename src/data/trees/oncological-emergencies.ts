...
export const ONCOLOGICAL_EMERGENCIES_NODES: DecisionNode[] = [
...

  {
    ...
    summary: 'HCM: NS 200-300 mL/hr + calcitonin 4 IU/kg q12h (rapid bridge) + denosumab 120 SC (Endo 2022 first-line) OR zoledronic acid 4 mg IV; avoid loop diuretics',
  },
...

  {
    ...
    body: '**Mortality 25-50%.** Suspect with any new chest pain, dyspnea, arrhythmia, or troponin elevation in ICI-treated patient. [28][29][31]\n\n**Workup:**\n• Troponin (high-sensitivity)\n• BNP\n• ECG (any new conduction abnormality is concerning)\n• Echocardiogram\n• Cardiac MRI if hemodynamically stable\n• **Endomyocardial biopsy** = definitive diagnosis\n• ID workup to rule out viral myocarditis\n\n**Management:**\n• **ICU admission immediately**\n• **[Methylprednisolone](#/drug/methylprednisolone/irae) 500-1000 mg IV daily × 3-5 days** (ESMO 2022; pulse) — earlier initiation correlates with lower MACE; taper after troponin <50% peak\n• **Steroid-refractory (≥50% are refractory): abatacept 10 mg/kg IV is the preferred second-line** [36] (CTLA4-Ig; emerging RCT evidence including phase III NCT05335928); ± **ruxolitinib** in fulminant disease — combined regimen showed mortality 3% vs 60% in early prospective study [36]\n• Other options if abatacept unavailable: mycophenolate 1g BID, IVIG, plasmapheresis, alemtuzumab; **avoid infliximab — increases mortality in CHF**\n• Anti-arrhythmics, mechanical support (IABP, ECMO) as needed\n• **Permanent ICI discontinuation**\n• **Cardiology consult immediately**\n\n**Concurrent myasthenia + myositis** can occur — check CK, AChR antibodies, exam for weakness/ptosis.',
    recommendation: '**ICI myocarditis: ICU + methylpred 500-1000 mg IV daily x 3-5d (start within 24h) + cards consult; abatacept 10 mg/kg if steroid-refractory (avoid infliximab in CHF); permanent ICI d/c; check CK + AChR Ab for triple syndrome.**',
    confidence: 'definitive',
    citation: [28, 29, 31, 36],
    summary: 'ICI myocarditis: 25-50% mortality; trop + ECG + echo + MRI + biopsy; ICU + methylpred 500-1000 mg IV x3-5d (early!); abatacept if refractory; permanent d/c',
    safetyLevel: 'critical',
  },
...
export const ONCOLOGICAL_EMERGENCIES_CITATIONS: Citation[] = [
  ...
  { num: 33, text: 'Pérez Fidalgo JA, García Fabregat L, Cervantes A, Margulies A, Vidall C, Roila F; ESMO Guidelines Working Group. Management of chemotherapy extravasation: ESMO-EONS Clinical Practice Guidelines. Ann Oncol. 2012;23 Suppl 7:vii167-73. (Dexrazoxane for anthracycline; hyaluronidase for vinca; DMSO for mitomycin.)' },
  { num: 34, text: 'Pelgrims J, De Vos F, Van den Brande J, Schrijvers D, Prové A, Vermorken JB. Methylene blue in the treatment and prevention of ifosfamide-induced encephalopathy: report of 12 cases and a review of the literature. Br J Cancer. 2000;82(2):291-294.' },
  { num: 35, text: 'Sanz MA, Fenaux P, Tallman MS, et al. Management of acute promyelocytic leukemia: updated recommendations from an expert panel of the European LeukemiaNet (PETHEMA). Blood. 2019;133(15):1630-1643. (No leukapheresis in APL — precipitates DIC; start ATRA immediately on clinical suspicion.)' },
  { num: 36, text: 'Salem JE, Bretagne M, Abbar B, et al. Abatacept/ruxolitinib and screening for concomitant respiratory muscle failure to mitigate fatality of immune-checkpoint inhibitor myocarditis. Cancer Discov. 2023;13(5):1100-1115. (Abatacept 10 mg/kg + ruxolitinib in steroid-refractory ICI myocarditis; mortality 3% vs 60% retrospective comparison.)' },
];
