...
export const BRUGADA_SYNDROME_NODES: DecisionNode[] = [
  // ===================================================================
  ...
  // ===================================================================
  {
    ...
    images: [
      { src: 'images/brugada/brugada-type1-ecgpedia.png', alt: '12-lead ECG showing Brugada Type 1 coved ST elevation pattern', caption: 'Brugada Type 1 pattern: coved ST elevation in right precordial leads. CardioNetworks ECGpedia / P.G. Postema, CC BY-SA 3.0, Wikimedia Commons.' },
      { src: 'images/brugada/brugada-type2-ecgpedia.png', alt: '12-lead ECG showing Brugada Type 2 saddleback ST elevation pattern', caption: 'Brugada Type 2 saddleback pattern: suggestive, not diagnostic without conversion to Type 1. CardioNetworks ECGpedia, CC BY-SA 3.0, Wikimedia Commons.' },
      { src: 'images/brugada/brugada-ecg-patterns.jpg', alt: 'Brugada syndrome ECG pattern in precordial leads V1 V2 and V3', caption: 'Typical Type 1 Brugada pattern in V1-V3. PeaBrainC, CC BY-SA 4.0, Wikimedia Commons.' },
    ],
    citation: [2, 3],
    calculatorLinks: [
      { id: 'brugada-shanghai', label: 'Shanghai Score' },
...
export const BRUGADA_SYNDROME_CRITICAL_ACTIONS = [
  ...
  { text: 'Isoproterenol for VF storm; treat fever, stop triggers, correct electrolytes.', nodeId: 'brugada-storm' },
  { text: 'Avoid sodium channel blockers and other high-risk drugs; use the drug avoidance tool.', nodeId: 'brugada-drug-exposure' },
  { text: 'ICD for cardiac arrest survivors or Type 1 with arrhythmic syncope.', nodeId: 'brugada-icd-indication' },
...
export const BRUGADA_SYNDROME_CITATIONS: Citation[] = [
