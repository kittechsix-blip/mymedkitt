...
export const ANORECTAL_BLEEDING_HUB_NODES: DecisionNode[] = [
  // ============================================================
  // Module 1 — Sick Check
  // ============================================================
  {
...
export const ANORECTAL_BLEEDING_HUB_CRITICAL_ACTIONS = [
  ...
  { text: 'Large-volume hematochezia + instability \u2192 two large-bore IVs, type and cross, restrictive transfusion, exclude an upper source.', nodeId: 'arb-lgib-verdict' },
  { text: 'Melena / hematemesis / BUN:Cr >30 \u2192 treat as upper-GI bleed until excluded.', nodeId: 'arb-ugib-entry' },
  { text: 'Upper-GI source \u2192 IV PPI \u00B1 octreotide/ceftriaxone if cirrhotic, urgent endoscopy.', nodeId: 'arb-ugib-verdict' },
  { text: 'New rectal bleeding age \u226550 or any alarm feature \u2192 never clear as hemorrhoids alone; arrange colonoscopy.', nodeId: 'arb-malig-verdict' },
  { text: 'Anticoagulated bleeder \u2192 match reversal to the agent: 4-factor PCC + IV vitamin K (warfarin), idarucizumab (dabigatran), andexanet alfa or 4F-PCC (apixaban/rivaroxaban).', nodeId: 'arb-anticoag-verdict' },
  { text: 'Avoid empiric antibiotics if EHEC (Shiga-toxin) is suspected \u2014 they raise the HUS risk; check CBC/smear/renal function.', nodeId: 'arb-colitis-verdict' },
];

export const ANORECTAL_BLEEDING_HUB_CITATIONS: Citation[] = [
  { num: 1, text: 'Sabry AO, Goosenberg E, Dsouza R, Sood T. Rectal Bleeding. In: StatPearls [Internet]. Treasure Island (FL): StatPearls Publishing; 2026. PMID: 33085290. NOTE: tertiary, non-peer-reviewed reference text \u2014 used here for background framing only. Every clinical recommendation in this consult is independently supported by the peer-reviewed society guidelines cited below.' },
  { num: 2, text: 'Wilkins T, Baird C, Pearson AN, Schade RR. Diverticular bleeding. Am Fam Physician. 2009;80(9):977-983. PMID: 19873964. NOTE: narrative review, retained for background epidemiology; management recommendations follow ref 3 and ref 9.' },
  { num: 3, text: 'Sengupta N, Feuerstein JD, Jairath V, Shergill AK, Strate LL, Wong RJ, Wan D. Management of Patients With Acute Lower Gastrointestinal Bleeding: An Updated ACG Guideline. Am J Gastroenterol. 2023;118(2):208-231. PMID: 36735555. doi:10.14309/ajg.0000000000002130' },
  { num: 4, text: 'Laine L, Barkun AN, Saltzman JR, Martel M, Leontiadis GI. ACG Clinical Guideline: Upper Gastrointestinal and Ulcer Bleeding. Am J Gastroenterol. 2021;116(5):899-917. PMID: 33929377. doi:10.14309/ajg.0000000000001245' },
  { num: 5, text: 'Tomaselli GF, Mahaffey KW, Cuker A, et al. 2020 ACC Expert Consensus Decision Pathway on Management of Bleeding in Patients on Oral Anticoagulants: A Report of the American College of Cardiology Solution Set Oversight Committee. J Am Coll Cardiol. 2020;76(5):594-622. PMID: 32680646. doi:10.1016/j.jacc.2020.04.053 (Verified 2026-07-29 as the current ACC expert consensus decision pathway; not superseded.)' },
  { num: 6, text: 'Rex DK, Boland CR, Dominitz JA, et al. Colorectal Cancer Screening: Recommendations for Physicians and Patients from the U.S. Multi-Society Task Force on Colorectal Cancer. Am J Gastroenterol. 2017;112(7):1016-1030. PMID: 28555630. doi:10.1038/ajg.2017.174 (Age to start/stop screening updated by ref 19; see also ref 20.)' },
  { num: 7, text: 'Shane AL, Mody RK, Crump JA, et al. 2017 Infectious Diseases Society of America Clinical Practice Guidelines for the Diagnosis and Management of Infectious Diarrhea. Clin Infect Dis. 2017;65(12):e45-e80. PMID: 29053792. doi:10.1093/cid/cix669' },
  { num: 8, text: 'Hawkins AT, Davis BR, Bhama AR, et al. The American Society of Colon and Rectal Surgeons Clinical Practice Guidelines for the Management of Hemorrhoids. Dis Colon Rectum. 2024;67(5):614-623. PMID: 38294832. doi:10.1097/DCR.0000000000003276 (Supersedes Davis BR et al. Dis Colon Rectum. 2018;61(3):284-292.)' },
  { num: 9, text: 'Oakland K, Chadwick G, East JE, et al. Diagnosis and management of acute lower gastrointestinal bleeding: guidelines from the British Society of Gastroenterology. Gut. 2019;68(5):776-789. PMID: 30792244. doi:10.1136/gutjnl-2018-317807' },
  { num: 10, text: 'Oakland K, Jairath V, Uberoi R, et al. Derivation and validation of a novel risk score for safe discharge after acute lower gastrointestinal bleeding: a modelling study. Lancet Gastroenterol Hepatol. 2017;2(9):635-643. PMID: 28651935. doi:10.1016/S2468-1253(17)30150-4 (Primary derivation of the Oakland score.)' },
  { num: 11, text: 'Oakland K, Kothiwale S, Forehand T, et al. External Validation of the Oakland Score to Assess Safe Hospital Discharge Among Adult Patients With Acute Lower Gastrointestinal Bleeding in the US. JAMA Netw Open. 2020;3(7):e209630. PMID: 32633766. doi:10.1001/jamanetworkopen.2020.9630 (Multicenter US validation comparing the \u22648, \u22649 and \u226410 discharge thresholds; basis for the \u226410 cut-point used in this consult.)' },
  { num: 12, text: 'Brandt LJ, Feuerstadt P, Longstreth GF, Boley SJ; American College of Gastroenterology. ACG Clinical Guideline: Epidemiology, Risk Factors, Patterns of Presentation, Diagnosis, and Management of Colon Ischemia (CI). Am J Gastroenterol. 2015;110(1):18-44. PMID: 25559486. doi:10.1038/ajg.2014.395' },
  { num: 13, text: 'Johnson S, Lavergne V, Skinner AM, et al. Clinical Practice Guideline by the Infectious Diseases Society of America (IDSA) and Society for Healthcare Epidemiology of America (SHEA): 2021 Focused Update Guidelines on Management of Clostridioides difficile Infection in Adults. Clin Infect Dis. 2021;73(5):e1029-e1044. PMID: 34164674. doi:10.1093/cid/ciab549' },
  { num: 14, text: 'Kaplan DE, Ripoll C, Thiele M, et al. AASLD Practice Guidance on risk stratification and management of portal hypertension and varices in cirrhosis. Hepatology. 2024;79(5):1180-1211. PMID: 37870298. doi:10.1097/HEP.0000000000000647' },
  { num: 15, text: 'Srivastava A, Santagostino E, Dougall A, et al. WFH Guidelines for the Management of Hemophilia, 3rd edition. Haemophilia. 2020;26(Suppl 6):1-158. PMID: 32744769. doi:10.1111/hae.14046' },
  { num: 16, text: 'Bordeianou L, Paquette I, Johnson E, et al. Clinical Practice Guidelines for the Treatment of Rectal Prolapse. Dis Colon Rectum. 2017;60(11):1121-1131. PMID: 28991074. doi:10.1097/DCR.0000000000000889' },
  { num: 17, text: 'Davids JS, Hawkins AT, Bhama AR, et al. The American Society of Colon and Rectal Surgeons Clinical Practice Guidelines for the Management of Anal Fissures. Dis Colon Rectum. 2023;66(2):190-199. PMID: 36321851. doi:10.1097/DCR.0000000000002664' },
  { num: 18, text: 'Rubin DT, Ananthakrishnan AN, Siegel CA, Sauer BG, Long MD. ACG Clinical Guideline: Ulcerative Colitis in Adults. Am J Gastroenterol. 2019;114(3):384-413. PMID: 30840605. doi:10.14309/ajg.0000000000000152' },
  { num: 19, text: 'Patel SG, May FP, Anderson JC, et al. Updates on Age to Start and Stop Colorectal Cancer Screening: Recommendations From the U.S. Multi-Society Task Force on Colorectal Cancer. Am J Gastroenterol. 2022;117(1):57-69. PMID: 34962727. doi:10.14309/ajg.0000000000001548 (Average-risk screening now begins at age 45.)' },
  { num: 20, text: 'Shaukat A, Kahi CJ, Burke CA, Rabeneck L, Sauer BG, Rex DK. ACG Clinical Guidelines: Colorectal Cancer Screening 2021. Am J Gastroenterol. 2021;116(3):458-479. PMID: 33657038. doi:10.14309/ajg.0000000000001122' },
];
