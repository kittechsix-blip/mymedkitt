...
export const DFSA_WORKUP_NODES: DecisionNode[] = [
...

  {
    ...
    summary: 'Drug-facilitated sexual assault: time-sensitive evidence collection — compassionate, trauma-informed approach',
  },

  {
    ...
    summary: 'Clinical Red Flags for DFSA — review key clinical information before proceeding',
  },

  {
    ...
    summary: 'Medical Stability — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Medical Stabilization Required — determine disposition and follow-up plan based on clinical findings',
  },

  {
    ...
    summary: 'Time Since Assault — assess clinical status to guide next management decision',
  },
...

  {
    ...
    summary: 'Informed Consent Framework — review key clinical information before proceeding',
  },

  {
    ...
    summary: 'Consent for Forensic Examination? — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Exam Declined — Still Offer Services — review key clinical information before proceeding',
  },

  {
    ...
    summary: 'Consent for Specimen Collection? — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Consent for Injury Photography? — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Specimen Collection Declined — review key clinical information before proceeding',
  },
...

  {
    ...
    summary: 'Specimen Collection Priority — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'URGENT: < 6 Hour Collection — review key clinical information before proceeding',
  },

  {
    ...
    summary: '6-12 Hour Collection — review key clinical information before proceeding',
  },

  {
    ...
    summary: '12-72 Hour Collection — review key clinical information before proceeding',
  },

  {
    ...
    summary: '72 Hours — 5 Day Collection — review key clinical information before proceeding',
    skippable: true,
  },

  {
    ...
    summary: '> 5 Days Post-Assault — review key clinical information before proceeding',
  },
...

  {
    ...
    summary: 'Forensic Drug Panel — review key clinical information before proceeding',
  },

  {
    ...
    summary: 'Hospital Tox Screen in Parallel? — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Lab Ordering & Specimen Handling — review key clinical information before proceeding',
  },
...

  {
    ...
    summary: 'SANE Nurse Available? — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'SANE Nurse Handoff — review key clinical information before proceeding',
  },

  {
    ...
    summary: 'No SANE Available — Physician-Led Coordination — review key clinical information before proceeding',
    skippable: true,
  },

  {
    ...
    summary: 'Clothing & Physical Evidence — review key clinical information before proceeding',
    skippable: true,
  },

  {
    ...
    summary: 'Documentation Requirements — review key clinical information before proceeding',
  },
...

  {
    ...
    summary: 'Prophylaxis Overview — review key clinical information before proceeding',
  },

  {
    ...
    summary: 'STI Prophylaxis — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'STI Prophylaxis Ordered — determine disposition and follow-up plan based on clinical findings',
  },

  {
    ...
    summary: 'Pregnancy Risk? — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Emergency Contraception — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Emergency Contraception Ordered — determine disposition and follow-up plan based on clinical findings',
  },

  {
    ...
    summary: 'Hepatitis B Vaccination Status — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Initiate Hepatitis B Vaccine — review key clinical information before proceeding',
  },

  {
    ...
    summary: 'HIV PEP Assessment — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'HIV PEP — Initiate Now — review key clinical information before proceeding',
  },

  {
    ...
    summary: 'Safe Discharge Assessment — assess clinical status to guide next management decision',
  },

  {
    ...
    summary: 'Unsafe Discharge — Safety Resources — review key clinical information before proceeding',
  },
