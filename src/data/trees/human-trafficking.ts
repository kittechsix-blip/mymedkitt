...
export const HUMAN_TRAFFICKING_NODES: DecisionNode[] = [
...

  {
    ...
    body: '**MINORS: Mandatory reporting applies**\n\n**Key points:**\n• ANY commercial sex involving a minor is trafficking (no force/fraud/coercion required)\n• **Mandatory reporting to CPS/law enforcement**\n• Does not require patient consent\n• Document thoroughly\n\n**Process:**\n1. Notify social work immediately\n2. Contact CPS hotline\n3. Law enforcement notification (may be same call)\n4. Keep child safe in hospital\n5. Do NOT release to suspected trafficker\n\n**If trafficker is parent/guardian:**\n• CPS involvement essential\n• May need to involve security/LE to prevent removal\n• Hospital can refuse to release if safety concern\n\n**Basis and jurisdictional scope:** Federal law (Trafficking Victims Protection Act, 22 U.S.C. \u00A7 7102) defines any commercial sex act involving a person under 18 as trafficking. The reporting duty itself is created by STATE child-abuse and trafficking statutes: which agency must be notified, in what timeframe, and by whom varies by state and by the patient\'s age. Confirm your own state statute and your hospital policy before acting on this node. [8][9][10][11]',
    citation: [8, 9, 10, 11],
...

  {
    ...
    body: '**Minor trafficking victim:**\n\n**Required actions:**\n• CPS notification (mandatory)\n• Law enforcement notification\n• **Do NOT release to suspected trafficker**\n\n**Process:**\n1. Keep child safe in hospital\n2. CPS takes custody\n3. Coordinate with law enforcement\n4. Advocate involvement if available\n5. Trauma-informed care throughout\n\n**Documentation critical:**\n• Detailed history\n• Physical findings\n• Photographs (with consent if possible)\n• All communications with CPS/LE\n\n**Basis and jurisdictional scope:** The under-18 commercial-sex provision is federal (22 U.S.C. \u00A7 7102), but the mandatory-report duty, the receiving agency, and the reporting timeframe are set by STATE statute and vary by jurisdiction. Verify your state\'s requirement and your hospital protocol. [8][9][10][11]',
...
export const HUMAN_TRAFFICKING_CITATIONS: Citation[] = [
  { num: 1, text: 'HEAL Trafficking and Hope for Justice. Protocol Toolkit for Developing a Response to Victims of Human Trafficking in Health Care Settings. Expert-consensus toolkit (not peer-reviewed); first released 2017, periodically updated. https://www.healtrafficking.org/resources/protocol-toolkit' },
  { num: 2, text: 'American College of Emergency Physicians. Policy Statement: Human Trafficking. Approved by the ACEP Board of Directors. https://www.acep.org/patient-care/policy-statements/human-trafficking (the ACEP-hosted PDF sits behind a member sign-in, so the exact approval/revision date line could not be independently verified for this citation; the peer-reviewed ACEP-authored companion in the primary literature is ref 6).' },
  { num: 3, text: 'National Human Trafficking Hotline (Polaris Project). Hotline Statistics. Tertiary source; hotline-contact counts are not population prevalence estimates. https://humantraffickinghotline.org/en/statistics' },
  { num: 4, text: 'Lederer LJ, Wetzel CA. The Health Consequences of Sex Trafficking and Their Implications for Identifying Victims in Healthcare Facilities. Annals of Health Law. 2014;23(1):61-91. Law review, not PubMed-indexed. https://lawecommons.luc.edu/annals/vol23/iss1/5' },
  { num: 5, text: 'UpToDate. Human trafficking: identification and care of victims in health care settings. PROPRIETARY TERTIARY SOURCE - subscription-only and continuously revised, so it cannot be independently reviewed without a UpToDate license. Primary-literature equivalents for the same recommendations are refs 6, 7, and 10.' },
  { num: 6, text: 'Shandro J, Chisolm-Straker M, Duber HC, et al. Human Trafficking: A Guide to Identification and Approach for the Emergency Physician. Ann Emerg Med. 2016;68(4):501-508.e1. PMID: 27130802' },
  { num: 7, text: 'Chisolm-Straker M, Singer E, Strong D, et al. Validation of a screening tool for labor and sex trafficking among emergency department patients. J Am Coll Emerg Physicians Open. 2021;2(5):e12558. PMID: 34667976' },
  { num: 8, text: 'English A. Mandatory Reporting of Human Trafficking: Potential Benefits and Risks of Harm. AMA J Ethics. 2017;19(1):54-62. PMID: 28107156. Basis for the point that trafficking-related reporting duties are state-specific and vary by patient age and jurisdiction.' },
  { num: 9, text: 'Geiderman JM, Marco CA. Mandatory and permissive reporting laws: obligations, challenges, moral dilemmas, and opportunities. J Am Coll Emerg Physicians Open. 2020;1(1):38-45. PMID: 33000012' },
  { num: 10, text: 'Bachrach L, Truschel L, Chisolm-Straker M. Human trafficking of children and adolescents: recognition and response in the emergency department. Pediatr Emerg Med Pract. 2022;19(7):1-24. PMID: 35737593' },
  { num: 11, text: 'Trafficking Victims Protection Act of 2000, 22 U.S.C. \u00A7 7102 - statutory definitions, including "severe forms of trafficking in persons" and the under-18 commercial sex provision. https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title22-section7102' },
];
