...
export const ACUTE_AGITATION_NODES: DecisionNode[] = [
...

  {
    ...
    body: '**High-threat situation — rapid control essential**\n\n**Physiology:** Hyperdopaminergic + hyperthermia + rhabdomyolysis risk\n\n**Treatment priorities:**\n1. **Aggressive cooling** if hyperthermic (>38.5°C)\n2. **Benzodiazepines** when feasible — midazolam or lorazepam\n3. **Ketamine** if immediate violent threat, severe hyperthermia preventing care, or failed benzodiazepines\n4. **Avoid antipsychotics alone** — can worsen hyperthermia\n\n**Monitor for:**\n• Rhabdomyolysis (CK, dark urine)\n• Cardiac arrhythmias\n• Acute kidney injury',
    citation: [1, 5],
    next: 'agit-med-choice',
    summary: 'Stimulant intoxication — cooling + benzodiazepines when feasible; ketamine for immediate high-threat or failed benzos.',
    safetyLevel: 'critical',
  },
...

  {
    ...
    body: '**Primary psychosis / mania:**\n\n**Preferred agents:**\n• Droperidol + midazolam when rapid sedation is needed\n• Ziprasidone + midazolam as an atypical antipsychotic combo option\n• Haloperidol + lorazepam when local practice favors it\n• Olanzapine IM alone when antipsychotic monotherapy is appropriate\n\n**Avoid:** IM olanzapine with parenteral benzodiazepines (IM/IV). If both are needed, separate per local protocol and monitor airway/respirations closely.',
    citation: [1, 7],
    next: 'agit-med-choice',
    summary: 'Primary psychiatric — droperidol + midazolam fastest. Olanzapine IM should not be paired with parenteral benzodiazepines.',
  },
...

  {
    ...
    body: '**For primary psychiatric agitation:**\n\n**Option 1 — Droperidol + Midazolam:**\n• Droperidol 5 mg IM/IV + Midazolam 5 mg IM/IV\n• Fastest evidence-supported combination for severe agitation\n\n**Option 2 — Ziprasidone + Midazolam:**\n• Ziprasidone 20 mg IM + Midazolam 5 mg IM\n• Onset: 15-20 min\n\n**Option 3 — Haloperidol + Lorazepam:**\n• Haloperidol 5 mg IM + Lorazepam 2 mg IM\n• Onset: 30-45 min (slower)\n• Add diphenhydramine 25-50 mg only when EPS risk is high\n\n**Do NOT combine:** IM olanzapine with parenteral benzodiazepines (IM/IV). Use olanzapine IM as monotherapy or separate per local protocol with close respiratory monitoring.',
    citation: [1, 7],
    next: 'agit-reassess',
    summary: 'Droperidol + midazolam preferred. Avoid IM olanzapine with parenteral benzodiazepines.',
  },
...

  {
    ...
    body: '**Hyperactive delirium with hyperthermia — HIGH MORTALITY**\n\n**Recognition:**\n• Disoriented + combative + altered\n• Adrenergic overdrive (tachycardia, hypertension)\n• Hyperthermia (>40°C)\n• Often: stimulant use (cocaine, meth)\n\n**Immediate management:**\n1. **Aggressive cooling** — ice packs, cold fluids, evaporative\n2. **Rapid sedation** — benzodiazepines when feasible; ketamine 5 mg/kg IM if immediate safety threat or failed benzos\n3. **Large-bore IV × 2** — prepare for massive hydration\n4. **Continuous monitoring** — cardiac, pulse ox, capnography\n5. **Minimal physical restraint** — prioritize chemical control and avoid prone restraint\n\n**Complications:**\n• Sudden cardiac arrest\n• Rhabdomyolysis → AKI\n• Extreme hyperthermia',
    citation: [1, 5, 9],
    next: 'agit-workup',
    summary: 'Hyperactive delirium = high mortality. Aggressive cooling, rapid sedation, hydration, and close monitoring.',
    safetyLevel: 'critical',
  },
...
export const ACUTE_AGITATION_CITATIONS: Citation[] = [
  { num: 1, text: 'ACEP Clinical Policy: Critical Issues in the Evaluation and Management of Adult Patients Presenting to the Emergency Department With Severe Agitation. Ann Emerg Med. 2024;83:e1-e30.' },
  ...
  { num: 9, text: 'ACEP. ACEP Reaffirms Positions on Hyperactive Delirium. 2023; ACMT. Position Statement: End the Use of the Term "Excited Delirium." J Med Toxicol. 2023;19(3):310-312.' },
];
