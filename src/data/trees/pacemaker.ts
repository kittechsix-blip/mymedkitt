...
export const PACEMAKER_CRITICAL_ACTIONS: CriticalAction[] = [
...
export const PACEMAKER_NODES: DecisionNode[] = [
...
export const PACEMAKER_CITATIONS: Citation[] = [
