...
export const AACG_NODES: DecisionNode[] = [
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        notes: 'Avoid in asthma, severe COPD, bradycardia, heart block, decompensated CHF',
      },
      alternative: {
      ...
      adjunct: {
        ...
        notes: 'Caution with sulfa allergy, renal/hepatic disease, hypokalemia',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        dose: '4-8mg',
        route: 'IV',
        frequency: 'Once, then PRN',
        duration: 'As needed',
        notes: 'Nausea is prominent in AACG. Control nausea early to enable PO medications.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        drug: 'Acetazolamide',
        dose: '500mg',
        route: 'IV (preferred) or PO',
        frequency: 'Once initially',
        duration: 'Single dose; may continue 250mg PO q6h for maintenance',
        notes: 'Use caution with sulfa allergy (cross-reactivity rare). Avoid in severe renal/hepatic disease, hypokalemia.',
      },
      adjunct: {
        drug: 'Timolol 0.5%',
        dose: '1 drop',
        route: 'Topical',
        frequency: 'q15-30min x 2-3 doses, then BID',
        duration: 'Until IOP controlled',
        notes: 'Avoid in asthma, severe COPD, bradycardia, heart block, decompensated CHF',
      },
      adjunct2: {
        drug: 'Brimonidine 0.15%',
        dose: '1 drop',
        route: 'Topical',
        frequency: 'q15min x 2-3 doses, then TID',
        duration: 'Until IOP controlled',
      },
      alternative: {
        drug: 'Apraclonidine 0.5-1%',
        dose: '1 drop',
        route: 'Topical',
        frequency: 'q15min x 2-3 doses',
        duration: 'Until IOP controlled',
        notes: 'Alternative to brimonidine',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        drug: 'Mannitol 20%',
        dose: '1-2 g/kg (70kg = 350-700mL)',
        route: 'IV',
        frequency: 'Once over 20-30 minutes',
        duration: 'Single dose',
        notes: 'Avoid in CHF, renal failure, severe dehydration. Consider Foley for large volumes. Check electrolytes.',
      },
      alternative: {
        drug: 'Glycerol',
        dose: '1 mL/kg',
        route: 'PO (mix with cold juice)',
        frequency: 'Once',
        duration: 'Single dose',
        notes: 'Avoid in diabetes (high caloric content). Use if IV not available.',
      },
      pcnAllergy: {
        drug: 'Isosorbide',
        dose: '1.5 g/kg',
        ...
        frequency: 'Once',
        duration: 'Single dose',
        notes: 'Less commonly used alternative osmotic agent.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        drug: 'Pilocarpine 2%',
        dose: '1 drop',
        route: 'Topical to affected eye',
        frequency: 'Repeat in 15 minutes x 2 doses total',
        duration: '2 doses',
        notes: 'WAIT until IOP <40 mmHg. Ineffective at higher IOP due to ischemic iris sphincter. NOT effective for drug-induced (sulfa) angle closure.',
      },
      alternative: {
        drug: 'Pilocarpine 4%',
        dose: '1 drop',
        ...
        frequency: 'Repeat in 15 minutes x 2 doses total',
        duration: '2 doses',
        notes: 'Higher concentration option. Same precautions apply.',
      },
      prophylaxis: {
        drug: 'Pilocarpine 2%',
        dose: '1 drop',
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        route: 'Topical',
        frequency: 'q1-4h',
        duration: 'Until laser iridotomy',
        notes: 'Reduces inflammation from IOP spike',
      },
      adjunct: {
        drug: 'Ketorolac 0.5%',
        dose: '1 drop',
        ...
        notes: 'Administer after cornea assessed',
      },
      adjunct2: {
        drug: 'Ondansetron',
        dose: '4-8mg',
        ...
        frequency: 'PRN',
        duration: 'As needed',
        notes: 'For nausea/vomiting control',
      },
      maintenance: {
        drug: 'Timolol 0.5% + Brimonidine 0.15% + Acetazolamide',
        dose: 'Timolol 1 drop / Brimonidine 1 drop / Acetazolamide 250mg',
        route: 'Topical / Topical / PO',
        frequency: 'BID / TID / q6h',
        duration: 'Until laser iridotomy',
        notes: 'Continue all IOP-lowering agents as maintenance therapy',
      },
...

  {
    ...
    treatment: {
      ...
      adjunct3: {
        ...
        frequency: 'q6h',
        duration: 'Until laser iridotomy',
        notes: 'If tolerated. Caution with sulfa allergy.',
      },
      monitoring: 'Follow-up within 24 hours mandatory. Return for increased pain, vision loss, nausea/vomiting.',
    },
    options: [
      {
...

  {
    ...
    treatment: {
      ...
      alternative: {
        ...
        frequency: 'q6h',
        duration: 'Until laser iridotomy',
        notes: 'Optional. Caution with sulfa allergy.',
      },
      monitoring: 'Ophthalmology follow-up within 24 hours mandatory. Return for increasing pain, worsening vision, halos, nausea/vomiting, or headache.',
    },
    options: [
      {
        label: 'Complete — Return to Start',
