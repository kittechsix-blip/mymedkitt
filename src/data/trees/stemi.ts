...
export const STEMI_NODES: DecisionNode[] = [
...

  {
    ...
    body: 'Load with ONE P2Y12 inhibitor before or at time of PCI. Discuss with interventional cardiologist.\n\n**[Prasugrel](#/drug/prasugrel/acs)** 60 mg loading \u2192 10 mg daily\n\u2022 More potent platelet inhibition, lower ischemic events vs clopidogrel; ticagrelor and prasugrel are Class I equivalents (no preference) in 2025 ACC/AHA [18][23]\n\u2022 **CONTRAINDICATED:** prior stroke/TIA \u2014 basis: TRITON-TIMI 38 (n=13,608), where patients with prior stroke/TIA had net clinical harm with prasugrel [37]\n\u2022 **No benefit:** age >75y, weight <60 kg \u2014 basis: TRITON-TIMI 38 prespecified subgroups showing no net clinical benefit [37]\n\n**[Ticagrelor](#/drug/ticagrelor/acs)** 180 mg loading \u2192 90 mg BID\n\u2022 Fewer stent thromboses and lower death rate vs clopidogrel [19]\n\u2022 Higher stroke/ICH risk vs clopidogrel [19]\n\n**[Clopidogrel](#/drug/clopidogrel/acs)** 600 mg loading \u2192 75 mg daily\n\u2022 Variable metabolism (CYP2C19) [20]\n\u2022 Use if CI to prasugrel AND ticagrelor, or high bleeding risk [5][23]\n\n**2025 ACC/AHA update:** Ticagrelor AND prasugrel are now Class I without distinction in PCI-managed STEMI; clopidogrel is the recommended concurrent P2Y12 agent for fibrinolytic-managed STEMI. [5][23]',
    citation: [5, 18, 19, 20, 23, 37],
    treatment: {
      firstLine: {
        drug: 'Prasugrel',
...

  {
    ...
    module: 4,
    title: 'Primary PCI',
    body: '**Goal: First medical contact-to-device \u226490 minutes.**\n\n\u2022 Indicated for symptom onset <12 hours [5][23]\n\u2022 Between 12\u201324 hours: reasonable if clinical or ECG evidence of ongoing ischemia [5][23]\n\u2022 >24 hours, asymptomatic, stable: PCI NOT recommended (no benefit) \u2014 basis is the OAT trial, which found no reduction in death, reinfarction, or class IV heart failure with late PCI of a persistently occluded infarct artery 3\u201328 days post-MI [32]\n\n**Advantages over fibrinolysis:**\n\u2022 Higher infarct artery patency rates\n\u2022 Lower rates of recurrent ischemia, reinfarction, ICH, and death [22]\n\n**Potential complications:** access site problems, contrast reactions, reperfusion arrhythmias, stent thrombosis.\n\n**Reperfusion arrhythmias** are common after successful PCI \u2014 assess next.',
    citation: [5, 22, 23, 32],
...

  {
    ...
    body: '**Door-to-needle \u226430 minutes.** Fibrin-specific agents preferred.\n\nCheck [Fibrinolytic Contraindications](#/info/stemi-lytic-contraindications)\n\n**Agents** (see [Fibrinolytic Dosing](#/info/stemi-lytic-agents)):\n\u2022 [Tenecteplase](#/drug/tenecteplase/stemi) \u2014 single weight-based IV bolus (preferred)\n\u2022 [Alteplase](#/drug/alteplase/stemi) \u2014 accelerated 90-min regimen\n\u2022 [Reteplase](#/drug/reteplase/stemi) \u2014 10 + 10 unit double bolus\n\n**Age >75 years:** Consider half-dose tenecteplase (reduced ICH risk) \u2014 basis: STREAM-1 halved the TNK dose after excess ICH in patients \u226575y (3/42 [7.1%] before amendment vs 0/93 after), and STREAM-2 randomized patients \u226560y to half-dose TNK with preserved reperfusion efficacy; ACEP Level C also supports dose reduction in the elderly [21][23][33]\n\n**After fibrinolysis:** Transfer to PCI center. Angiography within 3\u201324 hours (NOT within first 2\u20133 hours). [5][8][23]\n\nAny contraindications to fibrinolysis?',
    citation: [5, 8, 21, 23, 33],
    treatment: {
      firstLine: {
        drug: 'Tenecteplase',
...

  {
    ...
    body: 'Cardiogenic shock complicates 5\u201310% of AMI. [26]\n\n**Immediate management:**\n\u2022 **PCI regardless of time from MI onset** (Class I) \u2014 basis: the SHOCK trial (n=302) showed a survival benefit for early revascularization vs initial medical stabilization by 6 months, sustained at 6 years [5][23][35]\n\u2022 Volume resuscitation if no pulmonary edema [5][23]\n\u2022 Vasopressors to maintain coronary perfusion (norepinephrine preferred) \u2014 basis: the OptimaCC randomized trial found epinephrine produced similar arterial pressure and cardiac index to norepinephrine but a higher incidence of refractory shock [36]\n\u2022 Consider mechanical circulatory support (IABP, Impella, ECMO) [5][23]\n\n**Do NOT withhold vasopressors** for fear of worsening ischemia \u2014 the goal is coronary perfusion until revascularization.\n\nIf at non-PCI center: **transfer immediately regardless of time delay.** [5][23]',
...

  {
    ...
    body: '**All STEMI patients are admitted** after reperfusion (PCI or fibrinolysis).\n\n**In-hospital management** (guideline-directed medical therapy \u2014 basis: 2025 ACC/AHA ACS guideline and 2013 ACCF/AHA STEMI guideline): [5][23]\n\u2022 Continuous cardiac monitoring for reperfusion arrhythmias\n\u2022 [Metoprolol](#/drug/metoprolol/acs) within 24h if no CI (HR, BP permitting) [5][23]\n\u2022 [Atorvastatin](#/drug/atorvastatin/acs) 80 mg (start immediately) [5][23]\n\u2022 ACE inhibitor/ARB within 24h if EF \u226440%, HTN, or diabetes [5][23]\n\u2022 DAPT: [Aspirin](#/drug/aspirin/acs) 81 mg + P2Y12 inhibitor \u00D7 12 months [5][23]\n\n**Goals of care discussions** should be held for elderly patients and those with severe comorbidities. DNR/POLST/advance directives do NOT necessarily preclude intervention. [29]\n\n**Cardiac rehabilitation** referral before discharge (25% reduction in CV mortality). [5][23]',
...
export const STEMI_CITATIONS: Citation[] = [
  { num: 1, text: 'Gokhroo RK, Ranwa BL, Kishor K, et al. Sweating: a Specific Predictor of ST-Segment Elevation Myocardial Infarction Among the Symptoms of Acute Coronary Syndrome (SWIMI Study Group). Clin Cardiol. 2016;39(2):90-95. doi:10.1002/clc.22498. PMID: 26695479.' },
  { num: 2, text: 'Fanaroff AC, Rymer JA, Goldstein SA, Simel DL, Newby LK. Does This Patient with Chest Pain Have Acute Coronary Syndrome? The Rational Clinical Examination Systematic Review. JAMA. 2015;314(18):1955-1965. doi:10.1001/jama.2015.12735. PMID: 26547467.' },
  { num: 3, text: 'Brieger D, Eagle KA, Goodman SG, et al. Acute Coronary Syndromes Without Chest Pain, an Underdiagnosed and Undertreated High-Risk Group: Insights from the Global Registry of Acute Coronary Events (GRACE). Chest. 2004;126(2):461-469. doi:10.1378/chest.126.2.461. PMID: 15302732.' },
  { num: 4, text: 'Thygesen K, Alpert JS, Jaffe AS, et al. Fourth Universal Definition of Myocardial Infarction (2018). Eur Heart J. 2019;40(3):237-269. doi:10.1093/eurheartj/ehy462. PMID: 30165617.' },
  { num: 5, text: 'O\u2019Gara PT, Kushner FG, Ascheim DD, et al. 2013 ACCF/AHA Guideline for the Management of ST-Elevation Myocardial Infarction. Circulation. 2013;127(4):e362-e425. doi:10.1161/CIR.0b013e3182742cf6. PMID: 23247304.' },
  { num: 6, text: 'Hassen GW, Talebi S, Fernaine G, Kalantari H. Lead aVL on Electrocardiogram: Emerging as Important Lead in Early Diagnosis of Myocardial Infarction? Am J Emerg Med. 2014;32(7):785-788. doi:10.1016/j.ajem.2014.02.038. PMID: 24792939.' },
  { num: 7, text: 'Wong C-K, White HD. Patients with Circumflex Occlusions Miss Out on Reperfusion: How to Recognize and Manage Them. Curr Opin Cardiol. 2012;27(4):327-330. doi:10.1097/HCO.0b013e32835482b7. PMID: 22565144.' },
  { num: 8, text: 'Ibanez B, James S, Agewall S, et al. 2017 ESC Guidelines for the Management of Acute Myocardial Infarction in Patients Presenting with ST-Segment Elevation. Eur Heart J. 2018;39(2):119-177. doi:10.1093/eurheartj/ehx393. PMID: 28886621.' },
  { num: 9, text: 'Smith SW, Dodd KW, Henry TD, Dvorak DM, Pearce LA. Diagnosis of STEMI in the Presence of Left Bundle Branch Block with the ST-Elevation to S-Wave Ratio in a Modified Sgarbossa Rule. Ann Emerg Med. 2012;60(6):766-776. doi:10.1016/j.annemergmed.2012.07.119. PMID: 22939607.' },
  { num: 10, text: 'Tabas JA, Rodriguez RM, Seligman HK, Goldschlager NF. Electrocardiographic Criteria for Detecting Acute Myocardial Infarction in Patients with Left Bundle Branch Block: A Meta-Analysis. Ann Emerg Med. 2008;52(4):329-336. doi:10.1016/j.annemergmed.2007.12.006. PMID: 18342992.' },
  { num: 11, text: 'Harhash AA, Huang JJ, Reddy S, et al. aVR ST Segment Elevation: Acute STEMI or Not? Incidence of an Acute Coronary Occlusion. Am J Med. 2019;132(5):622-630. doi:10.1016/j.amjmed.2018.12.021. PMID: 30639554.' },
  { num: 12, text: 'Tanguay A, Lebon J, Lau L, H\u00E9bert D, B\u00E9gin F. Detection of STEMI Using Prehospital Serial 12-Lead Electrocardiograms. Prehosp Emerg Care. 2018;22(4):419-426. doi:10.1080/10903127.2017.1399185. PMID: 29336652.' },
  { num: 13, text: 'Sabia P, Afrookteh A, Touchstone DA, Keller MW, Esquivel L, Kaul S. Value of Regional Wall Motion Abnormality in the Emergency Room Diagnosis of Acute Myocardial Infarction: A Prospective Study Using Two-Dimensional Echocardiography. Circulation. 1991;84(3 Suppl):I85-I92. PMID: 1884510.' },
  { num: 14, text: 'Lange RA, Hillis LD. Acute Pericarditis. N Engl J Med. 2004;351(21):2195-2202. doi:10.1056/NEJMcp041997. PMID: 15548780.' },
  { num: 15, text: 'Hofmann R, James SK, Jernberg T, et al. Oxygen Therapy in Suspected Acute Myocardial Infarction (DETO2X-AMI). N Engl J Med. 2017;377(13):1240-1249. doi:10.1056/NEJMoa1706222. PMID: 28844200.' },
  { num: 16, text: 'Meine TJ, Roe MT, Chen AY, et al. Association of Intravenous Morphine Use and Outcomes in Acute Coronary Syndromes: Results from the CRUSADE Quality Improvement Initiative. Am Heart J. 2005;149(6):1043-1049. doi:10.1016/j.ahj.2005.02.010. PMID: 15976786.' },
  { num: 17, text: 'Kubica J, Adamski P, Ostrowska M, et al. Morphine Delays and Attenuates Ticagrelor Exposure and Action in Patients with Myocardial Infarction: The Randomized, Double-Blind, Placebo-Controlled IMPRESSION Trial. Eur Heart J. 2016;37(3):245-252. doi:10.1093/eurheartj/ehv547. PMID: 26491112.' },
  { num: 18, text: 'Olier I, Sirker A, Hildick-Smith DJR, et al. Association of Different Antiplatelet Therapies with Mortality After Primary Percutaneous Coronary Intervention. Heart. 2018;104(20):1683-1690. doi:10.1136/heartjnl-2017-312366. PMID: 29437885.' },
  { num: 19, text: 'Wallentin L, Becker RC, Budaj A, et al. Ticagrelor versus Clopidogrel in Patients with Acute Coronary Syndromes (PLATO). N Engl J Med. 2009;361(11):1045-1057. doi:10.1056/NEJMoa0904327. PMID: 19717846.' },
  { num: 20, text: 'Koski R, Kennedy B. Comparative Review of Oral P2Y(12) Inhibitors. P T. 2018;43(6):352-357. PMID: 29896034. PMCID: PMC5969212.' },
  { num: 21, text: 'Promes SB, Glauser JM, Smith MD, et al.; American College of Emergency Physicians Clinical Policies Subcommittee. Clinical Policy: Emergency Department Management of Patients Needing Reperfusion Therapy for Acute ST-Segment Elevation Myocardial Infarction. Ann Emerg Med. 2017;70(5):724-739. doi:10.1016/j.annemergmed.2017.09.035. PMID: 29065990.' },
  { num: 22, text: 'Armstrong PW, Gershlick AH, Goldstein P, et al. Fibrinolysis or Primary PCI in ST-Segment Elevation Myocardial Infarction (STREAM). N Engl J Med. 2013;368(15):1379-1387. doi:10.1056/NEJMoa1301092. PMID: 23473396.' },
  { num: 23, text: 'Rao SV, O\u2019Donoghue ML, Ruel M, et al. 2025 ACC/AHA/ACEP/NAEMSP/SCAI Guideline for the Management of Patients with Acute Coronary Syndromes. J Am Coll Cardiol. 2025;85(22):2135-2237. doi:10.1016/j.jacc.2024.11.009. PMID: 40013746. Copublished in Circulation. 2025;151(13):e771-e862.' },
  { num: 24, text: 'Gildea TH, Levis JT. ECG Diagnosis: Accelerated Idioventricular Rhythm. Perm J. 2018;22:17-173. doi:10.7812/TPP/17-173. PMID: 29616912. PMCID: PMC5882183.' },
  { num: 25, text: 'Meine TJ, Al-Khatib SM, Alexander JH, et al. Incidence, Predictors, and Outcomes of High-Degree Atrioventricular Block Complicating Acute Myocardial Infarction Treated with Thrombolytic Therapy. Am Heart J. 2005;149(4):670-674. doi:10.1016/j.ahj.2004.07.035. PMID: 15990751.' },
  { num: 26, text: 'Vahdatpour C, Collins D, Goldberg S. Cardiogenic Shock. J Am Heart Assoc. 2019;8(8):e011991. doi:10.1161/JAHA.119.011991. PMID: 30947630.' },
  { num: 27, text: 'Kinch JW, Ryan TJ. Right Ventricular Infarction. N Engl J Med. 1994;330(17):1211-1217. doi:10.1056/NEJM199404283301707. PMID: 8139631.' },
  { num: 28, text: 'Mehta LS, Beckie TM, DeVon HA, et al. Acute Myocardial Infarction in Women: A Scientific Statement from the American Heart Association. Circulation. 2016;133(9):916-947. doi:10.1161/CIR.0000000000000351. PMID: 26811316.' },
  { num: 29, text: 'Engberding N, Wenger NK. Acute Coronary Syndromes in the Elderly. F1000Res. 2017;6:1791. doi:10.12688/f1000research.11064.1. PMID: 29043079.' },
  { num: 30, text: 'McCord J, Jneid H, Hollander JE, et al. Management of Cocaine-Associated Chest Pain and Myocardial Infarction: A Scientific Statement from the American Heart Association. Circulation. 2008;117(14):1897-1907. doi:10.1161/CIRCULATIONAHA.107.188950. PMID: 18347214.' },
  { num: 31, text: 'Yannopoulos D, Bartos JA, Aufderheide TP, et al. The Evolving Role of the Cardiac Catheterization Laboratory in the Management of Patients with Out-of-Hospital Cardiac Arrest: A Scientific Statement from the American Heart Association. Circulation. 2019;139(12):e530-e552. doi:10.1161/CIR.0000000000000630. PMID: 30760026.' },
  { num: 32, text: 'Hochman JS, Lamas GA, Buller CE, et al.; Occluded Artery Trial (OAT) Investigators. Coronary Intervention for Persistent Occlusion After Myocardial Infarction. N Engl J Med. 2006;355(23):2395-2407. doi:10.1056/NEJMoa066139. PMID: 17105759.' },
  { num: 33, text: 'Van de Werf F, Risti\u0107 AD, Averkov OV, et al.; STREAM-2 Investigators. STREAM-2: Half-Dose Tenecteplase or Primary Percutaneous Coronary Intervention in Older Patients with ST-Segment-Elevation Myocardial Infarction: A Randomized, Open-Label Trial. Circulation. 2023;148(9):753-764. doi:10.1161/CIRCULATIONAHA.123.064521. PMID: 37439219.' },
  { num: 34, text: 'Antman EM, Morrow DA, McCabe CH, et al.; ExTRACT-TIMI 25 Investigators. Enoxaparin versus Unfractionated Heparin with Fibrinolysis for ST-Elevation Myocardial Infarction. N Engl J Med. 2006;354(14):1477-1488. doi:10.1056/NEJMoa060898. PMID: 16537665.' },
  { num: 35, text: 'Hochman JS, Sleeper LA, Webb JG, et al.; SHOCK Investigators. Early Revascularization in Acute Myocardial Infarction Complicated by Cardiogenic Shock. N Engl J Med. 1999;341(9):625-634. doi:10.1056/NEJM199908263410901. PMID: 10460813.' },
  { num: 36, text: 'Levy B, Clere-Jehl R, Legras A, et al. Epinephrine versus Norepinephrine for Cardiogenic Shock After Acute Myocardial Infarction (OptimaCC). J Am Coll Cardiol. 2018;72(2):173-182. doi:10.1016/j.jacc.2018.04.051. PMID: 29976291.' },
  { num: 37, text: 'Wiviott SD, Braunwald E, McCabe CH, et al.; TRITON-TIMI 38 Investigators. Prasugrel versus Clopidogrel in Patients with Acute Coronary Syndromes. N Engl J Med. 2007;357(20):2001-2015. doi:10.1056/NEJMoa0706482. PMID: 17982182.' },
];
...
export const STEMI_CLINICAL_NOTES: string[] = [
