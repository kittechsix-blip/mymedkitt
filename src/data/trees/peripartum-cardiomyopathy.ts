...
export const PERIPARTUM_CARDIOMYOPATHY_NODES: DecisionNode[] = [
...

  {
    ...
    body: '**First-line postpartum - start immediately after delivery:**\n\n[Lisinopril](#/drug/lisinopril/heart failure) 2.5-5 mg daily, titrate to 20-40 mg daily\nOR\n[Enalapril](#/drug/enalapril/heart failure) 2.5 mg BID, titrate to 10-20 mg BID\n\n**Safe for breastfeeding:** Enalapril, captopril, benazepril (minimal breast milk transfer)\n\n**If ACE-intolerant (cough):**\n- ARB: [Losartan](#/drug/losartan/heart failure) 25-50 mg daily (titrate to 100 mg)\n\n**ARNI (Sacubitril/Valsartan):**\n- May consider if persistently low EF on max ACE/ARB\n- AVOID during pregnancy and breastfeeding\n\n**MRA (Spironolactone/Eplerenone):**\n- AVOID during pregnancy\n- Can use postpartum if not breastfeeding\n- [Spironolactone](#/drug/spironolactone/heart failure) 12.5-25 mg daily [1][2][8][9]',
    citation: [1, 2, 8, 9],
    next: 'ppcm-beta-blockers',
...

  {
    ...
    body: '**Planned delivery timing (antepartum PPCM):**\n- **Stable on therapy:** continue pregnancy with close MFM/cardiology co-management; aim for term delivery\n- **Severe LV dysfunction (LVEF <30%):** plan **early delivery around 37 weeks** — advanced PPCM carries a high risk of decompensation in late pregnancy and peripartum, and earlier planned delivery limits ongoing hemodynamic load\n- **Mode:** vaginal delivery with early epidural and assisted second stage is preferred when stable; reserve C-section for obstetric or hemodynamic indications\n- Decision and timing should be made jointly by OB/MFM, cardiology, and anesthesia [1][2]\n\n**Maternal stabilization takes priority, but urgent delivery may be necessary for both maternal and fetal benefit.**\n\n**Indications for urgent delivery:**\n- Requiring inotropes/vasopressors\n- Mechanical circulatory support needed\n- Maternal decompensation despite maximal therapy\n- Fetal distress\n\n**Considerations:**\n- C-section usually necessary (cannot tolerate labor)\n- General anesthesia may be required (hemodynamic instability)\n- Have blood products ready\n- ECMO standby if available\n\n**Perimortem C-section:**\n- If cardiac arrest: deliver within 4-5 minutes\n- May improve maternal resuscitation (relieves aortocaval compression)\n- Improves neonatal outcomes if >24 weeks\n\n**Post-delivery:** Expect hemodynamic shifts - be prepared for fluid bolus or increased pressors [1][2][3]',
    citation: [1, 2, 3],
    next: 'ppcm-postpartum-management',
