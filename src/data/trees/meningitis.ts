...
export const MENINGITIS_NODES: DecisionNode[] = [
  ...
  // ===================================================================
  {
    ...
    body: '**Immediately start empiric treatment:**\n\u2022 [Acyclovir](#/drug/acyclovir/encephalitis) 10 mg/kg IV q8h (HSV-1 most common endemic cause) [7,29]\n\u2022 PLUS empiric bacterial meningitis coverage (see next steps) [1,27]\n\n**CT is indicated** in all patients with focal deficits (mass lesion must be excluded before LP). [12,18,27]\n\n**MRI** is superior to CT for detecting encephalitis and can distinguish subtypes (e.g., HSV \u2192 temporal lobe involvement), but should not delay treatment. [8,29]\n\nHerpes simplex encephalitis mortality: **70% untreated \u2192 9% with acyclovir**. [7,15]',
    citation: [1, 7, 8, 12, 15, 18, 27, 29],
    treatment: {
      firstLine: {
        drug: 'Acyclovir',
        dose: '10 mg/kg',
  ...
  },
  {
    ...
    body: '**CRITICAL:** Start empiric antibiotics and [Dexamethasone](#/drug/dexamethasone/meningitis) BEFORE CT imaging. Do NOT delay treatment for any diagnostic test. [1,19,20,27]\n\nDelayed antibiotics correlate with disease progression and **increased mortality**. [19,20]\n\n**Diagnostic tradeoff (basis for treating first):** antibiotics given before LP reduce CSF culture sensitivity, but CSF PCR remains reliable for days afterward \u2014 so the diagnosis is not lost by treating first. [11,12]\n\nAfter CT:\n\u2022 If no mass lesion or contraindication \u2192 proceed to LP\n\u2022 If mass lesion found \u2192 neurosurgical consultation; continue empiric treatment\n\n**Blood cultures** should be drawn before antibiotics when possible (66% yield in ABM). [5]',
    citation: [1, 5, 11, 12, 19, 20, 27],
  ...
  },
  {
    ...
    body: 'Select based on age, immune status, and clinical context to determine empiric antimicrobial regimen. [1,24,27]',
    citation: [1, 24, 27],
    options: [
      {
  ...
  },
  {
    ...
    body: '**Targets:** *S. pneumoniae* (most common), *N. meningitidis* [2]\n\n**Regimen:**\n\u2022 [Ceftriaxone](#/drug/ceftriaxone/adult meningitis) 2g IV q12h (higher dose for CNS penetration) [1,24,27]\n\u2022 [Vancomycin](#/drug/vancomycin/meningitic adult) 15\u201320 mg/kg IV q8\u201312h (for cephalosporin-resistant pneumococci) [1,24,27]\n\u2022 [Dexamethasone](#/drug/dexamethasone/meningitis) 0.15 mg/kg IV q6h \u00d7 2\u20134 days [1,21,27]\n\n**Alternative:** [Meropenem](#/drug/meropenem/meningitis) 2g IV q8h if cephalosporin allergy or concern for multidrug-resistant organisms. [25,27]\n\n**Add [Acyclovir](#/drug/acyclovir/encephalitis)** 10 mg/kg IV q8h if ANY encephalitis features. [7,29]',
    citation: [1, 2, 7, 21, 24, 25, 27, 29],
    treatment: {
      firstLine: {
  ...
  },
  {
    ...
    body: '**Age \u226550, pregnant, or immunocompromised** patients are at increased risk for *L. monocytogenes* meningitis (mortality **17\u201330%**). [1,24]\n\nPregnant women are **10\u201320\u00d7 more likely** to contract listerial infections. Infection during pregnancy is often devastating for the fetus. [24]\n\n**Regimen:**\n\u2022 [Ceftriaxone](#/drug/ceftriaxone/adult meningitis) 2g IV q12h [1,27]\n\u2022 [Vancomycin](#/drug/vancomycin/meningitic adult) 15\u201320 mg/kg IV q8\u201312h [1,27]\n\u2022 [Ampicillin](#/drug/ampicillin/adult meningitis) 2g IV q4h (Listeria coverage) [1,24,27]\n\u2022 [Dexamethasone](#/drug/dexamethasone/meningitis) 0.15 mg/kg IV q6h \u00d7 2\u20134 days [21,27]\n\n**Note:** [Meropenem](#/drug/meropenem/meningitis) has activity against *L. monocytogenes* \u2014 if used, ampicillin may be omitted. [1,27]\n\n**Add [Acyclovir](#/drug/acyclovir/encephalitis)** if encephalitis features present. [7,29]',
    citation: [1, 7, 21, 24, 27, 29],
    treatment: {
      firstLine: {
  ...
  },
  {
    ...
    body: '**Risk factors:** Neurosurgical procedures, shunts/drains, CSF leaks, basilar skull fractures. [25,28]\n\n**Common pathogens:** Gram-negative bacilli (*P. aeruginosa*, *A. baumannii*), gram-positive skin flora (*Staphylococcus* spp including MRSA). Mortality: **16\u201341%**. [25,28]\n\n**Regimen:**\n\u2022 [Vancomycin](#/drug/vancomycin/meningitic adult) 15\u201320 mg/kg IV q8\u201312h (MRSA coverage) [25,28]\n\u2022 [Meropenem](#/drug/meropenem/meningitis) 2g IV q8h (broad gram-negative + Pseudomonas coverage) [25,28]\n\u2022 OR [Cefepime](#/drug/cefepime/adult meningitis) 2g IV q8h as alternative to meropenem [25,28]\n\n**CSF lactate** is particularly useful for diagnosis \u2014 postoperative inflammation alters conventional markers but does NOT affect lactate. [25,28]\n\nConsider Infectious Disease consultation for second-/third-line agents (linezolid). [25,28]',
    citation: [25, 28],
    treatment: {
      firstLine: {
  ...
  },
  {
    ...
    body: '**Cryptococcal meningitis** is the 2nd highest cause of mortality in HIV/AIDS patients. *C. neoformans* causes ~1 million cases/year in HIV/AIDS, with ~600,000 annual deaths. [17]\n\nTypically subacute: weeks of evolving headache, neck stiffness, malaise.\n\n**Serum cryptococcal antigen (CrAg):** 99.7% sensitive, 94.1% specific \u2014 send immediately. [17]\n\n**Empiric antifungal regimen (after ID consultation):**\n\u2022 [Amphotericin B liposomal](#/drug/amphotericin-b/cryptococcal meningitis) 3\u20134 mg/kg/day IV [22,30]\n\u2022 [Flucytosine](#/drug/flucytosine/cryptococcal meningitis) 25 mg/kg PO q6h [22,30]\n\u2022 Induction \u00d7 1 week, then [Fluconazole](#/drug/fluconazole/cryptococcal meningitis) 400\u2013800 mg/day [22,30]\n\n**ALSO give empiric bacterial coverage** (Ceftriaxone + Vancomycin + Ampicillin) until CSF results available. [1,27]\n\n**\u26a0\ufe0f Do NOT give corticosteroids** \u2014 associated with worsened outcomes in cryptococcal meningitis. [1,21,30]',
    citation: [1, 17, 21, 22, 27, 30],
    treatment: {
      firstLine: {
  ...
  },
  {
    ...
    body: '**HSV-1 is the most common endemic cause** of viral encephalitis in the Western world. [7]\n\n**[Acyclovir](#/drug/acyclovir/encephalitis) 10 mg/kg IV q8h** \u2014 continue for all suspected encephalitis. [7,29]\n\u2022 In the landmark RCT (208 patients): acyclovir reduced mortality from **70% to 28%** [7]\n\u2022 Contemporary mortality with acyclovir + ICU care: **~9%** [15]\n\n**If HSV-1 PCR negative but high clinical suspicion:**\n\u2022 Continue acyclovir \u2014 false-negative PCR is possible in the first **72 hours** [7,29]\n\u2022 Repeat PCR at **3\u20137 days** [7,29]\n\n**MRI findings:** Temporal lobe involvement is characteristic of HSV encephalitis. [8,29]\n\n**VZV encephalitis:** More common in immunocompromised patients. Continue acyclovir if VZV identified. [6,29]\n\n**\u26a0\ufe0f Corticosteroids** are NOT indicated for viral encephalitis (unlike bacterial meningitis). Consider if autoimmune encephalitis suspected (relapse weeks after initial infection \u2014 consult neurology). [1,29]',
    citation: [1, 6, 7, 8, 15, 29],
    treatment: {
      firstLine: {
        drug: 'Acyclovir',
        dose: '10 mg/kg',
  ...
  },
  {
    ...
    body: 'Fungal meningitis is primarily a disease of **immunocompromised** populations. Most cases present **subacutely** with weeks of evolving symptoms. [8]\n\n**Most common cause:** *Cryptococcus neoformans* (~1 million cases/year in HIV/AIDS). [17]\n\nOther causes: *Histoplasma*, *Coccidioides*, *Candida* species.\n\n**Treatment (requires ID consultation):**\n\u2022 **Induction (1 week):** [Amphotericin B liposomal](#/drug/amphotericin-b/cryptococcal meningitis) 3\u20134 mg/kg/day IV + [Flucytosine](#/drug/flucytosine/cryptococcal meningitis) 25 mg/kg PO q6h [22,30]\n\u2022 **Consolidation:** [Fluconazole](#/drug/fluconazole/cryptococcal meningitis) 400\u2013800 mg/day PO [22,30]\n\u2022 This regimen showed lowest mortality in a Cochrane review of 13 studies (2426 participants) [22]\n\n**\u26a0\ufe0f Do NOT give corticosteroids** \u2014 dexamethasone is associated with **worsened outcomes** in cryptococcal and listerial meningitis. Discontinue immediately if either pathogen identified. [1,21,30]',
    citation: [1, 8, 17, 21, 22, 30],
    treatment: {
      firstLine: {
        drug: 'Amphotericin B liposomal + Flucytosine',
        dose: 'Amphotericin B 3-4 mg/kg/day; Flucytosine 25 mg/kg',
...
export const MENINGITIS_CITATIONS: Citation[] = [
  { num: 1, text: 'van de Beek D, Cabellos C, Dzupova O, et al. ESCMID guideline: diagnosis and treatment of acute bacterial meningitis. Clin Microbiol Infect. 2016;22(Suppl 3):S37-S62. doi:10.1016/j.cmi.2016.01.007. PMID 27062097.' },
  { num: 2, text: 'Brouwer MC, van de Beek D. Epidemiology of community-acquired bacterial meningitis. Curr Opin Infect Dis. 2018;31(1):78-84. doi:10.1097/QCO.0000000000000417. PMID 29176349.' },
  { num: 3, text: 'Durand ML, Calderwood SB, Weber DJ, et al. Acute bacterial meningitis in adults. A review of 493 episodes. N Engl J Med. 1993;328(1):21-28. doi:10.1056/NEJM199301073280104. PMID 8416268.' },
  { num: 4, text: 'Bijlsma MW, Brouwer MC, Kasanmoentalib ES, et al. Community-acquired bacterial meningitis in adults in the Netherlands, 2006-14: a prospective cohort study. Lancet Infect Dis. 2016;16(3):339-347. doi:10.1016/S1473-3099(15)00430-2. PMID 26652862.' },
  { num: 5, text: 'van de Beek D, de Gans J, Spanjaard L, et al. Clinical features and prognostic factors in adults with bacterial meningitis. N Engl J Med. 2004;351(18):1849-1859. doi:10.1056/NEJMoa040845. PMID 15509818.' },
  { num: 6, text: 'Wright WF, Pinto CN, Palisoc K, Baghli S. Viral (aseptic) meningitis: a review. J Neurol Sci. 2019;398:176-183. doi:10.1016/j.jns.2019.01.050. PMID 30731305.' },
  { num: 7, text: 'Whitley RJ, Alford CA, Hirsch MS, et al. Vidarabine versus acyclovir therapy in herpes simplex encephalitis. N Engl J Med. 1986;314(3):144-149. doi:10.1056/NEJM198601163140303. PMID 3001520.' },
  { num: 8, text: 'Venkatesan A, Tunkel AR, Bloch KC, et al. Case definitions, diagnostic algorithms, and priorities in encephalitis: consensus statement of the International Encephalitis Consortium. Clin Infect Dis. 2013;57(8):1114-1128. doi:10.1093/cid/cit458. PMID 23861361.' },
  { num: 9, text: 'Attia J, Hatala R, Cook DJ, Wong JG. The rational clinical examination. Does this adult patient have acute meningitis? JAMA. 1999;282(2):175-181. doi:10.1001/jama.282.2.175. PMID 10411200.' },
  { num: 10, text: 'Juli\u00e1n-Jim\u00e9nez A, Morales-Casado MI. Usefulness of blood and cerebrospinal fluid laboratory testing to predict bacterial meningitis in the emergency department. Neurologia (Engl Ed). 2019;34(2):105-113. doi:10.1016/j.nrl.2016.05.009. PMID 27469578.' },
  { num: 11, text: 'Sakushima K, Hayashino Y, Kawaguchi T, et al. Diagnostic accuracy of cerebrospinal fluid lactate for differentiating bacterial meningitis from aseptic meningitis: a meta-analysis. J Infect. 2011;62(4):255-262. doi:10.1016/j.jinf.2011.02.010. PMID 21382412.' },
  { num: 12, text: 'McGill F, Heyderman RS, Michael BD, et al. The UK joint specialist societies guideline on the diagnosis and management of acute meningitis and meningococcal sepsis in immunocompetent adults. J Infect. 2016;72(4):405-438. doi:10.1016/j.jinf.2016.01.007. PMID 26845731. (Corrigendum: J Infect. 2016;72(6):768-769.)' },
  { num: 13, text: 'Nakao JH, Jafri FN, Shah K, Newman DH. Jolt accentuation of headache and other clinical signs: poor predictors of meningitis in adults. Am J Emerg Med. 2014;32(1):24-28. doi:10.1016/j.ajem.2013.09.012. PMID 24139448.' },
  { num: 14, text: 'Costerus JM, Brouwer MC, Bijlsma MW, van de Beek D. Community-acquired bacterial meningitis. Curr Opin Infect Dis. 2017;30(1):135-141. doi:10.1097/QCO.0000000000000335. PMID 27828810.' },
  { num: 15, text: 'George BP, Schneider EB, Venkatesan A. Encephalitis hospitalization rates and inpatient mortality in the United States, 2000-2010. PLoS One. 2014;9(9):e104169. doi:10.1371/journal.pone.0104169. PMID 25192177.' },
  { num: 16, text: 'Vikse J, Henry BM, Roy J, et al. The role of serum procalcitonin in the diagnosis of bacterial meningitis in adults: a systematic review and meta-analysis. Int J Infect Dis. 2015;38:68-76. doi:10.1016/j.ijid.2015.07.011. PMID 26188130.' },
  { num: 17, text: 'Temfack E, Rim JJB, Spijker R, et al. Cryptococcal antigen in serum and cerebrospinal fluid for detecting cryptococcal meningitis in adults living with HIV: systematic review and meta-analysis of diagnostic test accuracy studies. Clin Infect Dis. 2021;72(7):1268-1278. doi:10.1093/cid/ciaa1243. PMID 32829406.' },
  { num: 18, text: 'Costerus JM, Brouwer MC, Sprengers MES, et al. Cranial computed tomography, lumbar puncture, and clinical deterioration in bacterial meningitis: a nationwide cohort study. Clin Infect Dis. 2018;67(6):920-926. doi:10.1093/cid/ciy200. PMID 29522090.' },
  { num: 19, text: 'Aronin SI, Peduzzi P, Quagliarello VJ. Community-acquired bacterial meningitis: risk stratification for adverse clinical outcome and effect of antibiotic timing. Ann Intern Med. 1998;129(11):862-869. doi:10.7326/0003-4819-129-11_part_1-199812010-00004. PMID 9867727.' },
  { num: 20, text: 'Proulx N, Fr\u00e9chette D, Toye B, et al. Delays in the administration of antibiotics are associated with mortality from adult acute bacterial meningitis. QJM. 2005;98(4):291-298. doi:10.1093/qjmed/hci047. PMID 15760921.' },
  { num: 21, text: 'Brouwer MC, McIntyre P, Prasad K, van de Beek D. Corticosteroids for acute bacterial meningitis. Cochrane Database Syst Rev. 2015;2015(9):CD004405. doi:10.1002/14651858.CD004405.pub5. PMID 26362566.' },
  { num: 22, text: 'Tenforde MW, Shapiro AE, Rouse B, et al. Treatment for HIV-associated cryptococcal meningitis. Cochrane Database Syst Rev. 2018;7(7):CD005647. doi:10.1002/14651858.CD005647.pub3. PMID 30045416.' },
  { num: 23, text: 'Nigrovic LE, Kuppermann N, Macias CG, et al. Clinical prediction rule for identifying children with cerebrospinal fluid pleocytosis at very low risk of bacterial meningitis. JAMA. 2007;297(1):52-60. doi:10.1001/jama.297.1.52. PMID 17200475.' },
  { num: 24, text: 'Hasbun R. Update and advances in community acquired bacterial meningitis. Curr Opin Infect Dis. 2019;32(3):233-238. doi:10.1097/QCO.0000000000000543. PMID 31021955.' },
  { num: 25, text: 'Bardak-Ozcem S, Sipahi OR. An updated approach to healthcare-associated meningitis. Expert Rev Anti Infect Ther. 2014;12(3):333-342. doi:10.1586/14787210.2014.890049. PMID 24512210.' },
  { num: 26, text: 'Metcalf RA, Nahirniak S, Guyatt G, et al. Platelet transfusion: 2025 AABB and ICTMG international clinical practice guidelines. JAMA. 2025;334(7):606-617. doi:10.1001/jama.2025.7529. PMID 40440268. Recommendation 1.3: pre-lumbar-puncture platelet transfusion threshold <20,000/uL (strong recommendation, moderate-certainty evidence).' },
  { num: 27, text: 'Tunkel AR, Hartman BJ, Kaplan SL, et al. Practice guidelines for the management of bacterial meningitis. Clin Infect Dis. 2004;39(9):1267-1284. doi:10.1086/425368. PMID 15494903. (IDSA \u2014 source for empiric agent selection, adult IV dosing, and CT-before-LP criteria.)' },
  { num: 28, text: 'Tunkel AR, Hasbun R, Bhimraj A, et al. 2017 Infectious Diseases Society of America\'s clinical practice guidelines for healthcare-associated ventriculitis and meningitis. Clin Infect Dis. 2017;64(6):e34-e65. doi:10.1093/cid/ciw861. PMID 28203777.' },
  { num: 29, text: 'Tunkel AR, Glaser CA, Bloch KC, et al. The management of encephalitis: clinical practice guidelines by the Infectious Diseases Society of America. Clin Infect Dis. 2008;47(3):303-327. doi:10.1086/589747. PMID 18582201.' },
  { num: 30, text: 'Perfect JR, Dismukes WE, Dromer F, et al. Clinical practice guidelines for the management of cryptococcal disease: 2010 update by the Infectious Diseases Society of America. Clin Infect Dis. 2010;50(3):291-322. doi:10.1086/649858. PMID 20047480.' },
];
