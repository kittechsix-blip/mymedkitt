...
export const LUMBAR_PUNCTURE_NODES: DecisionNode[] = [
...

  {
    ...
    citation: [1, 2],
    images: [{ src: 'images/lumbar-puncture/lp-midline-anatomy.png', alt: 'Lumbar spine anatomy showing conus medullaris at L1 and safe LP levels at L3-L5', caption: 'LP anatomy: Conus terminates at L1; LP safe at L3-L4 or L4-L5. Cauda equina (mobile nerve roots) below L1. (Wikimedia Commons, CC BY-SA 4.0)' }],
    calculatorLinks: [
...

  {
    ...
    options: [
      ...
      { label: 'Paramedian approach', description: '30-40% higher success — avoids ligaments. Opens 3-step visual guide.', next: 'lp-paramedian-steps' },
    ],
