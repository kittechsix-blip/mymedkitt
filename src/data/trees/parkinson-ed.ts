...
export const PARKINSON_ED_NODES: DecisionNode[] = [
...

  {
    ...
    treatment: {
      ...
      secondLine: 'Dantrolene 80 mg IV TID (or 1-2.5 mg/kg IV q6h for acute refractory rigidity, max 10 mg/kg/24h). Bromocriptine 2.5 mg PO/NG q6h, titrate to 5-10 mg TID. Continue ~10 days after resolution. Aggressive cooling, IVF, ICU admission.',
...
export const PARKINSON_ED_CITATIONS: Citation[] = [
