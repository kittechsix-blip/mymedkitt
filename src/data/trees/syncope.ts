...
export const SYNCOPE_NODES: DecisionNode[] = [
...

  {
    ...
    recommendation: 'Low to intermediate risk. Treat volume depletion, adjust medications, PCP follow-up for med reconciliation. Review [Discharge Instructions](#/info/syncope-discharge) with patient.',
    confidence: 'recommended',
    citation: [1, 22, 23, 24],
    next: 'sync-disposition-low',
...

  {
    ...
    citation: [1, 2, 8, 13, 14, 15, 25, 26, 27],
    next: 'sync-risk-stratify',
...

  {
    ...
    body: '**Particularly challenging** — many present with unexplained falls rather than syncope. [37,38]\n\n**Key points:**\n• 25-50% of unexplained falls in elderly may be syncope-related [37,39]\n• Almost half of elderly with dementia referred for unexplained falls receive a syncope diagnosis [39]\n• Neurally mediated syncope is still common in this age group [37]\n• QTc prolongation occurs in 25% of elderly — QTc >500 ms predicts 30-day and 1-year mortality [40,41]\n\n**Hospitalization controversy:**\n• Older adults often have multiple risk factors and worse outcomes overall\n• However, for unexplained syncope WITHOUT a serious ED diagnosis, **hospitalization does not improve 30-day adverse outcomes** [42]\n• Age >65 alone and unexplained syncope are NOT independent predictors of mortality [43,44]\n• Mortality is related primarily to **underlying comorbidities**, not the syncope itself [42,45]\n\nHospitalization may increase likelihood of identifying a serious diagnosis, but does not appear to improve mortality.',
    citation: [37, 38, 39, 40, 41, 42, 43, 44, 45],
...

  {
    ...
    body: '**Low-risk patients should generally be discharged**, even with unexplained syncope. [1,2]\n\n**Low-risk features (ESC):** [2]\n• Young age with typical features of reflex syncope\n• No history of cardiac disease\n• Syncope only when standing\n• Identifiable trigger (pain, blood, prolonged standing)\n• Normal ECG\n• Normal vital signs\n\n**Discharge counseling:**\n• Explain diagnosis and expected benign prognosis\n• Counsel on avoidance of known triggers\n• Counterpressure maneuvers (leg crossing, hand gripping) for prodromal symptoms\n• Adequate hydration and salt intake\n• Review fall risk and injury prevention\n\n**Recurrence:** ~9% recurrence within 6 months; 3+ lifetime episodes most predictive of future recurrence [48]\n\n**Driving:** Be familiar with state laws regarding driving after syncope. Consider referral before return to work for commercial drivers or high-risk occupations. [49]\n\n**Follow-up:** PCP for recurrent or unexplained syncope.\n\n[Discharge Instructions](#/info/syncope-discharge) — shareable patient handout',
    recommendation: 'Discharge with reassurance, trigger avoidance counseling, and PCP follow-up. Address driving restrictions if applicable. Review [Discharge Instructions](#/info/syncope-discharge) with patient.',
    confidence: 'definitive',
    citation: [1, 2, 47, 48, 49],
  },
...
export const SYNCOPE_CITATIONS: Citation[] = [
  ...
  { num: 40, text: 'White JL, et al. QTc Prolongation as a Marker of 30-Day Serious Outcomes in Older Patients with Syncope. Am J Emerg Med. 2019;37(4):685-689.' },
  { num: 41, text: 'Bo M, et al. Prevalence, Predictors and Clinical Implications of Prolonged QTc in Elderly Patients with Dementia and Suspected Syncope. Eur J Intern Med. 2019;61:34-39.' },
  { num: 42, text: 'Probst MA, et al. Clinical Benefit of Hospitalization for Older Adults with Unexplained Syncope: A Propensity-Matched Analysis. Ann Emerg Med. 2019;74(2):260-269.' },
  { num: 43, text: 'Roussanov O, et al. Outcomes of Unexplained Syncope in the Elderly. Am J Geriatr Cardiol. 2006;16(4):249-254.' },
  { num: 44, text: 'Grossman SA, et al. Can Elderly Patients Without Risk Factors Be Discharged Home When Presenting to the ED with Syncope? Arch Gerontol Geriatr. 2013;58(1):110-114.' },
  { num: 45, text: 'Kaul P, et al. Lack of Benefit from Hospitalization in Patients with Syncope: A Propensity Analysis. J Am Coll Emerg Physicians Open. 2020;1(5):716-722.' },
  { num: 46, text: 'Grossman SA, et al. Can Benign Etiologies Predict Benign Outcomes in High-Risk Syncope Patients? J Emerg Med. 2011;40(5):592-597.' },
  { num: 47, text: 'Sun BC, et al. Randomized Clinical Trial of an ED Observation Syncope Protocol vs Routine Inpatient Admission. Ann Emerg Med. 2014;64(2):167-175.' },
  { num: 48, text: 'Barbic F, et al. Syncope in a Working-Age Population: Recurrence Risk and Related Risk Factors. J Clin Med. 2019;8(2).' },
  { num: 49, text: 'Sorajja D, et al. Syncope While Driving: Clinical Characteristics, Causes, and Prognosis. Circulation. 2009;120(11):928-934.' },
  { num: 50, text: 'Viau JA, et al. The Yield of CT of the Head Among Patients Presenting with Syncope: A Systematic Review. Acad Emerg Med. 2019;26(5):479-490.' },
  { num: 51, text: 'Thiruganasambandamoorthy V, et al. Prevalence of PE Among ED Patients with Syncope: A Multicenter Prospective Cohort Study. Ann Emerg Med. 2019;73(5):500-510.' },
  { num: 52, text: 'Oqab Z, et al. Prevalence of PE in Patients Presenting with Syncope: A Systematic Review and Meta-Analysis. Am J Emerg Med. 2018;36(4):551-555.' },
  { num: 53, text: 'Stockley CJ, et al. The Utility of Routine D-Dimer Measurement in Syncope. Eur J Emerg Med. 2009;16(5):256-260.' },
  { num: 54, text: 'Kelly C, et al. Diagnostic Yield of PE Testing in Patients Presenting to the ED with Syncope. Res Pract Thromb Haemost. 2020;4(2):263-268.' },
  { num: 55, text: 'Richardson D. Complications of Carotid Sinus Massage — A Prospective Series of Older Patients. Age and Ageing. 2000;29(5):413-417.' },
];
