...
export const MEASLES_NODES: DecisionNode[] = [
...
export const MEASLES_CRITICAL_ACTIONS = [
  ...
  { text: 'Koplik spots (white spots on buccal mucosa) are pathognomonic, appear 1-2 days before rash', nodeId: 'measles-clinical-dx' },
...
export const MEASLES_CITATIONS: Citation[] = [
