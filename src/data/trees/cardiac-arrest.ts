...
export const CARDIAC_ARREST_NODES: DecisionNode[] = [
...

  {
    ...
    citation: [5, 16],
    next: 'ca-universal',
    summary: 'Torsades: Mg 2g IV then infusion — amiodarone CONTRAINDICATED',
    safetyLevel: 'critical',
  },
