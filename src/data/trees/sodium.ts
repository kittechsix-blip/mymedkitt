...
export const SODIUM_CRITICAL_ACTIONS: CriticalAction[] = [
  ...
  { text: 'Calculate serum osmolality and check urine osmolality/sodium', nodeId: 'na-hypo-etiology' },
  { text: 'Limit sodium correction to <8-10 mEq/L in 24h (avoid osmotic demyelination)', nodeId: 'na-hypo-emergency' },
  { text: 'Fluid restrict to 800-1000mL/day for SIAD', nodeId: 'na-siad-treatment' },
  { text: 'Correct hypernatremia slowly with D5W or 0.45% saline (<10-12 mEq/L per 24h)', nodeId: 'na-hyper-fwd' },
