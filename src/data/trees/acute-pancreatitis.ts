...
export const ACUTE_PANCREATITIS_NODES: DecisionNode[] = [
...

  {
    ...
    body: '**Acute Pancreatitis Steps Summary** — diagnosis, severity, resuscitation, complications.\n\n**Diagnosis requires 2 of 3 criteria:** [1][2]\n• Characteristic abdominal pain (epigastric, radiating to back, sudden onset)\n• Serum lipase (or amylase) >3× upper limit of normal\n• Imaging evidence on CT, MRI, or ultrasound\n\n**Key Principles:**\n• Most cases are mild and self-limiting\n• Early severity stratification guides disposition\n• Avoid excessive fluid resuscitation (recent evidence)\n• Delayed intervention for necrotizing pancreatitis\n• Same-admission cholecystectomy for gallstone pancreatitis',
    images: [{ src: 'images/acute-pancreatitis/pancreatitis-ct.jpg', alt: 'Axial CT scan showing acute exudative pancreatitis with peripancreatic fluid collections and fat stranding around an edematous pancreas', caption: 'Acute pancreatitis CT (axial) — peripancreatic fat stranding and fluid collections. CT reserved for diagnostic uncertainty or suspected complications (necrosis, pseudocyst, abscess) — not required for initial diagnosis. (CC BY-SA 3.0, Hellerhoff)' }],
    citation: [1, 2],
    calculatorLinks: [
