...
export const CERVICAL_SPINE_NONTRAUMATIC_NODES: DecisionNode[] = [
...
export const CERVICAL_SPINE_NONTRAUMATIC_MODULE_LABELS: string[] = [
...
export const CERVICAL_SPINE_NONTRAUMATIC_CITATIONS: Citation[] = [
