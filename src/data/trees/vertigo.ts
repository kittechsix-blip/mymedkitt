...
export const VERTIGO_NODES: DecisionNode[] = [
...

  {
    ...
    body: '**Get orthostatic vitals BEFORE assuming peripheral vestibular cause.** POTS and orthostatic hypotension frequently masquerade as vertigo — especially in young women and elderly.\n\n**Orthostatic criteria:**\n• **Orthostatic hypotension:** SBP drop ≥20 mmHg OR DBP drop ≥10 mmHg within 3 minutes of standing\n• **POTS:** HR increase ≥30 bpm (≥40 in adolescents) within 10 minutes of standing, without orthostatic hypotension\n\n**Pearl:** A patient who describes their "vertigo" as worse on standing, relieved by sitting, and lasts seconds-minutes likely has orthostatic intolerance, NOT peripheral vestibular disease. Treatment (hydration, salt, compression) is entirely different.\n\n*Basis:* The orthostatic hypotension threshold (SBP fall ≥20 mmHg or DBP fall ≥10 mmHg within 3 minutes of standing) and the POTS heart-rate criterion (≥30 bpm, ≥40 bpm in adolescents) are the 2011 consensus definitions of the American Autonomic Society / American Academy of Neurology / European Federation of Autonomic Societies [36]. These are consensus definitions, not outcome-validated decision thresholds, and they were not derived in a dizziness population. The recommendation to obtain orthostatic vitals before attributing symptoms to a vestibular cause reflects GRACE-3 diagnostic strategy for undifferentiated ED dizziness [1] and the physical-examination review in [24]; neither reports a diagnostic yield figure for this step.',
    citation: [1, 24, 36],
    options: [
      {
...

  {
    ...
    body: 'This is likely **not peripheral or central vestibular disease.** Consider alternate etiologies:\n\n**Cardiovascular:**\n• Orthostatic hypotension (volume, meds, autonomic)\n• POTS / dysautonomia\n• Arrhythmia — consider [Syncope Evaluation](#/tree/syncope)\n• Aortic stenosis, HOCM\n\n**Metabolic / Hematologic:**\n• Hypoglycemia\n• Severe anemia / GI bleed\n• Electrolyte derangement\n• Thyroid disease\n\n**Medication side effects** — review med list (antihypertensives, diuretics, alpha-blockers, SSRIs, anticholinergics).\n\n**Disposition:** Address underlying cause. If syncope-spectrum → syncope workup + risk stratification. If medication-related → adjust. Patient education on fall prevention.\n\n*Basis:* The premise for routing away from a vestibular diagnosis is that symptom-quality descriptions ("spinning" vs "lightheaded") are unreliable in acute care and should not drive the differential — demonstrated in a cross-sectional ED study in which patients gave inconsistent quality descriptors on repeat questioning [25]. The breadth of non-vestibular causes reflected here is consistent with national ED dizziness epidemiology [26], which is descriptive data only and not a validated differential-diagnosis instrument. Orthostatic and POTS definitions are consensus criteria [36]. No validated ED rule exists for excluding vestibular disease; the routing here is a diagnostic-strategy recommendation [1], not an outcome-tested pathway.',
    citation: [1, 25, 26, 36],
...

  {
    ...
    body: '**STOP. Do not perform HINTS exam.** Central features indicate posterior circulation stroke until proven otherwise.\n\n**Immediate actions:**\n• Activate stroke team / neurology consult\n• **Last known well time** — determines thrombolytic window\n• Continuous cardiac monitoring\n• IV access × 2\n• NPO\n• BP management if >220/120 (permissive hypertension in acute stroke)\n• [NIHSS](#/calculator/nihss) — note: NIHSS underscores posterior circulation strokes\n\n**Cross-link:** If meets stroke criteria, consider [Stroke Consult](#/tree/stroke) for time-based reperfusion decisions.\n\n**Key pearl:** Posterior circulation strokes are missed far more often than anterior. In a large ED cohort, initial misdiagnosis occurred in **~37% of posterior circulation strokes vs ~16% of anterior** — dizziness is the single most common presenting symptom of a missed stroke. Any AVS patient with central features or inability to walk should be imaged and admitted, **regardless of age** (over half of vertigo-stroke patients under 50 are initially misdiagnosed). [33]',
    citation: [6, 12, 24, 33],
    next: 'vert-stroke-imaging',
    calculatorLinks: [{ id: 'nihss', label: 'NIHSS Calculator' }],

    summary: 'Central features present — activate stroke team, establish last known well. Posterior circulation strokes are misdiagnosed ~37% of the time vs ~16% anterior',
    safetyLevel: 'critical',
  },

  {
    ...
    body: '[Imaging Decision Guide](#/info/vertigo-imaging-guide)\n\n**CT head non-contrast is NOT adequate to rule out posterior circulation stroke.**\n• CT sensitivity for acute *ischemic* stroke overall: **~42%** (Hwang 2012, n=1,356) — and substantially worse in the posterior fossa, where beam-hardening artifact from the skull base obscures the brainstem and cerebellum\n• CT is useful only to exclude hemorrhage or mass effect before treatment. **A negative CT does not rule out a posterior circulation stroke.** [29]\n\n**MRI with DWI is the test of choice — but beware:**\n• DWI misses **12-20% of acute posterior circulation strokes in the first 24-48 hours**\n• For **small (≤ 10 mm) brainstem strokes the false-negative rate is ~53%** — exactly the lesions that present as isolated vertigo (Saber Tehrani 2014)\n• **Repeat MRI at 48-72 hours** if first negative and clinical suspicion remains\n• A well-performed HINTS exam by a trained examiner outperforms early MRI-DWI for this presentation [1,30]\n\n**Vascular imaging:** CTA head/neck or MRA to evaluate for:\n• Vertebral or basilar artery occlusion / stenosis\n• Vertebral artery dissection (especially with neck pain)\n• PICA / AICA / SCA distribution infarct\n\n**Labs:** CBC, BMP, coags, troponin, lipids, HbA1c. Do NOT delay imaging for labs.',
    citation: [4, 5, 6, 12, 29, 30],
    next: 'vert-stroke-disposition',

    summary: 'CT ~42% sensitive for ischemic stroke and worse in the posterior fossa — MRI-DWI misses 12-20% at 24-48h and ~53% of strokes <=10mm; repeat at 48-72h if negative with high suspicion',
    safetyLevel: 'warning',
  },
...

  {
    ...
    summary: 'Epley maneuver for posterior canal BPPV — Cochrane OR 4.42 vs sham (56% vs 21%, NNT~3), 80-95% single-maneuver success, no post-maneuver restrictions. AAO-HNS 2017 recommends AGAINST routine vestibular suppressants',
  },
...

  {
    ...
    body: '⚠️ **First, reconsider the diagnosis.** A posterior-canal Epley has an 80-95% single-maneuver success rate. If repeated correctly-performed maneuvers fail, the leading possibilities are **wrong canal** (horizontal/anterior — Epley will not treat these), **cupulolithiasis** rather than canalithiasis (responds better to Semont), or **not BPPV at all**. Re-examine before defaulting to home exercises.\n\n**Brandt-Daroff Exercises** — home habituation technique. **AAO-HNS 2017 rates Brandt-Daroff as INFERIOR to canalith repositioning** and does not recommend it as the primary treatment; its role is adjunctive/for patients who cannot access repositioning. It works by habituation, not by relocating otoconia. Comparative trials show single-maneuver Epley success ~80% vs Brandt-Daroff ~25-27% at one week. [17,32]\n\n**Technique:**\n1. Sit on edge of bed with head turned 45° to LEFT\n2. Quickly lie down on RIGHT side (head now facing up)\n3. Hold 30 seconds or until vertigo stops\n4. Return to sitting, hold 30 seconds\n5. Turn head 45° to RIGHT, lie down on LEFT side\n6. Hold 30 seconds, return to sitting\n\n**Regimen:** 5 repetitions per session, 3 sessions per day (morning, afternoon, evening). Continue for **2 weeks or until 2 consecutive days symptom-free**.\n\n**Expected course:**\n• Initial increase in symptoms (due to provocation) — warn patient\n• Gradual reduction over 7-14 days\n• Long-term resolution rates are high with diligent performance, but **short-term efficacy is markedly lower than repositioning** — do not present this as equivalent to Epley\n\n**Vestibular rehabilitation:** Formal PT referral for patients who fail home exercises, elderly patients at fall risk, or those with multiple recurrences. Vestibular-trained PTs can perform advanced maneuvers under Frenzel goggle guidance.',
    citation: [7, 15, 17, 20, 32],
    next: 'vert-bppv-disposition',

    summary: 'Failed Epley: re-check the canal and the diagnosis first. Brandt-Daroff (5 reps x 3 sessions/day x 2 weeks) is rated INFERIOR to repositioning by AAO-HNS 2017 — adjunctive only; refer vestibular PT',
    skippable: true,
  },

  {
    ...
    body: '**Disposition: Discharge home** with clear instructions.\n\n**Medications:**\n• [Meclizine](#/drug/meclizine/vertigo) 25 mg PO q8h PRN — **maximum 48-72 hours**. Not curative. Can delay vestibular compensation if overused.\n• Antiemetics PRN: [Ondansetron](#/drug/ondansetron/acute vertigo) 4-8 mg ODT q8h PRN\n• Avoid [Diazepam](#/drug/diazepam/acute vestibular syndrome) for BPPV — benzodiazepines delay recovery\n\n**Patient education:**\n• Movement does NOT cause harm — gradually return to activity\n• Expect mild symptoms for a few days after successful maneuver\n• If repeat Dix-Hallpike or supine roll testing is negative but imbalance persists, consider residual dizziness or otolith dysfunction rather than persistent canalithiasis\n• Persistent positional nystagmus >1 minute or apogeotropic horizontal nystagmus suggests cupulolithiasis and should prompt vestibular PT or ENT follow-up\n• **Fall precautions** — especially in elderly\n• Recurrence rate ~15-30% within 1 year — return for repeat treatment\n• Home Brandt-Daroff exercises if symptoms recur\n\n**Follow-up:**\n• Primary care in 1-2 weeks\n• Vestibular PT referral if recurrent, refractory, or persistent imbalance after negative positional testing\n• ENT referral if atypical, persistent positional nystagmus, or associated hearing symptoms\n\n[Discharge Instructions](#/info/vertigo-rehab-discharge) — shareable patient handout',
    citation: [1, 7, 17],
    confidence: 'definitive',
  },
...

  {
    ...
    body: '[HINTS Exam Technique](#/info/vertigo-hints-guide)\n\n**HINTS is ONLY valid when ALL of the following are true:**\n• Patient has **continuous (AVS)** vertigo, not episodic\n• **Spontaneous nystagmus** is present at rest\n• **No central red flags** (already screened)\n• Symptoms currently active (not between episodes)\n\n**HINTS is INVALID and DANGEROUS when:**\n• No spontaneous nystagmus → HIT will appear "normal" in healthy people, falsely suggesting central lesion\n• Episodic/positional vertigo (BPPV) → the maneuvers reproduce symptoms without diagnostic value\n• Patient asymptomatic at time of exam\n\n**Kattah 2009:** In appropriate patients examined by a **trained neuro-otologist**, HINTS outperformed early MRI (sensitivity 100% vs 88%) for identifying central cause.\n\n⚠️ **KNOW WHOSE HANDS THESE NUMBERS COME FROM.** Ohle 2020 (systematic review/meta-analysis) separated examiner types:\n• **Neuro-otologist / trained specialist: sensitivity 96.7%, specificity 94.8%**\n• **Emergency physician (untrained in HINTS): sensitivity 83%, specificity 44%**\n\nAt 83% sensitivity, HINTS performed by an untrained EP **misses roughly 1 in 6 strokes** and its 44% specificity means a "central" result is barely better than a coin flip. **A "peripheral" HINTS in untrained hands is NOT a rule-out.** If you have not been formally trained and observed on head impulse testing, treat a reassuring HINTS as soft evidence only and lower your threshold to image or consult. [1,30]\n\n**If HINTS is not appropriate** (no spontaneous nystagmus) → there is no acute vestibular syndrome. Reconsider the time-course. **GRACE-3 (Rec 4)** advises assessing **gait/truncal instability** in this situation — inability to sit or walk unaided is a strong central marker. If constant vertigo persists without nystagmus, consider central cause anyway — image the posterior fossa. [26]',
    citation: [1, 2, 11, 24, 26, 27, 30],
    options: [
      {
    ...
    summary: 'HINTS only valid with continuous vertigo + spontaneous nystagmus. 100% sens is neuro-otologist data (Kattah 2009); untrained EPs achieve only 83% sens / 44% spec (Ohle 2020) — a peripheral HINTS in untrained hands is not a rule-out',
    safetyLevel: 'warning',
  },
...

  {
    ...
    body: '**HINTS "INFARCT" mnemonic — remember the CENTRAL (stroke) pattern:**\n• **I**mpulse **N**ormal\n• **F**ast-phase **A**lternating (direction-changing nystagmus)\n• **R**efixation on **C**over **T**est (skew)\n\nAny of these findings = think INFARCT (central stroke), not peripheral. **Peripheral (reassuring) is the opposite pattern** — the one this patient has: **unidirectional nystagmus + abnormal HIT (catch-up saccade) + no skew + normal hearing**.\n\n**Diagnostic accuracy — and this depends entirely on who did the exam:**\n\n*Kattah 2009 (trained neuro-otologist, n=101):*\n• Sensitivity for stroke: **100%** • Specificity: **96%** • Outperformed early MRI-DWI in first 48 hours\n\n*Ohle 2020 (meta-analysis, by examiner type):*\n• **Specialist/trained examiner: 96.7% sensitivity, 94.8% specificity**\n• **Emergency physician without formal HINTS training: 83% sensitivity, 44% specificity**\n\n⚠️ **Do not carry the 100% figure to the bedside unless you own the training that produced it.** At 83%, roughly **1 in 6 strokes is missed**. A peripheral HINTS in untrained hands is a *supportive* finding, not a discharge license. [1,30]\n\n**⚠️ Other critical caveats:**\n• Only valid in true AVS with spontaneous nystagmus\n• Cannot detect strokes in patients without a clear AVS presentation\n• Missing technique subtleties (e.g., not removing fixation, insufficient head-thrust velocity) leads to errors\n• Nelson 2009 (WJEM) found emergency physicians frequently misapplied HINTS components\n\n**Diagnosis: Vestibular Neuritis** (if no hearing loss) or **Labyrinthitis** (if hearing loss without central findings — rare, still warrants MRI).\n\n**Etiology:** Traditionally attributed to HSV-1 reactivation in the vestibular ganglion, but the **Bárány Society 2022 diagnostic criteria for acute unilateral vestibulopathy note this remains unproven** — no viral etiology is established, and antivirals are not indicated. Self-limited over days to weeks. [31]',
    citation: [1, 2, 11, 14, 27, 30, 31],
    next: 'vert-vn-treatment',

    summary: 'All HINTS peripheral: unidirectional nystagmus + abnormal HIT + no skew + normal hearing = vestibular neuritis. 100% sens is specialist data; untrained EPs achieve 83%',
    skippable: true,
  },
...
export const VERTIGO_CITATIONS: Citation[] = [
  { num: 1, text: 'Edlow JA, Carpenter C, Akhter M, et al. Guidelines for reasonable and appropriate care in the emergency department 3 (GRACE-3): Acute dizziness and vertigo in the emergency department. Acad Emerg Med. 2023;30(5):442-486. doi:10.1111/acem.14728. PMID: 37166022. https://onlinelibrary.wiley.com/doi/10.1111/acem.14728 [Scope: ED diagnostic guideline for acute dizziness/vertigo. It addresses diagnostic strategy, not drug selection or dosing — do not cite GRACE-3 as the sole basis for any medication dose.]' },
  { num: 2, text: 'Kattah JC, Talkad AV, Wang DZ, Hsieh YH, Newman-Toker DE. HINTS to diagnose stroke in the acute vestibular syndrome: three-step bedside oculomotor examination more sensitive than early MRI diffusion-weighted imaging. Stroke. 2009;40(11):3504-3510. doi:10.1161/STROKEAHA.109.551234. PMID: 19762709. https://www.ahajournals.org/doi/10.1161/STROKEAHA.109.551234 [Scope: n=101 AVS patients at a single stroke centre; HINTS performed by neuro-ophthalmology/neuro-otology-trained examiners. Sensitivity 100%, specificity 96%; early MRI-DWI false-negative 12%.]' },
  { num: 3, text: 'Navi BB, Kamel H, Shah MP, et al. Application of the ABCD2 score to identify cerebrovascular causes of dizziness in the emergency department. Stroke. 2012;43(6):1484-1489. doi:10.1161/STROKEAHA.111.646414. PMID: 22442167.' },
  { num: 4, text: 'Oppenheim C, Stanescu R, Dormont D, et al. False-negative diffusion-weighted MR findings in acute ischemic stroke. AJNR Am J Neuroradiol. 2000;21(8):1434-1440. PMID: 11003275. (No DOI assigned by the publisher; PMID is the machine identifier.) https://pubmed.ncbi.nlm.nih.gov/11003275/' },
  { num: 5, text: 'Simonsen CZ, Madsen MH, Schmitz ML, Mikkelsen IK, Fisher M, Andersen G. Sensitivity of diffusion- and perfusion-weighted imaging for diagnosing acute ischemic stroke is 97.5%. Stroke. 2015;46(1):98-101. doi:10.1161/STROKEAHA.114.007107. PMID: 25388415. [CORRECTED 2026-07-31: this reference previously appeared as "Sensitivity of diffusion-weighted imaging in posterior circulation. Neurology. 2015;85(20):1785-1788" — a citation that does not exist. Scope limitation: the cohort is acute ischemic stroke overall, NOT posterior-circulation-specific; do not use it as a posterior circulation DWI sensitivity source (see refs 4, 12 for that).]' },
  { num: 6, text: 'Arch AE, Weisman DC, Coca S, Nystrom KV, Wira CR 3rd, Schindler JL. Missed ischemic stroke diagnosis in the emergency department by emergency medicine and neurology services. Stroke. 2016;47(3):668-673. doi:10.1161/STROKEAHA.115.010613. PMID: 26846858. [Reports 22% of ischemic strokes initially missed overall; 37% of posterior circulation vs 16% of anterior circulation. Duplicate of ref 33 — retained because existing nodes cite both indices.]' },
  { num: 7, text: 'Hilton MP, Pinder DK. The Epley (canalith repositioning) manoeuvre for benign paroxysmal positional vertigo. Cochrane Database Syst Rev. 2014;2014(12):CD003162. doi:10.1002/14651858.CD003162.pub3. PMID: 25485940. [Pooled complete symptom resolution 56% Epley vs 21% control, OR 4.42 (95% CI 2.62-7.44); authors also state a high post-treatment recurrence rate of 36%.]' },
  { num: 8, text: 'Lempert T, Olesen J, Furman J, et al. Vestibular migraine: diagnostic criteria. J Vestib Res. 2012;22(4):167-172. doi:10.3233/VES-2012-0453. PMID: 23142830. (Bárány Society / IHS consensus)' },
  { num: 9, text: 'Tarnutzer AA, Berkowitz AL, Robinson KA, Hsieh YH, Newman-Toker DE. Does my dizzy patient have a stroke? A systematic review of bedside diagnosis in acute vestibular syndrome. CMAJ. 2011;183(9):E571-E592. doi:10.1503/cmaj.100174. PMID: 21576300.' },
  { num: 10, text: 'Furman JM, Barton JJS. Treatment of vertigo. UpToDate. Waltham, MA: UpToDate Inc. Accessed 2024. https://www.uptodate.com/contents/treatment-of-vertigo [Subscription point-of-care reference. No PMID or DOI exists for UpToDate topic cards; the topic URL is the only machine identifier available. Where a dose is carried, an indexed primary source is co-cited.]' },
  { num: 11, text: 'Johns P, Quinn J. Clinical diagnosis of benign paroxysmal positional vertigo and vestibular neuritis. CMAJ. 2020;192(8):E182-E186. doi:10.1503/cmaj.190334. PMID: 32094268. See also Johns P, Rosenberg H. Just the Facts: How to assess a patient with constant significant vertigo and nystagmus in the emergency department. CJEM. 2020;22(4):463-467. doi:10.1017/cem.2020.34. PMID: 32456726. [REPLACED 2026-07-31: this index previously pointed to "Johns P. The Big Three of dizziness ... EMRAP / ACEP educational resources. 2019" — a non-indexed item with no PMID, DOI, or retrievable URL, and therefore not independently reviewable under FDA CDS Prong 4. Substituted with the same author\'s peer-reviewed, indexed publications covering the same content.]' },
  { num: 12, text: 'Saber Tehrani AS, Kattah JC, Mantokoudis G, et al. Small strokes causing severe vertigo: frequency of false-negative MRIs and nonlacunar mechanisms. Neurology. 2014;83(2):169-173. doi:10.1212/WNL.0000000000000573. PMID: 24920847. [False-negative early MRI-DWI in 53% of strokes <=10 mm.]' },
  { num: 13, text: 'Kerber KA, Brown DL, Lisabeth LD, Smith MA, Morgenstern LB. Stroke among patients with dizziness, vertigo, and imbalance in the emergency department: a population-based study. Stroke. 2006;37(10):2484-2487. doi:10.1161/01.STR.0000240329.48263.0d. PMID: 16946161.' },
  { num: 14, text: 'Strupp M, Zingler VC, Arbusow V, et al. Methylprednisolone, valacyclovir, or the combination for vestibular neuritis. N Engl J Med. 2004;351(4):354-361. doi:10.1056/NEJMoa033280. PMID: 15269315. [n=141 RCT; methylprednisolone taper improved peripheral vestibular function at 12 months, valacyclovir did not, combination added nothing over steroid alone.]' },
  { num: 15, text: 'Whitney SL, Alghwiri AA, Alghadir A. An overview of vestibular rehabilitation. Handb Clin Neurol. 2016;137:187-205. doi:10.1016/B978-0-444-63437-5.00013-3. PMID: 27638071.' },
  { num: 16, text: 'Dix MR, Hallpike CS. The pathology, symptomatology and diagnosis of certain common disorders of the vestibular system. Proc R Soc Med. 1952;45(6):341-354. doi:10.1177/003591575204500604. PMID: 14941845. (Original description of the positional test.) See also Dmitriew C, Bodunde O, Regis A, Lepage R, Turgeon Z, Johns P, McIsaac S, Ohle R. The use and misuse of the Dix-Hallpike test in the emergency department. CJEM. 2021;23(5):613-616. doi:10.1007/s43678-021-00110-1. PMID: 33677822. [REPLACED 2026-07-31: this index previously carried "Saccomanno S, Paoloni V, Manenti RJ, et al. Dix-Hallpike test and Epley maneuver ... Eur Arch Otorhinolaryngol. 2019;276(11):3009-3015" — a FABRICATED citation. No such article exists in that journal, volume, or page range, and the three named authors are orthodontic/dental researchers with no vestibular publications.]' },
  { num: 17, text: 'Bhattacharyya N, Gubbels SP, Schwartz SR, et al. Clinical practice guideline: benign paroxysmal positional vertigo (update). Otolaryngol Head Neck Surg. 2017;156(3_suppl):S1-S47. doi:10.1177/0194599816689667. PMID: 28248609. (AAO-HNS) [Duplicate of ref 32 — retained because existing nodes cite both indices.]' },
  { num: 18, text: 'Neuhauser H, Leopold M, von Brevern M, Arnold G, Lempert T. The interrelations of migraine, vertigo, and migrainous vertigo. Neurology. 2001;56(4):436-441. doi:10.1212/wnl.56.4.436. PMID: 11222783.' },
  { num: 19, text: 'Fife TD, Iverson DJ, Lempert T, et al. Practice parameter: therapies for benign paroxysmal positional vertigo (an evidence-based review). Neurology. 2008;70(22):2067-2074. doi:10.1212/01.wnl.0000313378.77444.ac. PMID: 18505980. (AAN)' },
  { num: 20, text: 'Gianoli G, Goebel J, Mowry S, Poomipannit P. Anatomic differences in the lateral vestibular nerve channels and their implications in vestibular neuritis. Otol Neurotol. 2005;26(3):489-494. doi:10.1097/01.mao.0000169787.99835.9f. PMID: 15891655. [CORRECTED 2026-07-31: this reference previously appeared as "Anatomic differences in the lateral semicircular canal. Otolaryngol Head Neck Surg. 2001;124(3):270-275" — real authors, but the title, journal, year, volume, and pages were all wrong; that journal/volume/page combination is a parotid surgery paper (PMID 11240989). Scope limitation: this is a temporal-bone study of superior vestibular nerve channel narrowing in VESTIBULAR NEURITIS. It is not a source for lateral (horizontal) canal BPPV anatomy or treatment — use refs 17/19/32 for that.]' },
  { num: 21, text: 'Sajjadi H, Paparella MM. Meniere\'s disease. Lancet. 2008;372(9636):406-414. doi:10.1016/S0140-6736(08)61161-7. PMID: 18675691.' },
  { num: 22, text: 'von Brevern M, Zeise D, Neuhauser H, Clarke AH, Lempert T. Acute migrainous vertigo: clinical and oculographic findings. Brain. 2005;128(Pt 2):365-374. doi:10.1093/brain/awh351. PMID: 15601663.' },
  { num: 23, text: 'Cohn B. Can bedside oculomotor (HINTS) testing differentiate central from peripheral causes of vertigo? Ann Emerg Med. 2014;64(3):265-268. doi:10.1016/j.annemergmed.2014.01.010. PMID: 24530107. [Systematic-review snapshot commentary; explicitly cautions that HINTS performance outside specialist hands is unestablished.]' },
  { num: 24, text: 'Edlow JA, Newman-Toker D. Using the physical examination to diagnose patients with acute dizziness and vertigo. J Emerg Med. 2016;50(4):617-628. doi:10.1016/j.jemermed.2015.10.040. PMID: 26896289.' },
  { num: 25, text: 'Newman-Toker DE, Cannon LM, Stofferahn ME, Rothman RE, Hsieh YH, Zee DS. Imprecision in patient reports of dizziness symptom quality: a cross-sectional study conducted in an acute care setting. Mayo Clin Proc. 2007;82(11):1329-1340. doi:10.4065/82.11.1329. PMID: 17976352.' },
  { num: 26, text: 'Kerber KA, Meurer WJ, West BT, Fendrick AM. Dizziness presentations in U.S. emergency departments, 1995-2004. Acad Emerg Med. 2008;15(8):744-750. doi:10.1111/j.1553-2712.2008.00189.x. PMID: 18638027. [Scope: national epidemiology of ED dizziness visits. It is NOT a diagnostic-accuracy study and is not a source for HINTS performance or for any exam recommendation.]' },
  { num: 27, text: 'Nelson JA, Viirre E. The clinical differentiation of cerebellar infarction from common vertigo syndromes. West J Emerg Med. 2009;10(4):273-277. PMID: 20046249. (No DOI assigned; PMID is the machine identifier.) https://pubmed.ncbi.nlm.nih.gov/20046249/ [Note: the publication year is 2009, not 2011.]' },
  { num: 28, text: 'Newman-Toker DE, Kerber KA, Hsieh YH, et al. HINTS outperforms ABCD2 to screen for stroke in acute continuous vertigo and dizziness. Acad Emerg Med. 2013;20(10):986-996. doi:10.1111/acem.12223. PMID: 24127701. [ABCD2 >=4: sensitivity 61.1%, specificity 62.3% overall. In patients aged <60 the sensitivity of ABCD2 >=4 was 28.9% — i.e. it MISSED roughly 71% of strokes in that age group.]' },
  { num: 29, text: 'Hwang DY, Silva GS, Furie KL, Greer DM. Comparative sensitivity of computed tomography vs. magnetic resonance imaging for detecting acute posterior fossa infarct. J Emerg Med. 2012;42(5):559-565. doi:10.1016/j.jemermed.2011.05.101. PMID: 22305149. [CORRECTED 2026-07-31: the PMID previously recorded here (22137968) belongs to an unrelated theoretical-biology paper. Scope: n=67 patients with MRI-confirmed POSTERIOR FOSSA infarct; non-contrast CT sensitivity 41.8% (95% CI 30.1-54.4) in that posterior fossa population — this figure is not a whole-brain "acute ischemic stroke overall" sensitivity.]' },
  { num: 30, text: 'Ohle R, Montpellier RA, Marchadier V, et al. Can emergency physicians accurately rule out a central cause of vertigo using the HINTS examination? A systematic review and meta-analysis. Acad Emerg Med. 2020;27(9):887-896. doi:10.1111/acem.13960. PMID: 32167642. [Population detail, verified against the abstract: the 96.7% sensitivity / 94.8% specificity pooled estimate comes from NEUROLOGISTS. The 83% sensitivity / 44% specificity estimate comes from a MIXED cohort of board-certified emergency physicians AND fellowship-trained neurologists (neuro-otology or vascular neurology). The paper does not describe either arm as "untrained," and no arm is composed purely of emergency physicians. Read any node text using the shorthand "untrained EP" against this scope note.]' },
  { num: 31, text: 'Strupp M, Bisdorff A, Furman J, et al. Acute unilateral vestibulopathy/vestibular neuritis: diagnostic criteria. Consensus document of the Barany Society. J Vestib Res. 2022;32(5):389-406. doi:10.3233/VES-220201. PMID: 35723133. [Expert consensus diagnostic criteria; not a validated decision rule and not an outcome study.]' },
  { num: 32, text: 'Bhattacharyya N, Gubbels SP, Schwartz SR, et al. Clinical Practice Guideline: Benign Paroxysmal Positional Vertigo (Update). Otolaryngol Head Neck Surg. 2017;156(3_suppl):S1-S47. doi:10.1177/0194599816689667. PMID: 28248609. (Recommendation AGAINST routine vestibular suppressants for BPPV; Brandt-Daroff rated inferior to canalith repositioning.) [Duplicate of ref 17 — retained because existing nodes cite both indices.]' },
  { num: 33, text: 'Arch AE, Weisman DC, Coca S, Nystrom KV, Wira CR 3rd, Schindler JL. Missed ischemic stroke diagnosis in the emergency department by emergency medicine and neurology services. Stroke. 2016;47(3):668-673. doi:10.1161/STROKEAHA.115.010613. PMID: 26846858. [CORRECTED 2026-07-31: the author list previously ended "Wira CR, Greer DM." Greer DM is not an author of this paper (that name belongs to ref 29); the sixth author is Schindler JL. Duplicate of ref 6.]' },
  { num: 34, text: 'Neuhauser HK, Radtke A, von Brevern M, et al. Migrainous vertigo: prevalence and impact on quality of life. Neurology. 2006;67(6):1028-1033. doi:10.1212/01.wnl.0000237539.09942.06. PMID: 17000973.' },
  { num: 35, text: 'Friedman BW, Bender B, Davitt M, et al. A randomized trial of diphenhydramine as prophylaxis against metoclopramide-induced akathisia in nauseated emergency department patients. Ann Emerg Med. 2009;53(3):379-385. doi:10.1016/j.annemergmed.2008.08.003. PMID: 18814935. [CORRECTED 2026-07-31: the PMID previously recorded here (18814936) belongs to a different article ("Letters, libel, and the law," Ann Emerg Med. 2009;53(3):354-7). The correct PMID for this trial is 18814935.]' },
  { num: 36, text: 'Freeman R, Wieling W, Axelrod FB, et al. Consensus statement on the definition of orthostatic hypotension, neurally mediated syncope and the postural tachycardia syndrome. Clin Auton Res. 2011;21(2):69-72. doi:10.1007/s10286-011-0119-5. PMID: 21431947. [Source of the consensus orthostatic hypotension threshold (sustained fall of >=20 mmHg systolic or >=10 mmHg diastolic within 3 minutes of standing) and of the POTS heart-rate criterion.]' },
  { num: 37, text: 'Kleindorfer DO, Towfighi A, Chaturvedi S, et al. 2021 Guideline for the Prevention of Stroke in Patients With Stroke and Transient Ischemic Attack: A Guideline From the American Heart Association/American Stroke Association. Stroke. 2021;52(7):e364-e467. doi:10.1161/STR.0000000000000375. PMID: 34024117. [Basis for secondary-prevention antiplatelet and statin recommendations after TIA/minor stroke, including short-course dual antiplatelet therapy in minor stroke/high-risk TIA.]' },
  { num: 38, text: 'Orr SL, Friedman BW, Christie S, et al. Management of Adults With Acute Migraine in the Emergency Department: The American Headache Society Evidence Assessment of Parenteral Pharmacotherapies. Headache. 2016;56(6):911-940. doi:10.1111/head.12835. PMID: 27300483. [Evidence assessment underlying parenteral antidopaminergic and adjunct dosing for acute migraine in the ED. Note: this assessment addresses acute MIGRAINE; there is no dedicated ED pharmacotherapy trial base for vestibular migraine, which is itself an evidence limitation.]' },
  { num: 39, text: 'Alashram AR. Effectiveness of Brandt-Daroff exercises in the treatment of benign paroxysmal positional vertigo: a systematic review of randomized controlled trials. Eur Arch Otorhinolaryngol. 2024;281(7):3371-3384. doi:10.1007/s00405-024-08502-6. PMID: 38341824. [Indexed evidence base for home Brandt-Daroff exercises as a second-line/adjunct option after canalith repositioning.]' },
  { num: 40, text: 'Newman-Toker DE, Moy E, Valente E, Coffey R, Hines AL. Missed diagnosis of stroke in the emergency department: a cross-sectional analysis of a large population-based sample. Diagnosis (Berl). 2014;1(2):155-166. doi:10.1515/dx-2013-0038. PMID: 28344918. [Population-based analysis of stroke initially discharged from the ED with a benign diagnosis; the source for the young-patient and dizziness/headache-presentation misdiagnosis signal.]' },
  { num: 41, text: 'Meclizine hydrochloride tablet — FDA prescribing information (Structured Product Label). DailyMed, U.S. National Library of Medicine. SETID: dab43efd-bec6-472f-b13a-1c043914dcd1. https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=dab43efd-bec6-472f-b13a-1c043914dcd1 [Machine-readable label source for meclizine dosing and labelled indication. Cited alongside ref 32, which recommends AGAINST routine vestibular suppressants in BPPV.]' },
];
...
export const VERTIGO_CRITICAL_ACTIONS = [
  ...
  { text: 'A negative CT head does NOT rule out posterior circulation stroke — CT is only ~42% sensitive for acute ischemic stroke and worse in the posterior fossa', nodeId: 'vert-stroke-imaging' },
  { text: 'MRI-DWI misses 12-20% of posterior circulation strokes in the first 24-48 hours, and ~53% of strokes <=10mm — repeat at 48-72h if clinical suspicion remains', nodeId: 'vert-stroke-disposition' },
  { text: 'HINTS sensitivity depends on the examiner: 96.7% for trained specialists but only 83% (spec 44%) for untrained emergency physicians — a peripheral HINTS in untrained hands is not a rule-out', nodeId: 'vert-hints-check' },
  { text: 'ABCD2 is NOT a rule-out in dizziness — only 61.1% sensitive at a >=4 threshold, missing 28.9% of strokes in patients under 60', nodeId: 'vert-tia-workup' },
  { text: 'AAO-HNS 2017 recommends AGAINST routine vestibular suppressants for BPPV — Epley is the treatment, meclizine is not a substitute', nodeId: 'vert-posterior-bppv' },
