...
export const VERTIGO_CITATIONS: Citation[] = [
  ...
  { num: 28, text: 'Newman-Toker DE, Kerber KA, Hsieh YH, et al. HINTS outperforms ABCD2 to screen for stroke in acute continuous vertigo and dizziness. Acad Emerg Med. 2013;20(10):986-996. PMID: 24127701.' },
  { num: 29, text: 'Hwang DY, Silva GS, Furie KL, Greer DM. Comparative sensitivity of computed tomography vs. magnetic resonance imaging for detecting acute posterior fossa infarct. J Emerg Med. 2012;42(5):559-565. doi:10.1016/j.jemermed.2011.05.101. PMID: 22137968.' },
  { num: 30, text: 'Ohle R, Montpellier RA, Marchadier V, et al. Can emergency physicians accurately rule out a central cause of vertigo using the HINTS examination? A systematic review and meta-analysis. Acad Emerg Med. 2020;27(9):887-896. doi:10.1111/acem.13960. PMID: 32167642. (Specialist 96.7%/94.8%; untrained EP 83%/44%.) See also Saber Tehrani AS, et al. Small strokes causing severe vertigo: frequency of false-negative MRIs. Neurology. 2014;83(2):169-173. PMID: 24920847.' },
  { num: 31, text: 'Strupp M, Bisdorff A, Furman J, et al. Acute unilateral vestibulopathy/vestibular neuritis: diagnostic criteria. Consensus document of the Barany Society. J Vestib Res. 2022;32(5):389-406. doi:10.3233/VES-220201. PMID: 35723133.' },
  { num: 32, text: 'Bhattacharyya N, Gubbels SP, Schwartz SR, et al. Clinical Practice Guideline: Benign Paroxysmal Positional Vertigo (Update). Otolaryngol Head Neck Surg. 2017;156(3_suppl):S1-S47. doi:10.1177/0194599816689667. PMID: 28248609. (Recommendation AGAINST routine vestibular suppressants for BPPV; Brandt-Daroff rated inferior to canalith repositioning.)' },
  { num: 33, text: 'Arch AE, Weisman DC, Coca S, Nystrom KV, Wira CR, Greer DM. Missed ischemic stroke diagnosis in the emergency department by emergency medicine and neurology services. Stroke. 2016;47(3):668-673. doi:10.1161/STROKEAHA.115.010613. PMID: 26846858.' },
  ...
  { num: 35, text: 'Friedman BW, Bender B, Davitt M, et al. A randomized trial of diphenhydramine as prophylaxis against metoclopramide-induced akathisia in nauseated emergency department patients. Ann Emerg Med. 2009;53(3):379-385. doi:10.1016/j.annemergmed.2008.08.003. PMID: 18814936.' },
];
