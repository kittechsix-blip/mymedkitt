...
export const UTI_PEDS_CRITICAL_ACTIONS = [
  ...
  { text: 'Febrile infant 2-24 months: ceftriaxone 50 mg/kg IM/IV empiric (covers E. coli, GBS)', nodeId: 'uti-ed-abx' },
  { text: 'VCUG only needed after first febrile UTI if renal ultrasound shows abnormalities', nodeId: 'uti-rbus-result' },
  ...
  { text: 'Prophylactic antibiotics NOT routinely recommended post first febrile UTI', nodeId: 'uti-ed-followup' },
];
