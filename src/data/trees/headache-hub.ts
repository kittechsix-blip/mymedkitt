...
export const HEADACHE_HUB_CRITICAL_ACTIONS = [
  ...
  { text: 'Thunderclap = walk the Ottawa SAH Rule. Positive → CT (~98% sens ≤6 h) → LP for xanthochromia if CT negative + onset >6 h.', nodeId: 'hh-sah-entry' },
...
export const HEADACHE_HUB_CITATIONS: Citation[] = [
  ...
  { num: 15, text: 'Stiell IG, Wells GA, Vandemheen K, et al. The Canadian CT Head Rule for patients with minor head injury. Lancet. 2001;357(9266):1391-1396.' },
];
