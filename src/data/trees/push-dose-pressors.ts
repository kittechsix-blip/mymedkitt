...
export const PUSH_DOSE_PRESSORS_CRITICAL_ACTIONS = [
  ...
  { text: 'Epinephrine: 10 mcg (1 mL of 10 mcg/mL) IV push q2-5min', nodeId: 'pdp-epi-dose' },
  { text: 'Phenylephrine: 100 mcg (1 mL of 100 mcg/mL) IV push q2-5min', nodeId: 'pdp-phenyl-dose' },
  { text: 'Mix 1 mL cardiac epi (1:10,000) + 9 mL NS = 100 mcg/10 mL', nodeId: 'pdp-epi-prep' },
  { text: 'Do NOT give 1 mg epi to patient with pulse', nodeId: 'pdp-start' },
  { text: 'Label syringes clearly to prevent dosing errors', nodeId: 'pdp-epi-safety' },
  { text: 'Bridge to continuous infusion within 10-15 minutes', nodeId: 'pdp-troubleshoot' },
];

export const PUSH_DOSE_PRESSORS_NODES: DecisionNode[] = [
...
export const PUSH_DOSE_PRESSORS_CITATIONS: Citation[] = [
  {
    num: 1,
