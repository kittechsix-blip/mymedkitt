...
export const PPH_CRITICAL_ACTIONS = [
  ...
  { text: 'Fundal massage immediately — do not delay', nodeId: 'pph-massage-fundus' },
...
export const PPH_NODES: DecisionNode[] = [
...

  {
    ...
    options: [
      ...
      },
      {
        ...
        description: 'DIC, Amniotic Fluid Embolism, dilutional',
        next: 'pph-thrombin',
      },
    ],
