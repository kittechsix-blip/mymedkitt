...
export const RV_ASSESSMENT_NODES: DecisionNode[] = [
...

  {
    ...
    body: '**Vasopressor Selection for RV Failure:**\n\n| Agent | Mechanism | Role | Notes |\n|-------|-----------|------|-------|\n| [Norepinephrine](#/drug/norepinephrine/vasodilatory shock) | α > β | First-line | Safe peripherally; improves RV coronary perfusion |\n| [Vasopressin](#/drug/vasopressin/vasodilatory shock) | V1 receptor | First-line alt | ↑ SVR, may ↓ PVR; hard to titrate |\n| [Epinephrine](#/drug/epinephrine/septic shock infusion) | β + α | Inotropy needed | β effects dilate pulm vessels; ↑ lactate |\n| [Dobutamine](#/drug/dobutamine/septic shock inotrope) | β agonist | Inotropy | Start 2 mcg/kg/min; causes hypotension — need vasopressor |\n\n⚠️ **AVOID Phenylephrine**\n• Pure alpha agonist\n• Increases pulmonary vascular resistance\n• Worsens RV afterload\n• Can precipitate RV failure\n\n**Practical Approach:**\n1. Start norepinephrine infusion\n2. Add vasopressin if needed\n3. Add epinephrine or dobutamine if inotropic support needed\n4. Have push-dose at bedside as backup [1][2][8]',
    citation: [1, 2, 8],
    next: 'rv-push-dose',
...
export const RV_ASSESSMENT_MODULE_LABELS: string[] = [
  'Why RV Matters',
  'Clinical Assessment',
  'Pre-Optimization',
  'Intubation',
...
export const RV_ASSESSMENT_CITATIONS: Citation[] = [
