...
export const TTP_NODES: DecisionNode[] = [
...

  {
    ...
    body: '[Caplacizumab](#/drug/caplacizumab/ttp loading) is an anti-vWF nanobody that prevents platelet aggregation. [13]\n\n**HERCULES Trial Results:** [13]\n• 74% reduction in composite outcome (death, recurrence, thromboembolism)\n• Faster platelet normalization\n• Lower recurrence during treatment\n\n**Dosing:** [13]\n• **Loading:** 11 mg IV before first TPE\n• **Maintenance:** 11 mg SC daily\n• **Duration:** Continue until 30 days after last TPE\n• Can extend up to 28 additional days if ADAMTS13 remains <10%\n\n**Side effects:** [13]\n• Epistaxis (29%)\n• Headache (21%)\n• Gingival bleeding (16%)\n• Mucocutaneous bleeding (monitor closely)\n\n**Cost:** ~$10,000-15,000/dose (discuss with pharmacy early)\n\n**⚠️ 2025 ISTH safety caveat:** [10] avoid concurrent antiplatelet agents and anticoagulants until platelet count recovers to ≥50,000/mm³ (added bleeding risk on top of caplacizumab).\n\n**Pearl:** Start caplacizumab EARLY/upfront with first TPE — the 2025 ISTH update emphasizes early initiation, not salvage use. Do not delay waiting for ADAMTS13 results if clinical picture supports iTTP.',
    citation: [13],
    next: 'ttp-monitoring',
...
export const TTP_CITATIONS: Citation[] = [
...
export const TTP_CRITICAL_ACTIONS = [
  ...
  { text: 'Caplacizumab 11mg IV before first TPE, then 11mg SC daily', nodeId: 'ttp-caplacizumab' },
