...
export const BURR_HOLE_CRITICAL_ACTIONS = [
  ...
  { text: 'Blown pupil is ipsilateral to the clot ~79% of the time WHEN a lateralized lesion exists — but its PPV for any surgical mass is only ~30%. Use CT whenever obtainable.', nodeId: 'bh-side-selection' },
  ...
  { text: 'Time-critical: the 70-90 min figure is the mean ANISOCORIA-to-decompression latency in survivors (Cohen 1996, n=21) — not a validated cutoff. Other series show inflection at ~2-4 h and no survivors beyond ~6 h. Decompress as fast as physically possible.', nodeId: 'bh-start' },
...
export const BURR_HOLE_NODES: DecisionNode[] = [
...

  {
    ...
    body: '**Emergency Burr Hole Craniostomy**\n\nRarely performed but potentially life-saving procedure for evacuating expanding extra-axial hematomas (epidural or subdural) when neurosurgical intervention is unavailable.\n\n⚠️ **This is a LAST RESORT procedure**\n\n**The Question:**\nWill the patient herniate and die before reaching a neurosurgeon?\n\n**Key Time Points — read the fine print:**\n• The often-quoted **70-90 minutes** is the *mean latency from ANISOCORIA to decompression* among survivors in a small series (Cohen, J Trauma 1996, n=21; latency analysis n=10). It is **not** a validated cutoff, and the trigger is anisocoria, not "herniation signs" broadly. [10]\n• Other series place the outcome inflection at **~2 hours** (Haselsberger 1988), **~3 hours** (Sakas 1995), and **~4 hours** (Seelig, NEJM 1981). Sakas reported **no survivors beyond ~6 hours**.\n• The honest operational statement: every minute of pupillary dilation costs outcome, the curve is steep in the first 1-4 hours, and there is no safe window. Decompress as fast as physically possible.\n• If neurosurgery available within 2 hours → aggressive medical management + transport\n\n**Roberts & Hedges:** "The emergency physician should consider burr hole trephination only when faced with a patient who will clearly die during transport to a neurosurgical facility." [1]',
    options: [
...

  {
    ...
    body: '**Which Side to Drill?**\n\n**Rule #1: CT-Guided is ALWAYS Preferred**\n• Count slices from vertex to hematoma center\n• Drill directly over lesion\n\n**Without CT or As Clinical Backup:**\n\n**1. Ipsilateral to Dilated Pupil — weaker than commonly taught**\n• **When a lateralized mass lesion IS present, the blown pupil is ipsilateral ~79% of the time** (34% ipsilateral vs 9% contralateral in the Helmy series; the remaining 49% had no lateralizing lesion at all)\n• **But the positive predictive value of anisocoria for ANY surgical mass is only ~30%** (Chesnut, n=608), rising to only ~43% even when asymmetry exceeds 3 mm\n• Translation: a blown pupil is a poor screening test for "there is a clot on that side." It tells you which side *if* you already know a clot exists. Do not open a head on pupil alone if CT is obtainable.\n• CN III compression occurs ipsilateral to hematoma\n\n**2. If Both Pupils Dilated**\n• Side of FIRST dilation (if known from serial exams)\n• Side of obvious external trauma\n\n**3. If Pupils Equal**\n• Side of external trauma or skull fracture\n• Side of scalp hematoma/laceration\n\n**4. Contralateral Hemiparesis**\n• Hematoma usually OPPOSITE the weak side\n• Cerebral peduncle compression causes contralateral weakness\n\n⚠️ **False Localizing Signs — know which sign actually lies**\n• **Kernohan\'s notch produces a false-localizing MOTOR finding — hemiparesis IPSILATERAL to the clot — not a false-localizing pupil.** Rule #4 above (hematoma opposite the weak side) is the rule Kernohan breaks. The pupil in Kernohan\'s notch is still ipsilateral to the mass.\n• The frequently quoted "15%" has no denominator-based study behind it — the literature is case reports and a pooled series of ~102 cases. Treat Kernohan as *uncommon but real*, not as a 1-in-7 event.\n• Practical rule: trust the pupil over the motor exam for side, and trust CT over both. [1][2][12]',
    options: [
    ...
    summary: 'Blown pupil ipsilateral ~79% WHEN a lateralized lesion exists, but PPV for a surgical mass only ~30%; Kernohan falsifies the MOTOR exam, not the pupil; CT-guided always preferred',
  },
...

  {
    ...
    module: 5,
    title: 'Complications',
    body: '**Intraoperative Complications:**\n\n| Complication | Cause | Management |\n|--------------|-------|------------|\n| **Cortical Injury** | Drill plunge | Use clutch bit; stop if brain seen |\n| **MMA Bleeding** | Temporal drilling | Bipolar; bone wax in foramen |\n| **Sagittal Sinus** | Too medial | Stay ≥3 cm lateral; direct pressure |\n| **Dural Tear** | Aggressive instrumentation | Cover with dural substitute |\n| **Scalp Bleeding** | Incision | Electrocautery, pressure, clips |\n\n**Post-Procedure Complications:**\n\nRates below are drawn from **neurosurgical burr-hole series (chronic SDH drainage)** — the largest denominators available. There is no ED-trephination cohort large enough to generate rates; the published ED experience is a handful of cases. Assume EP-performed rates are **at least** as high as these. [13][14]\n\n| Complication | Rate | Source / Notes |\n|--------------|------|----------------|\n| **Any surgical complication** | **11-20.5%** | Rohde 2002 (20.5%); Karolinska n=2,655 (11%) |\n| **Moderate–severe complication** | **~3.9%** | Karolinska n=2,655 |\n| **Intracranial hemorrhage** | **~2.1%** | Rohde 2002 |\n| **Empyema / subdural infection** | **1.4-2.1%** | Karolinska 1.4%; Rohde 2.1% |\n| **Procedure-related mortality** | **~1.1%** | Rohde 2002 |\n| **CSF Leak** | Variable | Higher with dural breach |\n| **Rebleeding** | Common | Patient needs definitive craniotomy |\n| **Cerebral Edema** | Expected | Peaks 48-72h |\n| **Seizures** | Variable | Consider prophylaxis |\n\n⚠️ **Do not quote "~2.5% overall major complication rate" — that figure is not supported by any published denominator.** The defensible statement is that roughly **1 in 5 burr holes has some complication and roughly 1 in 25 has a moderate-to-severe one, with ~1% procedure-related mortality**, in the hands of neurosurgeons operating electively. [1][6][8][13][14]',
    citation: [1, 6, 8, 13, 14],
    next: 'bh-post-procedure',
    summary: 'Neurosurgical series: 11-20.5% any complication, ~3.9% mod-severe, ~2.1% ICH, 1.4-2.1% empyema, ~1.1% mortality. The old "~2.5%" figure was unsourced.',
    skippable: true,
  },
...

  {
    ...
    body: '**Immediate Post-Procedure:**\n\n**Remember: This is a BRIDGE, Not a Cure**\n\nPatient still requires:\n• Definitive neurosurgical craniotomy\n• ICU-level care\n• Ongoing ICP management\n\n**Immediate Actions:**\n\n1. **Antibiotics:**\n   • Continue cefazolin 2g IV q8h or ceftriaxone 1g IV q24h\n   • Meningitis prophylaxis\n\n2. **Arrange Immediate Transport:**\n   • Neurosurgical center\n   • Air transport if available and faster\n   • Pre-notify receiving facility\n\n3. **Neuroprotection Bundle:**\n   • Head elevated 30°, midline\n   • MAP >80-90 mmHg\n   • SpO₂ >94%\n   • Normocapnia (EtCO₂ 35-40)\n   • Normothermia\n   • Glucose 140-180 mg/dL\n\n4. **Seizure Prophylaxis:**\n   • **Levetiracetam is preferred over phenytoin** for early post-traumatic seizure prophylaxis (Neurocritical Care Society 2024 — weak recommendation, low-quality evidence; chosen for tolerability and monitoring burden, not proven superior efficacy). [15]\n   • **Duration: ≤7 days.** Prophylaxis beyond 7 days does not reduce late seizures and should be stopped.\n   • For supratentorial injuries\n   • **Dose is not guideline-specified.** 500 mg IV BID is the common starting dose but PK data suggest >50% of TBI patients are subtherapeutic on it; 1000 mg IV BID is used at many centers. Confirm against your institutional protocol. [3][4][9][15]',
    citation: [3, 4, 9, 15],
    next: 'bh-monitoring',
...
export const BURR_HOLE_CITATIONS: Citation[] = [
  ...
  { num: 8, text: 'Joint Trauma System. Emergency Life-Saving Cranial Procedures by Non-Neurosurgeons in the Deployed Setting. Clinical Practice Guideline ID 68. 10 June 2025. (Note: JTS CPG 30 and CPG 76 explicitly DISCOURAGE blind exploratory burr holes without imaging.)' },
  ...
  { num: 10, text: 'Cohen JE, Rajz G, Itshayek E, et al. Emergency burr hole trephination for traumatic intracranial hematoma. J Trauma. 1996;41(1):120-122. PMID 8676403. (n=21; the 70-90 min figure is the mean anisocoria-to-decompression latency in survivors, n=10.) See also Haselsberger 1988 (PMID 3354356, ~2 h), Sakas 1995 (PMID 7760198, ~3 h inflection, no survivors beyond ~6 h), Seelig NEJM 1981 (PMID 7231489, ~4 h).' },
  { num: 11, text: 'Helmy A, et al. Pupillary abnormalities and lesion lateralization in traumatic brain injury. Acta Neurochir Suppl. 2012. (49% no lateralizing lesion; 34% ipsilateral, 9% contralateral → ~79% concordance when a lateralized lesion exists.) See also Chesnut RM, et al., n=608: PPV of pupillary asymmetry for a surgical mass only 30%, rising to 43% for >3 mm asymmetry.' },
  { num: 12, text: 'Carrasco-Moro R, et al. Kernohan-Woltman notch phenomenon: a systematic review of pooled cases (n=102). Clin Neurol Neurosurg. 2023. (Produces false-localizing IPSILATERAL hemiparesis; the pupil remains ipsilateral to the mass. No denominator-based incidence exists — the "15%" figure is unsourced.)' },
  { num: 13, text: 'Rohde V, Graf G, Hassler W. Complications of burr-hole craniostomy and closed-system drainage for chronic subdural hematomas. Neurosurg Rev. 2002;25(1-2):89-94. PMID 11954771. (20.5% surgical complications, 2.1% ICH, 2.1% empyema, 1.1% mortality.)' },
  { num: 14, text: 'Karolinska Institutet cohort. Complications after burr-hole evacuation of chronic subdural hematoma (n=2,655). 2025. PMID 39774663. (11% any complication, 3.9% moderate-severe, 1.4% empyema.)' },
  { num: 15, text: 'Frontera JA, et al. Guideline for Reversal and Prophylaxis in Neurocritical Care: seizure prophylaxis after TBI. Neurocrit Care. 2024;40(3):819-844. (Levetiracetam suggested over phenytoin — weak recommendation, low-quality evidence; duration ≤7 days.)' },
  { num: 16, text: 'Day JD, Tschabitscher M. Anatomic position of the asterion. Neurosurgery. 1998;42(1):198-199. PMID 9442525. (Asterion overlies the transverse-sigmoid sinus complex in the majority of hemispheres.)' },
];
