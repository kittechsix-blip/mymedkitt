...
export const ACETAMINOPHEN_OD_NODES: DecisionNode[] = [
...

  {
    ...
    images: [{ src: 'images/acetaminophen/napqi-metabolism.jpg', alt: 'Diagram showing acetaminophen hepatic metabolism pathways: glucuronidation and sulfation producing nontoxic conjugates, and CYP2E1-mediated oxidation producing toxic NAPQI with glutathione neutralization', caption: 'APAP hepatotoxicity — NAPQI accumulates when overdose saturates conjugation and depletes glutathione. Risk factors: fasting, chronic alcohol use, CYP inducers (rifampin, carbamazepine). NAC replenishes glutathione and provides alternate sulfation. (CC BY-SA 3.0)' }],
    citation: [1, 2, 3],
    calculatorLinks: [
