...
export const TRACHEO_INNOMINATE_FISTULA_NODES: DecisionNode[] = [
...

  {
    ...
    summary: 'TIF is near-100% fatal without surgery; sentinel bleed precedes massive hemorrhage by 24-48 hours',
    skippable: true,
  },

  {
    ...
    citation: [1, 2, 5],
    summary: 'Stratify by time since tracheostomy: 3d-6wk is TIF window, <72h usually benign, >6wk less likely',
    options: [
      {
...

  {
    ...
    summary: 'Early trach bleeding usually benign — suctioning, manipulation, coagulopathy; escalate if arterial or >50 mL',
    skippable: true,
  },

  {
    ...
    summary: 'Late trach bleeding often granulation tissue; arterial/pulsatile features still warrant full TIF protocol',
    skippable: true,
  },

  {
    ...
    citation: [1, 3, 4],
    summary: '50% of TIF patients have sentinel bleed; pulsating trach tube + bleeding = pathognomonic triad; CTA only 20-30% sensitive',
...

  {
    ...
    summary: 'Sentinel bleed = imminent hemorrhage; call surgery STAT, activate MTP, type & cross, NPO for OR',
    safetyLevel: 'critical',
  },
...

  {
    ...
    summary: 'Hyperinflate trach cuff to ~50 mL as first maneuver — 85% success rate, temporizing only, prepare for OR',
    safetyLevel: 'critical',
    images: [
      {
...

  {
    ...
    citation: [1, 6],
    summary: 'Assess cuff hyperinflation response; bleeding past cuff means fistula is proximal — proceed to Utley maneuver',
    options: [
      {
...

  {
    ...
    summary: 'Cuff tamponade successful but NOT definitive — do not move tube, suction, or deflate; continue to OR',
    safetyLevel: 'critical',
  },

  {
    ...
    summary: 'Partial control: add oral ETT deep past stoma for additional tamponade, or replace trach with cuffed ETT',
    safetyLevel: 'critical',
  },
...

  {
    ...
    summary: 'Utley maneuver is the lifesaving bedside intervention — >80% success; provider stays attached to patient until OR',
    safetyLevel: 'critical',
    images: [
      {
...

  {
    ...
    summary: 'Secure oral ETT first, remove trach, finger through stoma into pretracheal space, compress artery vs sternum',
    safetyLevel: 'critical',
  },

  {
    ...
    summary: 'Extend stoma if too small; external sternal notch pressure as alternative; maintain pressure during OR transport',
  },
...

  {
    ...
    summary: 'Mortality without surgery ~100%, with surgery 50-70%; call CT surgery/vascular STAT, prepare sternotomy tray',
    safetyLevel: 'critical',
  },

  {
    ...
    summary: 'Ligate AND divide innominate artery; ligation alone risks re-fistulization; endovascular stent-graft emerging option',
    safetyLevel: 'critical',
  },
...

  {
    ...
    summary: 'Activate MTP with 1:1:1 ratio, large-bore IV x2, airway backup plan, TXA per protocol',
  },

  {
    ...
    summary: 'Never remove trach unless doing Utley; never delay for imaging; never ligate without division; never release finger tamponade',
    safetyLevel: 'critical',
  },
...
export const TRACHEO_INNOMINATE_FISTULA_CITATIONS: Citation[] = [
