...

  {
    ...
    treatment: {
      ...
      alternative: {
        ...
        dose: 'Insulin 5 units IV + D50W 50-100 mL (1-2 amps)',
        route: 'IV',
        frequency: 'Once, may repeat',
        duration: 'Effect lasts 4-6 hours',
        notes: 'Shifts K intracellularly. Monitor glucose q1h. 5 units (not 10) reduces hypoglycemia risk with similar K-lowering effect.',
      },
