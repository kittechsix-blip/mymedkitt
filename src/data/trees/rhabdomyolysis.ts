...
export const RHABDOMYOLYSIS_CRITICAL_ACTIONS = [
  ...
  { text: 'Bicarbonate (150 mEq NaHCO3 in 1L D5W) only if severe acidosis pH <7.1 - NOT routine, fluids are priority', nodeId: 'rhabdo-bicarb' },
  { text: 'Always check and correct magnesium - up to 50% have concurrent hypoMg', nodeId: 'rhabdo-electrolyte-check' },
...
export const RHABDOMYOLYSIS_NODES: DecisionNode[] = [
...

  {
    ...
    treatment: {
      ...
      alternative: {
        ...
        dose: 'Insulin 5 units IV (10 units if normal renal function and adequate glucose) + 25 g dextrose (D50W 50 mL)',
        route: 'IV',
        frequency: 'Once, may repeat',
        duration: 'Effect lasts 4-6 hours',
        notes: 'Shifts K intracellularly. Dose by hypoglycemia risk — 5 units (or 0.1 units/kg, max 10) if eGFR <60, dialysis-dependent, pre-treatment glucose <150 mg/dL, weight <60 kg, or no diabetes (LaRue 2017; Moussavi 2021); 10 units if normal renal function AND adequate glucose (Pierce 2020; UKKA 2023). Check glucose at 30, 60, 120 and 240 min.',
      },
      monitoring: 'Continuous cardiac monitor. Recheck K in 1-2 hours. Glucose at 30, 60, 120 and 240 min after insulin.',
    },
  },
...
export const RHABDOMYOLYSIS_CITATIONS: Citation[] = [
