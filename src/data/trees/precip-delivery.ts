...
export const PRECIP_DELIVERY_CRITICAL_ACTIONS = [
  ...
  { text: 'Support head, check for nuchal cord', nodeId: 'precip-head' },
...
export const PRECIP_DELIVERY_NODES: DecisionNode[] = [
...

  {
    ...
    body: 'EMTALA CONSIDERATIONS\n\n**[Active labor](#/info/precip-active-labor) may constitute an emergency medical condition under EMTALA when safe transfer is not possible.** [7]\n\nAssess and provide necessary stabilizing treatment before transfer. If an emergency medical condition remains unstable, transfer only when EMTALA\'s appropriate-transfer requirements are met. If delivery is imminent, the hospital must deliver the baby regardless of OB availability.\n\nTRANSFER GUIDELINES\n• Ensure receiving facility has OB capabilities and has accepted the patient\n• **Antenatal transfer is always preferred over neonatal transfer** — a pregnant patient in a vehicle is safer than a newborn in an ambulance [3]\n• Document medical necessity for transfer\n• Send all records and lab results with the patient\n• Continuous fetal monitoring during transport if available',
    recommendation: 'Transfer to facility with OB capabilities. Antenatal transfer preferred over neonatal transfer. Ensure EMTALA compliance — active labor may constitute an emergency medical condition when safe transfer is not possible.',
...
export const PRECIP_DELIVERY_CITATIONS: Citation[] = [
  ...
  { num: 5, text: 'Weiner GM, Zaichkin J, eds. Textbook of Neonatal Resuscitation (NRP). 9th ed. American Academy of Pediatrics; October 2025.' },
