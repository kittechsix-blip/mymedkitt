...

  {
    ...
    treatment: {
      ...
      pcnAllergy: {
        ...
        frequency: 'BID',
        duration: '28 days',
        notes: 'Rule out neurosyphilis first (doxy doesn\'t reach CSF); contraindicated in pregnancy',
      },
