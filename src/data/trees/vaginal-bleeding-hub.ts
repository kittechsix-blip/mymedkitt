...
//   Rh status and alloimmunization .. ACOG PB 181 [10] + 2024 ACOG CPU (<12 wk) / SMFM dissent
//   Tranexamic acid in PPH .......... WOMAN trial [13] (1 g IV, 3-hour window)
...
export const VAGINAL_BLEEDING_HUB_NODES: DecisionNode[] = [
  ...
  },
  {
    ...
    body: 'Open [Massive Transfusion](#/tree/massive-transfusion) when hemorrhagic shock is possible.\n\n**Immediate actions:** two large-bore IVs or IO, type and cross, CBC/coags/fibrinogen if severe or obstetric, pregnancy test, bedside US when skilled, pelvic exam/speculum if it will identify a controllable source, OB/GYN early, and blood products for shock rather than crystalloid-heavy resuscitation.\n\n**TXA \u2014 postpartum hemorrhage is the proven indication:** [13]\n- **1 g IV over 10 minutes**, as early as possible.\n- **Repeat 1 g IV** if bleeding continues after 30 minutes, or restarts within 24 hours of the first dose.\n- \uD83D\uDED1 **The 3-hour window is the whole ballgame.** In the WOMAN trial the death-from-bleeding benefit was confined to treatment **within 3 hours of birth** (RR 0.69, 95% CI 0.53-0.90). **There was no benefit when TXA was started beyond 3 hours.** Benefit decays roughly 10% for every 15 minutes of delay. Give it now or do not bother.\n- Outside PPH (stable AUB, nonpregnant bleeding), TXA is a bleeding-control adjunct without a mortality signal \u2014 follow the AUB pathway [1,11] rather than this bundle.\n\nDo not delay resuscitation for complete diagnostic sorting.\n\n**Basis:** hemorrhage-first posture and obstetric hemorrhage bundle [5,12]; acute AUB stabilization framing [1]; TXA dose, repeat dose, and 3-hour window from the WOMAN trial [13].',
    recommendation: 'Treat unstable vaginal bleeding as hemorrhage first, diagnosis second. In PPH give TXA 1 g IV within 3 hours of birth - there is no benefit after that.',
    citation: [1, 5, 11, 12, 13],
    safetyLevel: 'critical',
  ...
  },
  {
    ...
    body: 'Open [First Trimester Emergencies](#/tree/first-trimester).\n\n**Core workup:** quantitative beta-hCG, transvaginal ultrasound, CBC, type and screen when moderate bleeding or pain, OB/GYN for unstable, ectopic suspicion, concerning free fluid, or pregnancy of unknown location with high-risk features.\n\n\uD83D\uDED1 **A single beta-hCG value does not exclude ectopic pregnancy.** ACEP gives a **Level B** recommendation: do not use the beta-hCG value to exclude ectopic in a patient with an indeterminate ultrasound. Ruptured ectopics occur below every published discriminatory zone. The ultrasound and the clinical picture drive the decision, not the number. [2]\n\n**Rh status \u2014 the guidance changed:** [10]\n- **\u226512+0 weeks, and all bleeding at any later gestation:** check Rh type; give anti-D immune globulin to Rh-negative, unsensitized patients per ACOG PB 181.\n- **<12+0 weeks (early pregnancy loss, threatened abortion, induced abortion):** the **2024 ACOG Clinical Practice Update suggests forgoing routine Rh testing and RhIg administration**, superseding the prior PB 181 / PB 200 / PB 225 guidance for this window. NICE NG126 likewise advises no anti-D for medical management \u2264 10+0 weeks. [3,10]\n- \u26A0\uFE0F **SMFM formally dissents** and continues to recommend RhIg <12 weeks. This is genuinely contested \u2014 **follow your institutional protocol and document which one you followed.**\n\n**Critical rule:** a pregnancy of unknown location is not a benign diagnosis. Ectopic precautions and follow-up must be explicit if discharge is considered.\n\n**Basis:** beta-hCG cannot exclude ectopic (ACEP Level B) [2]; ectopic workup [7]; early pregnancy loss [8]; Rh guidance and its 2024 revision [10]; anti-D thresholds [3].',
    recommendation: 'Bleeding with positive pregnancy test requires ectopic-safe documentation and follow-up. Do not use a beta-hCG value to rule out ectopic.',
    citation: [2, 3, 7, 8, 10],
    safetyLevel: 'critical',
    confidence: 'definitive',
  },
  ...
  },
  {
    ...
    body: 'Postmenopausal bleeding requires outpatient gynecology evaluation even if ED bleeding has stopped. The ED role is to stabilize, exclude severe anemia/hemorrhage, identify obvious non-uterine sources, and arrange timely follow-up.\n\n\uD83D\uDED1 **Do not discharge on a "thin stripe."** ACOG updated this in 2026: **transvaginal ultrasound alone is no longer sufficient initial evaluation** for most patients with postmenopausal bleeding. An endometrial thickness \u22644 mm does not reliably exclude cancer \u2014 the negative predictive value is materially worse in Black patients and in patients with fibroids, obesity, or nondiagnostic imaging. **Endometrial sampling is the expected next step.** If a bedside or radiology TVUS is done in the ED, it does not close the loop; the gynecology referral for biopsy still stands. [9]\n\n**Red flags for urgent escalation:** heavy ongoing bleeding, symptomatic anemia, pelvic mass, anticoagulation, infection, pain, or unreliable follow-up.\n\n**Basis:** TVUS-alone insufficiency and the shift to tissue sampling from the 2026 ACOG Clinical Practice Update superseding CO 734 [9]; anticoagulant-associated bleeding management [15].',
...
export const VAGINAL_BLEEDING_HUB_CITATIONS: Citation[] = [
  ...
  { num: 10, text: 'ACOG Committee on Practice Bulletins-Obstetrics. Practice Bulletin No. 181: Prevention of Rh D Alloimmunization. Obstet Gynecol. 2017 Aug;130(2):e57-e70. Reaffirmed 2021. doi:10.1097/AOG.0000000000002232. PMID 28742673. SUPERSEDED IN PART FOR PREGNANCY <12+0 WEEKS - see ACOG Clinical Practice Update: Rh D Immune Globulin Administration After Abortion or Pregnancy Loss at Less Than 12 Weeks of Gestation. Obstet Gynecol. 2024 Nov;144(5):e140-e143. doi:10.1097/AOG.0000000000005733. PMID 39298769 (suggests forgoing Rh testing and RhIg administration before 12+0 weeks; replaces the corresponding guidance in PB 181, PB 200, and PB 225). DISSENT: Society for Maternal-Fetal Medicine. SMFM Statement: Rh D immune globulin administration after abortion or pregnancy loss at less than 12 weeks of gestation. Am J Obstet Gynecol. 2024;231(6):B2-B5. doi:10.1016/j.ajog.2024.08.045 (SMFM continues to recommend RhIg in this window).' },
