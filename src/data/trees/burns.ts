...
export const BURNS_NODES: DecisionNode[] = [
...

  {
    ...
    images: [{ src: 'images/burns/burns-escharotomy-cut-lines.svg', alt: 'Escharotomy cut-line map for chest, arms, hands, legs, and feet', caption: 'Red lines show where to cut: limb mid-axial lines, chest anterior/mid-axillary decompression lines, and dorsal hand/foot extensions. Black marks show danger zones to avoid.' }],
    citation: [11, 12, 14, 21, 22, 24],
    next: 'burn-transfer',
...
export const BURNS_CRITICAL_ACTIONS = [
  ...
  { text: 'Escharotomy within 6 hours for circumferential burns with vascular compromise', nodeId: 'burn-eschar-extremity' },
  { text: 'CO poisoning: 100% O₂ via NRB, target SpO₂ >95%, check carboxyhemoglobin level', nodeId: 'burn-co-treatment' },
  { text: 'Cyanide antidote (hydroxocobalamin 5 g IV) if lactate >8 + enclosed space fire', nodeId: 'burn-cyanide-rx' },
...
export const BURNS_CITATIONS: Citation[] = [
  ...
  { num: 24, text: 'NSW Agency for Clinical Innovation. Escharotomy for burn patients: a guide for clinicians. August 2025.' },
];
