...
export const POST_ROSC_NODES: DecisionNode[] = [
...

  {
    ...
    citation: [2, 3, 4, 10],
    next: 'rosc-neuro',
    summary: 'TTM2: no benefit of cooling to 33C — prevent fever >37.8C x72h, anti-shivering protocol required',
    safetyLevel: 'critical',
  },
