...
export const EATING_DISORDERS_NODES: DecisionNode[] = [
  ...
  },
  {
    ...
    treatment: {
      ...
      alternative: {
        ...
        dose: '0.3-0.6 mmol/kg/day PO (prophylactic) | 0.2-0.6 mmol/kg IV over 6h by severity (treatment)',
        route: 'IV or PO',
        frequency: 'Daily, divided doses',
        duration: 'Until phosphate stable >2.5 mg/dL',
        notes: 'Start prophylactically with refeeding. IV for Phos <2.0 mg/dL. IV potassium phosphate carries 1.47 mEq potassium per mmol phosphorus — use sodium phosphate if K is 4 mEq/L or higher or renal function is impaired. Do not exceed 45 mmol phosphorus in a single dose.',
      },
  ...
  },
  {
    ...
    treatment: {
      ...
      adjunct: {
        drug: 'Sodium/Potassium Phosphate',
        dose: 'Prophylactic: 0.3 mmol/kg/day PO | Treatment: 0.2-0.6 mmol/kg IV over 6h by severity',
        ...
        notes: 'Start prophylactically with refeeding. Monitor calcium (can cause hypocalcemia) and do not infuse phosphate through a line carrying calcium. IV potassium phosphate carries 1.47 mEq potassium per mmol phosphorus — use sodium phosphate if K is 4 mEq/L or higher or renal function is impaired.',
      },
...
export const EATING_DISORDERS_CRITICAL_ACTIONS = [
  ...
  { text: 'ECG for prolonged QTc (>450ms) - increased risk of sudden death', nodeId: 'ed-cardiac-monitoring' },
  { text: 'Admit for HR <40, SBP <90, glucose <60, temp <35.5C, prolonged QTc, or severe electrolytes', nodeId: 'ed-medical-admit' },
  { text: 'NG feeds if unable to meet oral nutrition goals (NOT as punishment)', nodeId: 'ed-acute-mgmt' },
  { text: 'Psychiatric clearance required before discharge for intentional self-harm or active suicidal ideation', nodeId: 'ed-psych-assess' },
];
