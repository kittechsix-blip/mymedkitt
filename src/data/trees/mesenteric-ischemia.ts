...
export const MESENTERIC_ISCHEMIA_CRITICAL_ACTIONS = [
  ...
  { text: 'Heparin 100 U/kg bolus → 18 U/kg/hr infusion — start before surgery', nodeId: 'ami-anticoag' },
...
export const MESENTERIC_ISCHEMIA_NODES: DecisionNode[] = [
...
export const MESENTERIC_ISCHEMIA_CITATIONS: Citation[] = [
