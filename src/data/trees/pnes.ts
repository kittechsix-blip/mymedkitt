...
export const PNES_CRITICAL_ACTIONS: CriticalAction[] = [
...
export const PNES_NODES: DecisionNode[] = [
...
export const PNES_CITATIONS: Citation[] = [
  ...
  { num: 5, text: 'Muthusamy S, Seneviratne U, Ding C, Phan TG. Using Semiology to Classify Epileptic Seizures vs Psychogenic Nonepileptic Seizures: A Meta-analysis. Neurol Clin Pract. 2022;12(3):234-247. https://www.neurology.org/doi/10.1212/CPJ.0000000000001170' },
