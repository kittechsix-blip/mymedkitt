...
export const DELIRIUM_CRITICAL_ACTIONS: CriticalAction[] = [
  ...
  { text: 'Use haloperidol or olanzapine for severe agitation (avoid benzodiazepines)', nodeId: 'del-pharm-decision' },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        dose: 'Haloperidol 5-10 mg + Midazolam 2.5-5 mg',
        route: 'IM',
        frequency: 'Once, may repeat after 20 min',
        duration: 'Single dose PRN',
        notes: 'Classic "B52" combination. QTc monitoring required. Do not combine olanzapine with parenteral benzodiazepines.',
      },
      alternative: {
        drug: 'Olanzapine',
        dose: '10 mg',
        ...
        frequency: 'Once, may repeat after 20 min',
        duration: 'Single dose PRN',
        notes: 'No QTc prolongation. Do NOT combine with parenteral benzodiazepines.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        frequency: 'Once, may repeat after 20 min',
        duration: 'Single dose PRN',
        notes: 'Reduce all doses by 50% in elderly. AVOID benzodiazepines. Black box warning for dementia-related psychosis.',
      },
      alternative: {
        drug: 'Quetiapine',
        dose: '25-50 mg',
        ...
        frequency: 'Once',
        duration: 'Single dose PRN',
        notes: 'For mild agitation in cooperative patients. Significant sedation at low doses.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        frequency: 'Once',
        duration: 'Single dose PRN',
        notes: 'Lowest D2 receptor affinity. AVOID typical antipsychotics (haloperidol, droperidol). Consult neurology early.',
      },
      alternative: {
        drug: 'Midazolam',
        dose: '1-2 mg',
        route: 'IM',
        frequency: 'Once, may repeat cautiously',
        duration: 'Single dose PRN',
        notes: 'Use low doses only. For severe agitation when PO not feasible. Avoid high doses.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        notes: 'Drug of choice for intoxication/withdrawal. May require large, repeated doses for delirium tremens. Protects against alcohol withdrawal seizures.',
      },
      alternative: {
        drug: 'Midazolam',
        dose: '2.5-5 mg',
        ...
        frequency: 'q5-10 min PRN',
        duration: 'Until adequate sedation',
        notes: 'Faster onset than lorazepam. AVOID antipsychotics in stimulant intoxication.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        frequency: 'Once, may repeat',
        duration: 'Single dose',
        notes: 'For refractory agitation when traditional agents fail. Prepare for intubation. Avoid in elderly, heart disease, schizophrenia.',
      },
      alternative: {
        drug: 'Combination therapy',
        dose: 'Haloperidol 5-10 mg + Midazolam 5 mg',
        route: 'IM or IV',
        frequency: 'q20 min PRN',
        duration: 'Until adequate sedation',
        notes: 'Combination superior to monotherapy. If olanzapine was used, switch to haloperidol before adding BZD.',
      },
