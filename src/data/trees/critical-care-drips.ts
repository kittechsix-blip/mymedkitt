...
export const CRITICAL_CARE_DRIPS_MODULE_LABELS: string[] = [
  'Overview & Selection',
  'Vasopressors',
  'Inotropes',
...
export const CRITICAL_CARE_DRIPS_NODES: DecisionNode[] = [
...
export const CRITICAL_CARE_DRIPS_CITATIONS: Citation[] = [
