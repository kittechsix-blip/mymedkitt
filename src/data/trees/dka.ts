...
export const DKA_NODES: DecisionNode[] = [
...

  {
    ...
    treatment: {
      ...
      alternative: {
        drug: 'Sodium bicarbonate 8.4% (diluted to isotonic)',
        dose: '100 mmol (100 mL of 8.4%) in 400 mL sterile water',
        route: 'IV',
        frequency: 'Infuse over ~2 h; may repeat q2h until pH >7.0',
        duration: 'Stop once pH >7.0; recheck VBG q2h',
        notes: 'Not routine. Consider only if pH <7.0 per the 2024 ADA/EASD consensus (supersedes the 2009 pH <6.9 threshold). No mortality, cardiac or neurologic benefit has been demonstrated. Never push undiluted 8.4%.',
      },
...

  {
    ...
    body: '**Aggressive but careful IV fluid therapy is cornerstone of DKA management.** [1][2][8]\n\n**Overall strategy:**\n• Correct dehydration: Most DKA patients are 5-8L depleted (sometimes >10L in severe DKA)\n• Target: Replace half deficit in first 8-12 hours, remainder over next 24 hours\n• Monitor: Reassess HR, BP, urine output, perfusion q1-2h\n• Adjust based on clinical response\n\n**Fluid choice (UPDATED 2024 ADA/EASD/JBDS Consensus):**\n• **Balanced crystalloid (LR, Plasmalyte) — PREFERRED FIRST-LINE when available:** 2024 consensus suggests balanced crystalloids over normal saline due to faster DKA resolution, less hyperchloremic acidosis (NAGMA), and shorter hospital LOS. [1][8]\n• **Normal saline (0.9%) — acceptable alternative:** Long-standing first-line that remains appropriate per institutional preference. Higher NAGMA risk with large-volume use.\n• Either is acceptable; institutional preference respected by 2024 ADA/EASD/JBDS guidelines.\n\n**Initial bolus:**\n• For volume depletion/shock: 500 mL-1 L IV bolus over 30-60 min (or 500-1000 mL/hr over 2-4 hours per 2024 consensus)\n• Reassess hemodynamics, urine output\n• Repeat bolus if needed to achieve HR <100-110, SBP >90-100\n• Caution in heart failure, ESRD, pregnancy — use POCUS to assess intravascular volume vs edema\n\n**Ongoing fluids after bolus:**\n• Depends on glucose level — see next decision point',
    citation: [1, 2, 8],
    next: 'dka-glucose-threshold',
    treatment: {
      firstLine: {
        drug: 'Lactated Ringers or Plasmalyte (balanced crystalloid)',
        ...
        notes: 'PREFERRED per 2024 ADA/EASD/JBDS consensus — faster DKA resolution, less NAGMA, shorter LOS vs NS. Goal HR <100-110, SBP >90-100. Caution in HF/ESRD.',
      },
      alternative: {
        drug: 'Normal saline 0.9%',
        dose: '500 mL-1 L bolus, then 150-200 mL/hr',
        route: 'IV',
        frequency: 'Same as balanced crystalloid',
        duration: 'Same protocol',
        notes: 'Acceptable alternative. Higher hyperchloremic acidosis (NAGMA) risk with large-volume infusion. Institutional preference respected.',
      },
      monitoring: 'HR, BP, UOP q1-2h. POCUS if HF/ESRD/pregnancy. Switch to "drop and split" when glucose <300.',
    },
    summary: 'Balanced crystalloid (LR/Plasmalyte) preferred per 2024 consensus; NS acceptable. 500-1000 mL bolus, then 150-200 mL/hr. 5-8L depleted.',
  },
...

  {
    ...
    summary: 'KCl 10 mEq/hr IV (10-20 mEq/hr only via central line) until K+ >3.3. Do NOT start insulin until repleted — fatal arrhythmia risk.',
    safetyLevel: 'critical',
  },
...

  {
    ...
    treatment: {
      ...
      alternative: {
        ...
        duration: 'Single dose',
        notes: 'Not guideline-endorsed and not routine — the 2024 ADA/EASD consensus considers bicarbonate only if pH <7.0 (superseding the 2009 pH <6.9). Intended to blunt the acidosis worsening from loss of hyperventilation. Give slowly and recheck pH.',
      },
...

  {
    ...
    citation: [1, 2, 5],
    summary: 'ICU orders: insulin drip + glargine, aggressive K+, NS/D10W, thiamine, bicarb only if pH <7.0 (not routine). Labs q1-2h.',
    treatment: {
      firstLine: {
        drug: 'Regular insulin IV drip',
        dose: '0.1 U/kg/hr',
...

  {
    ...
    treatment: {
      ...
      alternative: {
        ...
        route: 'IV',
        frequency: 'Continuous per K level',
        duration: 'Target K 4-5 mEq/L throughout treatment',
        notes: 'CONCENTRATION in the bag, not an hourly rate. Withhold potassium once K >5.0. Acetate preferred to reduce chloride load.',
      },
...
export const DKA_CRITICAL_ACTIONS = [
  ...
  { text: 'Check K+ before starting insulin - hold insulin if K+ <3.3 mEq/L', nodeId: 'dka-potassium-check' },
  { text: 'Regular insulin infusion 0.1 units/kg/hr IV (max 15 U/hr) after K+ ≥3.3 mEq/L — no routine bolus per 2024 ADA/EASD/JBDS consensus', nodeId: 'dka-insulin-start' },
  { text: 'Add dextrose to IV fluids when glucose drops to 200-250 mg/dL to prevent hypoglycemia', nodeId: 'dka-glucose-threshold' },
  { text: 'Potassium repletion 20-30 mEq/L in IV fluids if K+ 3.3-5.3 (avoid if K+ >5.3)', nodeId: 'dka-potassium-check' },
...
export const DKA_CITATIONS: Citation[] = [
  ...
  { num: 16, text: 'American Diabetes Association. 16. Diabetes Care in the Hospital: Standards of Care in Diabetes—2025. Diabetes Care. 2025;48(Suppl 1):S321-S334.' },
  { num: 17, text: 'Thammakosol K, et al. Early subcutaneous basal insulin with intravenous insulin infusion for DKA: systematic review and meta-analysis of RCTs. Diabetes Obes Metab. 2026.' },
];
