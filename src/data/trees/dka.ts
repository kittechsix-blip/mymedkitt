...
export const DKA_CRITICAL_ACTIONS = [
  ...
  { text: 'Regular insulin infusion 0.1 units/kg/hr (or 0.14 units/kg/hr per 2024 guidelines) after K+ ≥3.3', nodeId: 'dka-insulin-start' },
  ...
  { text: 'DKA resolution: glucose <200 + anion gap <12 + pH >7.3 + HCO₃ >18', nodeId: 'dka-stopping-criteria' },
