...
export const SEIZURE_HUB_NODES: DecisionNode[] = [
  // ============================================================
  // Module 1 — Sick Check
  // ============================================================
  {
...
export const SEIZURE_HUB_CITATIONS: Citation[] = [
  ...
  { num: 2, text: 'American College of Emergency Physicians Clinical Policies Subcommittee (Writing Committee) on Seizures. Clinical Policy: Critical Issues in the Management of Adult Patients Presenting to the Emergency Department With Seizures. Ann Emerg Med. 2024;84(1):e1-e12. DOI: 10.1016/j.annemergmed.2024.02.018. PMID: 38906639. (Level A: treat benzodiazepine-refractory seizures with a second-line agent; fosphenytoin, levetiracetam, or valproate may be used with similar efficacy.)' },
  ...
  { num: 13, text: 'Kapur J, Elm J, Chamberlain JM, et al. Randomized Trial of Three Anticonvulsant Medications for Status Epilepticus (ESETT). N Engl J Med. 2019;381(22):2103-2113. DOI: 10.1056/NEJMoa1905795. PMID: 31774955. (Trial dosing: levetiracetam 60 mg/kg max 4500 mg, fosphenytoin 20 mg PE/kg max 1500 mg PE, valproate 40 mg/kg max 3000 mg; ~50% seizure cessation at 60 min with each, no efficacy or safety difference.)' },
  { num: 14, text: 'Tunkel AR, Glaser CA, Bloch KC, et al. The management of encephalitis: clinical practice guidelines by the Infectious Diseases Society of America. Clin Infect Dis. 2008;47(3):303-327. DOI: 10.1086/589747. PMID: 18582201. (Empiric IV acyclovir pending HSV PCR results in suspected encephalitis.)' },
  { num: 15, text: 'Saposnik G, Bushnell C, Coutinho JM, et al. Diagnosis and Management of Cerebral Venous Thrombosis: A Scientific Statement From the American Heart Association. Stroke. 2024;55(3):e77-e90. DOI: 10.1161/STR.0000000000000456. PMID: 38284265. (CT/MR venography for diagnosis; anticoagulation even in the presence of hemorrhagic venous infarction.)' },
];
