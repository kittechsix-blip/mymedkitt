...
export const FIRST_TRIMESTER_NODES: DecisionNode[] = [
...

  {
    ...
    recommendation: 'Medical management with IM methotrexate in consultation with OB. Requires reliable follow-up for serial beta-hCG monitoring.',
...

  {
    ...
    recommendation: 'OB consult. Admit for IV rehydration, thiamine, parenteral antiemetics, and electrolyte monitoring.',
    confidence: 'recommended',
    citation: [21, 22, 25],
  },
...

  {
    ...
    recommendation: 'Admit for IV ceftriaxone. Continue until afebrile 48h, then oral step-down guided by cultures.',
    confidence: 'definitive',
    citation: [1, 29],
  },
