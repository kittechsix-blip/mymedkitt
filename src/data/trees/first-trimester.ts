...
export const FIRST_TRIMESTER_NODES: DecisionNode[] = [
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        duration: 'One-time',
        notes: 'Requires baseline CBC, BMP, LFTs. Single-dose protocol preferred. Repeat dose at day 7 if beta-hCG decline <15%.',
      },
      alternative: {
        drug: 'Methotrexate (two-dose protocol)',
        dose: '50 mg/m² BSA',
        route: 'IM',
        frequency: 'Day 0 and Day 4',
        duration: 'Two doses',
        notes: 'Consider if beta-hCG 5000-10000 or large ectopic mass. Check beta-hCG on day 4 and 7.',
      },
...

  {
    ...
    treatment: {
      ...
      alternative: {
        ...
        dose: '800 mcg',
        route: 'Buccal (between cheek and gum)',
        frequency: 'Single dose',
        duration: 'One-time; hold 30 min then swallow remnants',
        notes: 'Alternative if patient prefers non-vaginal route. Slightly lower efficacy than vaginal.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        drug: 'Gentamicin + Clindamycin + Ampicillin (triple therapy)',
        dose: 'Gentamicin 5 mg/kg IV + Clindamycin 900 mg IV + Ampicillin 2 g IV',
        route: 'IV',
        frequency: 'Gentamicin q24h, Clindamycin q8h, Ampicillin q6h',
        duration: 'Until afebrile 48 hours post-surgical evacuation',
        notes: 'Start immediately. Do not delay surgical evacuation for antibiotics to take effect.',
      },
      alternative: {
        ...
        duration: 'Until afebrile 48 hours post-surgical evacuation',
        notes: 'Alternative if triple therapy components unavailable.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        drug: 'Thiamine + Metoclopramide + IV fluids',
        dose: 'Thiamine 100 mg IV + Metoclopramide 10 mg IV + D5NS 125 mL/hr',
        route: 'IV',
        frequency: 'Thiamine daily, Metoclopramide q8h, Fluids continuous',
        duration: 'Until tolerating PO and ketonuria resolved',
        notes: 'Give thiamine BEFORE dextrose to prevent Wernicke encephalopathy. D5NS preferred over NS.',
      },
      alternative: {
        drug: 'Ondansetron',
        dose: '8 mg IV',
        ...
        notes: 'Reserve for refractory cases due to possible small risk of fetal cardiac defects. Exhaust other antiemetics first.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        frequency: 'Every 6 hours',
        duration: '7 days',
        notes: 'Safe in all trimesters. Preferred first-line agent in pregnancy.',
      },
      alternative: {
        ...
        frequency: 'Every 12 hours',
        duration: '7 days',
        notes: 'Use if cephalexin allergy or resistant organism. Safe in pregnancy.',
      },
      pcnAllergy: {
        drug: 'Nitrofurantoin',
        dose: '100 mg',
        ...
        frequency: 'Every 12 hours',
        duration: '7 days',
        notes: 'Use only when no other suitable alternatives available in first trimester (ACOG). Safe in 2nd/3rd trimester. Avoid at term (risk of hemolysis in G6PD-deficient newborn).',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        duration: 'Until afebrile 48 hours, then transition to oral',
        notes: 'Safe in all trimesters. Obtain urine and blood cultures before first dose.',
      },
      alternative: {
        drug: 'Cefepime',
        dose: '1 g IV',
        route: 'IV',
        frequency: 'Every 12 hours',
        duration: 'Until afebrile 48 hours',
        notes: 'Alternative if ceftriaxone unavailable or resistant organisms suspected.',
      },
      pcnAllergy: {
        drug: 'Aztreonam',
        dose: '1 g IV',
        ...
        duration: 'Until afebrile 48 hours',
        notes: 'Safe in pregnancy. Use for severe PCN allergy (anaphylaxis). Adjust for renal function.',
      },
...
export const FIRST_TRIMESTER_CITATIONS: Citation[] = [
