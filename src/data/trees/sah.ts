...
const SAH_CT_RESULT: DecisionNode = {
  id: 'sah-ct-result',
  type: 'question',
  module: 2,
  title: 'CT Result',
...
const SAH_CONFIRMED: DecisionNode = {
  id: 'sah-confirmed',
  type: 'info',
  module: 3,
  title: 'SAH Confirmed',
...
const SAH_INITIAL_MGMT: DecisionNode = {
  id: 'sah-initial-mgmt',
  type: 'info',
  module: 4,
...
const SAH_DEFINITIVE: DecisionNode = {
  id: 'sah-definitive',
  type: 'info',
  module: 5,
