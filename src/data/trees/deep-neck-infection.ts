...
export const DEEP_NECK_INFECTION_CRITICAL_ACTIONS: CriticalAction[] = [
  { text: 'Assess airway immediately for stridor, trismus, dysphagia, drooling', nodeId: 'dni-start' },
  { text: 'Secure airway BEFORE detailed workup if any signs of compromise', nodeId: 'dni-emergent-airway' },
  ...
  { text: 'Immediate ENT/oral surgery consult for drainage planning', nodeId: 'dni-consultants' },
  { text: 'Assess for descending mediastinitis (chest CT if concern)', nodeId: 'dni-complications' },
  { text: 'Admit all deep neck infections for IV antibiotics and monitoring', nodeId: 'dni-dispo-branch' },
];
