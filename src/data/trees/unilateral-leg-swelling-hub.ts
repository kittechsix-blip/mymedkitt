...
export const UNILATERAL_LEG_SWELLING_HUB_CITATIONS: Citation[] = [
  { num: 1, text: 'Ely JW, Osheroff JA, Chambliss ML, Ebell MH. Approach to Leg Edema of Unclear Etiology. J Am Board Fam Med. 2006;19(2):148-160. PMID: 16513903; Tintinalli\u2019s Emergency Medicine: A Comprehensive Study Guide, 9th ed. McGraw Hill, 2020. ISBN 978-1-260-01993-3 (chapter on the swollen/painful extremity).' },
  ...
  { num: 3, text: 'Chinsakchai K, et al. Trends in Management of Phlegmasia Cerulea Dolens. Vasc Endovascular Surg. 2011;45(1):5-14. PMID: 21193462; Mumoli N, Invernizzi C, Luschi R. Phlegmasia cerulea dolens. Circulation. 2012;125(8):1056-1057. PMID: 22371444.' },
  { num: 4, text: 'Stevens DL, Bisno AL, et al. IDSA Practice Guidelines for the Diagnosis and Management of Skin and Soft Tissue Infections: 2014 Update. Clin Infect Dis. 2014;59(2):e10-e52. PMID: 24973422. Supersession checked against PubMed at time of audit: this remains the current IDSA SSTI guideline; no update published.' },
  { num: 5, text: 'von Keudell AG, Weaver MJ, et al. Diagnosis and Treatment of Acute Extremity Compartment Syndrome. Lancet. 2015;386(10000):1299-1310. PMID: 26460664; McQueen MM, Court-Brown CM. Compartment monitoring in tibial fractures: the pressure threshold for decompression (delta pressure <30 mmHg). J Bone Joint Surg Br. 1996;78(1):99-104. PMID: 8898137.' },
  ...
  { num: 9, text: 'Stevens SM, Woller SC, Baumann Kreuziger L, et al. Antithrombotic Therapy for VTE Disease: Second Update of the CHEST Guideline and Expert Panel Report. Chest. 2021;160(6):e545-e608. PMID: 34352278. Supersession checked at time of audit: no third update published; see the CHEST 2012-2021 compendium/review, Chest. 2024;166(2):388-404, PMID: 38458430.' },
  ...
  { num: 13, text: 'Heidenreich PA, Bozkurt B, Aguilar D, et al. 2022 AHA/ACC/HFSA Guideline for the Management of Heart Failure. Circulation. 2022;145(18):e895-e1032. PMID: 35363499.' },
  { num: 14, text: 'Konstantinides SV, Meyer G, Becattini C, et al. 2019 ESC Guidelines for the diagnosis and management of acute pulmonary embolism, developed in collaboration with the European Respiratory Society. Eur Heart J. 2020;41(4):543-603. PMID: 31504429.' },
];
