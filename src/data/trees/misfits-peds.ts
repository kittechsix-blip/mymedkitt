...
export const MISFITS_PEDS_NODES: DecisionNode[] = [
...

  {
    ...
    body: '**NEONATAL HYPOGLYCEMIA**\n\n**DEFINITION**\nGlucose <50 mg/dL requires intervention\nGlucose <40 mg/dL is critical\n\n**CAUSES IN SICK NEONATE:**\n• Sepsis (increased metabolic demand)\n• Inborn errors of metabolism\n• Hyperinsulinism\n• Adrenal insufficiency (CAH)\n• Poor feeding, prematurity\n• Maternal diabetes (transient)\n\n**SYMPTOMS**\n• Jitteriness, tremor\n• Lethargy, poor feeding\n• Apnea, cyanosis\n• Seizures\n• Hypothermia\n\n**TREATMENT**\n\n**MILD (asymptomatic, glucose 40-50):**\n• Feed if able to take PO\n• Recheck in 30-60 minutes\n\n**MODERATE TO SEVERE (<40 or symptomatic):**\n• [Dextrose](#/drug/dextrose) IV bolus:\n  - D10W: 2 mL/kg IV push (200 mg/kg)\n  - Provides 200 mg/kg dextrose\n• Follow with D10W infusion at maintenance rate\n• Recheck glucose in 30 minutes\n• Target glucose >50 mg/dL\n\n**REFRACTORY HYPOGLYCEMIA:**\nConsider hyperinsulinism, CAH, IEM\nMay need higher dextrose concentrations (D12.5, D15)\n\n⚠️ **THE TARGET DEPENDS ON WHO YOU THINK THIS BABY IS:**\n• **AAP (transitional hypoglycemia, first 48h):** treat symptomatic infants to **> 40-50 mg/dL**. The thresholds above reflect this.\n• **Pediatric Endocrine Society:** if you suspect a **persistent hypoglycemia disorder** (refractory, requires glucose infusion rate > 8 mg/kg/min, family history, midline defects, macrosomia, or hypoglycemia beyond 48-72h), the target is **> 70 mg/dL** (GRADE 1++00), not 50. Do not discharge these infants on the transitional target.\n• Before correcting refractory hypoglycemia, draw the **critical sample** (insulin, C-peptide, cortisol, GH, beta-hydroxybutyrate, free fatty acids, ammonia, lactate, acylcarnitines) — it is uninterpretable once glucose is normalized. [20]',
    recommendation: 'Hypoglycemia <50: D10W 2 mL/kg IV push, then D10 maintenance infusion. Recheck in 30 min. Investigate cause. If a persistent hypoglycemia disorder is suspected, target >70 mg/dL per PES and draw the critical sample before correcting.',
    confidence: 'definitive',
    citation: [1, 8, 20],
    calculatorLinks: [{ id: 'peds-dose', label: 'Peds Dose Calculator' }],
    treatment: {
...

  {
    ...
    body: '**NEONATAL SEPSIS**\n\nMost common serious diagnosis in sick neonate. Must always be considered.\n\n**RISK FACTORS:**\n• Prolonged rupture of membranes (>18h)\n• Maternal GBS colonization\n• Chorioamnionitis\n• Prematurity\n• Indwelling catheters\n\n**COMMON PATHOGENS:**\n**Early-onset (<7 days):** GBS, E. coli, Listeria\n**Late-onset (7-28 days):** Coag-negative Staph, S. aureus, GBS, gram-negatives\n\n**PRESENTATION:**\n• Nonspecific: lethargy, poor feeding, temperature instability\n• Respiratory distress, apnea\n• Jaundice\n• Abdominal distension\n• Petechiae, poor perfusion\n\n**WORKUP:**\n• Blood culture (before antibiotics if possible)\n• CBC with differential\n• CRP, procalcitonin\n• UA and urine culture (catheterized)\n• **Lumbar puncture** (unless contraindicated)\n• CXR if respiratory symptoms\n• HSV PCR (if risk factors - see **HSV**)\n\n**EMPIRIC ANTIBIOTICS:**\n• [Ampicillin](#/drug/ampicillin) 50 mg/kg IV q8h (covers Listeria, GBS)\n• [Gentamicin](#/drug/gentamicin) 4 mg/kg IV q24h (covers gram-negatives)\n• Add [Acyclovir](#/drug/acyclovir) 20 mg/kg IV q8h if HSV suspected\n\n⚠️ **DOSING CAVEATS — verify against NeoFax/Lexicomp before administering:**\n• **Ampicillin:** current neonatal references dose **100 mg/kg/dose** for suspected sepsis (150-200 mg/kg/dose for meningitis, i.e. 300 mg/kg/day). Interval is set by **postmenstrual age (PMA), not postnatal age** — term (≥ 35 wks PMA) is **q8h from day 1**. [20]\n• **Gentamicin:** 4 mg/kg q24h applies to **≥ 35 wks PMA**. Preterm neonates require **4.5-5 mg/kg at q36-48h** intervals. Do not apply the flat term dose to a preterm infant. [20]\n• **Ceftriaxone is contraindicated in ANY neonate ≤ 28 days** receiving calcium-containing IV solutions (FDA label; fatal ceftriaxone-calcium precipitates), and separately in hyperbilirubinemia. There is **no 7-day carve-out.** [21]',
    recommendation: 'Neonatal sepsis: Ampicillin + Gentamicin (verify dose/interval by postmenstrual age). Add Acyclovir 20 mg/kg if HSV risk. LP if stable. Ceftriaxone contraindicated ≤ 28 days with calcium-containing IV fluids.',
    confidence: 'definitive',
    citation: [1, 2, 10, 20, 21],
    calculatorLinks: [{ id: 'peds-dose', label: 'Peds Dose Calculator' }],
    treatment: {
      firstLine: {
      ...
      alternative: {
        ...
        notes: '⚠️ FDA LABEL: ceftriaxone is CONTRAINDICATED in neonates ≤ 28 days receiving (or expected to receive) any calcium-containing IV solution, including LR and TPN — fatal ceftriaxone-calcium precipitation in lung and kidney has been reported. Also contraindicated in hyperbilirubinemia (bilirubin-albumin displacement). The ">7 days" framing above is NOT the FDA cutoff. Use cefotaxime (or ceftazidime/cefepime where cefotaxime is unavailable in the US) in any neonate ≤ 28 days.',
      },
...

  {
    ...
    treatment: {
      firstLine: {
        ...
        route: 'IV',
        frequency: 'q8h',
        duration: 'SEM: 14 days; CNS/disseminated: 21 days IV, THEN oral suppression 300 mg/m2 TID x 6 months',
        notes: 'Start immediately if HSV suspected. Adequate hydration prevents crystalline nephropathy. Oral suppression after the IV course is standard of care for all classifications (Kimberlin, NEJM 2011).',
      },
      monitoring: 'HSV PCR results. LFTs, renal function. ANC ~2x/week (neutropenia is dose-limiting). Neurologic status. Repeat LP at end of treatment for CNS disease - must be PCR-negative before stopping IV.',
    },
    safetyLevel: 'critical',
  },
...

  {
    ...
    treatment: {
      ...
      alternative: {
        ...
        notes: 'For refractory seizures AFTER phenobarbital. Not a first-line substitute - NEOLEV2 RCT showed phenobarbital 80% vs levetiracetam 28% seizure freedom (P<.001).',
      },
...

  {
    ...
    body: '**EMPIRIC ANTIBIOTICS FOR SICK NEONATE**\n\n**STANDARD REGIMEN:**\n• [Ampicillin](#/drug/ampicillin) 50 mg/kg IV q8h\n  - Covers GBS, Listeria, Enterococcus\n• [Gentamicin](#/drug/gentamicin) 4 mg/kg IV q24h\n  - Covers gram-negatives (E. coli, Klebsiella)\n  - Synergy with Ampicillin for GBS\n\n**ADD ACYCLOVIR IF HSV CONCERN:**\n• [Acyclovir](#/drug/acyclovir) 20 mg/kg IV q8h\n• HSV risk factors: maternal HSV, vesicles, seizures, CSF pleocytosis, LFT elevation\n\n**MENINGITIS DOSING:**\n• Ampicillin 75-100 mg/kg IV q6-8h (higher dose)\n• Add a third-generation cephalosporin for gram-negative CNS coverage\n\n⚠️ **CEPHALOSPORIN SELECTION IN NEONATES — two traps:**\n1. **Ceftriaxone is contraindicated at ≤ 28 days** (not 7 days) if any calcium-containing IV solution is or may be running, and in hyperbilirubinemia. Do not use it as the "older neonate" workaround. [21]\n2. **[Cefotaxime](#/drug/cefotaxime) was discontinued in the US (Feb 2018)** and remains on ASHP shortage — many US pharmacies do not stock it. If unavailable, substitute **ceftazidime** or **cefepime** per your NICU/ID protocol. Confirm availability before writing the order. [20,21]\n\n**NEC/ABDOMINAL:**\nAdd [Metronidazole](#/drug/metronidazole) 15 mg/kg IV q12h for anaerobic coverage\n\n**LATE-ONSET SEPSIS (>7 days):**\nConsider adding [Vancomycin](#/drug/vancomycin) 15 mg/kg IV q8-12h if:\n• Central line present\n• Prior NICU admission\n• Concern for Staph aureus\n\n**DURATION:**\n• Culture-negative, improving: 48-72h\n• Bacteremia: 10-14 days\n• Meningitis: 14-21 days',
    recommendation: 'Empiric: Ampicillin + Gentamicin (verify dose/interval by postmenstrual age). Add Acyclovir 20 mg/kg if HSV risk. Add Vancomycin for late-onset or line infection. Avoid ceftriaxone at <= 28 days.',
    confidence: 'definitive',
    citation: [1, 10, 11, 20, 21],
    calculatorLinks: [{ id: 'peds-dose', label: 'Peds Dose Calculator' }],
    treatment: {
      firstLine: {
        drug: 'Ampicillin + Gentamicin',
      ...
      alternative: {
        ...
        notes: 'Meningitis dosing. Cefotaxime is preferred over ceftriaxone for the ENTIRE neonatal period (<= 28 days), not just the first week. NOTE: cefotaxime was discontinued in the US in Feb 2018 and is often unavailable - substitute ceftazidime or cefepime per local NICU/ID protocol.',
      },
...
export const MISFITS_PEDS_CITATIONS: Citation[] = [
  ...
  { num: 18, text: 'Pressler RM, Abend NS, Auvin S, et al. Treatment of seizures in the neonate: Guidelines and consensus-based recommendations - Special report from the ILAE Task Force on Neonatal Seizures. Epilepsia. 2023;64(10):2550-2570. doi:10.1111/epi.17745. PMID: 37655702.' },
  { num: 19, text: 'Weiner GM, Zaichkin J, eds. Textbook of Neonatal Resuscitation (NRP). 9th ed. American Academy of Pediatrics; 2025. (Released 22 Oct 2025; required for all NRP courses since 1 Jun 2026. Aligned with 2025 AHA/AAP Neonatal Resuscitation Guidelines, Circulation/Pediatrics 2025.)' },
  { num: 20, text: 'Neofax / NeoFax-Pediatrics (IBM Micromedex) and Lexicomp Neonatal dosing monographs; Bradley JS, Nelson JD, eds. Nelson\'s Pediatric Antimicrobial Therapy. 31st ed. AAP; 2025. Neonatal antimicrobial dosing intervals are assigned by postmenstrual age, not postnatal age.' },
  { num: 21, text: 'US FDA. Rocephin (ceftriaxone sodium) prescribing information - Contraindications 4.2/4.3: neonates <=28 days receiving calcium-containing IV solutions, and hyperbilirubinemic neonates. See also FDA Drug Safety Communication on ceftriaxone-calcium precipitation, and ASHP Drug Shortage record for cefotaxime (US discontinuation Feb 2018).' },
  { num: 22, text: 'Kimberlin DW, Whitley RJ, Wan W, et al. Oral acyclovir suppression and neurodevelopment after neonatal herpes. N Engl J Med. 2011;365(14):1284-1292. doi:10.1056/NEJMoa1003509. PMID: 21991950.' },
  { num: 23, text: 'Sharpe C, Reiner GE, Davis SL, et al. Levetiracetam versus phenobarbital for neonatal seizures: a randomized controlled trial (NEOLEV2). Pediatrics. 2020;145(6):e20193182. doi:10.1542/peds.2019-3182. PMID: 32385134.' },
];
