...
export const BOTULISM_NODES: DecisionNode[] = [
...

  {
    ...
    summary: 'The 4 Ds: Diplopia, Dysarthria, Dysphagia, Descending paralysis — afebrile, clear sensorium, symmetric, dilated pupils',
  },

  {
    ...
    summary: 'Assess for bulbar symptoms, descending motor weakness, autonomic dysfunction — sensory and mental status NORMAL',
  },

  {
    ...
    summary: 'Identify source: foodborne (preformed toxin, 12-36h onset), wound (IVDU, 4-14d), infant (spores, <1yr)',
  },

  {
    ...
    summary: 'Home-canned vegetables, fermented fish — GI prodrome before neuro; multiple cases from same meal is pathognomonic',
    skippable: true,
  },

  {
    ...
    summary: 'IVDU wound botulism: black tar heroin/skin-popping — NO GI symptoms, longer incubation 4-14d, wound may look benign',
  },

  {
    ...
    summary: 'Infant <1yr: floppy baby, constipation first — BabyBIG (510-231-7600), do NOT give antibiotics (releases more toxin)',
...

  {
    ...
    summary: 'Botulism vs GBS vs MG: descending vs ascending, dilated pupils (unique), normal sensory, prominent autonomic, normal CSF',
  },

  {
    ...
    summary: 'Red flags: fixed dilated pupils, clear sensorium, descending symmetric pattern, afebrile — treat empirically if uncertain',
  },
...

  {
    ...
    summary: 'CLINICAL DIAGNOSIS — do NOT wait for labs to treat; mouse bioassay takes 1-4 days; normal CSF helps rule out GBS',
    safetyLevel: 'critical',
  },

  {
    ...
    summary: 'CT/MRI brain normal (rules out stroke), EMG incremental response at >50Hz (OPPOSITE of MG which is decremental)',
    skippable: true,
  },
...

  {
    ...
    summary: 'Call CDC 770-488-7100 NOW — HBAT 1 vial IV neutralizes circulating toxin only; earlier = better outcomes, 10% hypersensitivity',
    safetyLevel: 'critical',
  },

  {
    ...
    summary: 'Administer even if diagnosis uncertain — epinephrine at bedside for anaphylaxis; effective up to days after onset',
  },

  {
    ...
    summary: 'BabyBIG 50mg/kg IV for infants (510-231-7600) — human-derived, reduces hospital stay from 5.5 to 2.5 weeks; NO antibiotics',
    safetyLevel: 'critical',
  },
...

  {
    ...
    summary: 'Airway is priority — intubate early if FVC <12-15 mL/kg; anticipate weeks of ventilation until nerve regeneration',
    safetyLevel: 'critical',
  },

  {
    ...
    summary: 'Wound botulism: surgical debridement + metronidazole 500mg IV q8h; AVOID aminoglycosides (worsen NM blockade)',
    safetyLevel: 'warning',
  },

  {
    ...
    summary: 'DVT prophylaxis (paralyzed = high risk), communication boards for alert-but-paralyzed patients, no role for steroids',
  },
...

  {
    ...
    summary: 'REPORTABLE DISEASE — notify health department immediately; Category A bioterrorism agent; save food samples',
  },
...

  {
    ...
    summary: 'ALL suspected botulism = ICU admission — serial FVC q4h, rapid intubation access, do not delay antitoxin for transfer',
  },

  {
    ...
    summary: 'FVC q4h (intubate <12-15 mL/kg), continuous SpO2, telemetry for autonomic instability, serial neuro/motor exams',
  },
...
export const BOTULISM_CITATIONS: Citation[] = [
