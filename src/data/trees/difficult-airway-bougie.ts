...
export const DIFFICULT_AIRWAY_BOUGIE_CRITICAL_ACTIONS: CriticalAction[] = [
...
export const DIFFICULT_AIRWAY_BOUGIE_NODES: DecisionNode[] = [
...
export const DIFFICULT_AIRWAY_BOUGIE_CITATIONS: Citation[] = [
