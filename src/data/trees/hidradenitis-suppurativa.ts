...
export const HIDRADENITIS_SUPPURATIVA_NODES: DecisionNode[] = [
...

  {
    ...
    images: [
      { src: 'images/hidradenitis-suppurativa/hs-nodules.jpg', alt: 'Cluster of inflamed hidradenitis suppurativa nodules on skin', caption: 'Inflamed HS nodules, here bulky and confluent in advanced disease. The recurring, painful deep nodule is the earliest lesion; early disease looks like a solitary "boil" in a fold. HidradenitisAwareness, CC BY-SA 4.0, via Wikimedia Commons.' },
    ],
    citation: [1, 2, 6],
    next: 'hs-criteria',
...

  {
    ...
    images: [
      { src: 'images/hidradenitis-suppurativa/hs-hurley-ii-axilla.jpg', alt: 'Hurley stage II hidradenitis suppurativa of the axilla with separated nodules, tunnels and scars', caption: 'Hurley II, left axilla — tunnels and scarring with intervening normal skin. Alharbi Z, Kauczok J, Pallua N, BMC Dermatology 2012, CC BY 2.5, via Wikimedia Commons.' },
      { src: 'images/hidradenitis-suppurativa/hs-hurley-iii.jpg', alt: 'Advanced hidradenitis suppurativa with confluent violaceous nodules and multiple draining openings', caption: 'Advanced disease (uploader-labelled Hurley III) — confluent violaceous nodules with multiple draining openings. Interconnected tunnels are inferred from the linked openings; they run beneath the surface and are confirmed by probing or ultrasound. HidradenitisAwareness, CC BY-SA 4.0, via Wikimedia Commons.' },
    ],
    calculatorLinks: [
...

  {
    ...
    body: 'An inflamed, non-fluctuant nodule under 2 cm should be **injected, not cut**. Intralesional corticosteroid shrinks the lesion and relieves pain within 24–48 hours and is recommended by both North American and European guidelines for acute flares. The evidence is a prospective case series (Riis 2016) plus guideline consensus; the one small placebo-controlled RCT (Fajgenbaum 2020, 32 patients) found no significant difference from saline for lesion clearance or pain, so expect benefit in many but not all.\n\n[Triamcinolone acetonide](#/drug/triamcinolone/hidradenitis) **10 mg/mL, about 0.5–1 mL per nodule**, injected with a 27–30 gauge needle into the center of the inflamed lesion until it blanches slightly. Several nodules can be treated in one visit.\n\n• No incision, no dressing, no packing\n• Warn about transient local atrophy or hypopigmentation\n• Not a substitute for systemic therapy — it treats today\'s nodule only\n\nA fluctuant lesion should be drained instead; steroid into a pus-filled cavity does nothing.',
    citation: [2, 3, 5, 12, 17],
    next: 'hs-analgesia',
...
export const HIDRADENITIS_SUPPURATIVA_CITATIONS: Citation[] = [
  { num: 1, text: 'Okun MM, Flamm A, Werley EB, Kirby JS. Hidradenitis Suppurativa: Diagnosis and Management in the Emergency Department. J Emerg Med. 2022;63(5):636-644. doi:10.1016/j.jemermed.2022.08.001. PMID 36243614.' },
  ...
  { num: 10, text: 'COSENTYX (secukinumab) injection, for subcutaneous use. Prescribing Information. Novartis Pharmaceuticals. Hidradenitis suppurativa indication approved October 2023 (adults); expanded March 2026 to pediatric patients ≥12 years weighing ≥30 kg (150 mg for 30 to <90 kg, 300 mg for ≥90 kg). Label revised August 2026.' },
  ...
  { num: 15, text: 'Machado MO, Stergiopoulos V, Maes M, et al. Depression and Anxiety in Adults With Hidradenitis Suppurativa: A Systematic Review and Meta-analysis. JAMA Dermatol. 2019;155(8):939-945. doi:10.1001/jamadermatol.2019.0759. PMID 31166590.' },
  { num: 16, text: 'Thorlacius L, Cohen AD, Gislason GH, Jemec GBE, Egeberg A. Increased Suicide Risk in Patients with Hidradenitis Suppurativa. J Invest Dermatol. 2018;138(1):52-57. doi:10.1016/j.jid.2017.09.008. PMID 28942360.' },
  { num: 17, text: 'Fajgenbaum K, Crouse L, Dong L, Zeng D, Sayed C. Intralesional Triamcinolone May Not Be Beneficial for Treating Acute Hidradenitis Suppurativa Lesions: A Double-Blind, Randomized, Placebo-Controlled Trial. Dermatol Surg. 2020;46(5):685-689. doi:10.1097/DSS.0000000000002112. PMID 31490300.' },
];
