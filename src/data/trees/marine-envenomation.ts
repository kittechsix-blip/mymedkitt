...
export const MARINE_ENVENOMATION_CRITICAL_ACTIONS: CriticalAction[] = [
  { text: 'For jellyfish stings: rinse with vinegar (box jellyfish) or seawater (other species)', nodeId: 'marine-cnidarian' },
  { text: 'Remove tentacles carefully without triggering nematocysts', nodeId: 'marine-cnidarian' },
  { text: 'Give box jellyfish antivenom for Chironex fleckeri stings', nodeId: 'marine-box-jelly' },
...
export const MARINE_ENVENOMATION_MODULE_LABELS: string[] = [
  'Initial Assessment',
  'Cnidarian (Jellyfish)',
  'Fish Envenomation',
  'Other Marine',
...
export const MARINE_ENVENOMATION_NODES: DecisionNode[] = [
  // ─────────────────────────────────────────────────────────────────────────────
...
**Medications:**
- [Box Jellyfish Antivenom](#/drug/box-jellyfish-antivenom/box jellyfish envenomation): 1-6 ampoules IV
...
**Medications:**
- [Stonefish Antivenom](#/drug/stonefish-antivenom/stonefish envenomation): 1 amp per 2 punctures (max 3)`,
    citation: [3, 8, 10],
    next: 'marine-systemic',
...
**Medications:**
- [Sea Snake Antivenom](#/drug/sea-snake-antivenom/sea snake envenomation): 1 vial IV (1:10 dilution)`,
    citation: [1, 12],
    next: 'marine-systemic',
