...
export const ANGIOEDEMA_NODES: DecisionNode[] = [
...
export const ANGIOEDEMA_CRITICAL_ACTIONS = [
  ...
  { text: 'Avoid ACE inhibitors permanently after ACEi-induced angioedema (switch to ARB with caution)', nodeId: 'angio-acei' },
