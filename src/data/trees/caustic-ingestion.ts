...
export const CAUSTIC_INGESTION_NODES: DecisionNode[] = [
...
export const CAUSTIC_INGESTION_CRITICAL_ACTIONS = [
  ...
  { text: 'Alkali (lye, drain cleaners) causes liquefactive necrosis - deeper, more severe injury', nodeId: 'caustic-alkali-risk' },
  { text: 'Acid (toilet bowl cleaners, rust removers) causes coagulative necrosis - esophagus may be spared', nodeId: 'caustic-acid-risk' },
  { text: 'CXR/AXR for free air or pneumomediastinum (perforation)', nodeId: 'caustic-imaging' },
  { text: 'Steroids and antibiotics NOT recommended (no mortality benefit)', nodeId: 'caustic-supportive' },
  { text: 'Zargar classification: Grade 0-1 = discharge, Grade 2a-3 = admit for endoscopy and monitoring', nodeId: 'caustic-zargar-assess' },
  { text: 'Asymptomatic patients with intentional ingestion still need endoscopy (30% have significant injury)', nodeId: 'caustic-discharge-criteria' },
];

// Evidence Citations
// -------------------------------------------------------------------

export const CAUSTIC_INGESTION_CITATIONS: Citation[] = [
...
export const CAUSTIC_INGESTION_CLINICAL_NOTES: string[] = [
