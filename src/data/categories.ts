...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        id: 'myocarditis',
        title: 'Myocarditis',
        subtitle: 'Recognition → Mimics → Risk Stratification → Fulminant Stabilization → CMR/Biopsy → Disposition',
        categoryId: 'cardiology',
        version: '1.0',
        nodeCount: 23,
        entryNodeId: 'myocarditis-start',
      },
      {
        id: 'chest-pain-hub',
        ...
        version: '1.0',
        nodeCount: 16,
        entryNodeId: 'cp-start',
        type: 'hub',
        displayCategoryId: 'cardiology',
      },
      {
        id: 'palpitations-hub',
        title: 'Palpitations Hub',
        subtitle: 'Sick Check → Time-Critical Exclusions → Initial Bundle → Monitoring → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 16,
        entryNodeId: 'palp-start',
        type: 'hub',
        displayCategoryId: 'cardiology',
      },
    ],
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      {
        id: 'dyspnea-hub',
        title: 'Shortness of Breath Hub',
        subtitle: 'Sick Check → Time-Critical Exclusions → Rescue/Reassess → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 17,
        entryNodeId: 'dysp-start',
        type: 'hub',
        displayCategoryId: 'critical-care',
      },
      {
        id: 'acute-cyanosis-hypoxemia-hub',
        title: 'Cyanosis / Hypoxaemia Hub',
        subtitle: 'Sick Check → Time-Critical Exclusions → Rescue/Reassess → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 19,
        entryNodeId: 'cyanosis-start',
        type: 'hub',
        displayCategoryId: 'critical-care',
      },
      {
      ...
      },
      {
        ...
        version: '1.0',
        nodeCount: 32,
        entryNodeId: 'dic-start',
      },
      {
        id: 'coagulation-cascade',
        title: 'Coagulation Cascade',
        subtitle: 'Pattern Decode \u2192 Lab Toolkit \u2192 Bleeding Workup \u2192 Reversal \u2192 Thrombosis Workup \u2192 Special Populations',
        categoryId: 'critical-care',
        version: '1.0',
        nodeCount: 32,
        entryNodeId: 'coag-start',
      },
      {
        id: 'hemoptysis-hub',
        title: 'Hemoptysis Hub',
        subtitle: 'Sick Check \u2192 Time-Critical Exclusions \u2192 Initial Bundle \u2192 Imaging \u2192 Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 16,
        entryNodeId: 'hmp-start',
        type: 'hub',
        displayCategoryId: 'critical-care',
      },
    ],
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        ...
        subtitle: 'Recognition → Red Flags → O₂/Triptan → Bridge → Verapamil + ECG → Refractory → Dispo',
        categoryId: 'neurology',
        version: '1.0',
        nodeCount: 24,
        entryNodeId: 'cluster-start',
      },
      {
        id: 'headache-hub',
        title: 'Headache Hub',
        subtitle: 'Sick Check → Time-Critical Exclusions → Rescue Cocktail → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.1',
        nodeCount: 23,
        entryNodeId: 'hh-start',
        type: 'hub',
      ...
      {
        id: 'altered-mental-status-hub',
        title: 'Altered Mental Status Hub',
        subtitle: 'Sick Check → Time-Critical Exclusions → Rescue/Reassess → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 18,
        entryNodeId: 'ams-start',
        type: 'hub',
        displayCategoryId: 'neurology',
      },
      {
      ...
      },
      {
        id: 'dizziness-hub',
        title: 'Dizziness Hub',
        subtitle: 'Sick Check → Differential → Timing/Triggers → Consult Links → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 18,
        entryNodeId: 'diz-start',
        type: 'hub',
        displayCategoryId: 'neurology',
      },
      {
      ...
      },
      {
        ...
        version: '1.0',
        nodeCount: 15,
        entryNodeId: 'bp-start',
        type: 'hub',
        displayCategoryId: 'orthopedics',
      },
      {
        id: 'monocular-vision-loss-hub',
        title: 'Monocular Vision Loss Hub',
        subtitle: 'Sick Check → Retinal Stroke/GCA/Glaucoma/Trauma → Rescue → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 17,
        entryNodeId: 'mvl-start',
        type: 'hub',
        displayCategoryId: 'ophthalmology',
      },
      {
        id: 'dental-pain-hub',
        title: 'Dental Pain Hub',
        subtitle: 'Sick Check → Deep Infection/Trauma/Pulpitis → Analgesia → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 18,
        entryNodeId: 'dp-start',
        type: 'hub',
      },
      {
      ...
      },
      {
        ...
        version: '1.0',
        nodeCount: 19,
        entryNodeId: 'nop-start',
        type: 'hub',
        displayCategoryId: 'psychiatry',
      },
      {
        id: 'pelvic-pain-female-hub',
        title: 'Pelvic Pain, Female Hub',
        subtitle: 'Sick Check → Ectopic/Torsion/PID/TOA → Rescue → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 16,
        entryNodeId: 'ppf-start',
        type: 'hub',
        displayCategoryId: 'ob-gyn',
      },
      {
        id: 'vaginal-bleeding-hub',
        title: 'Vaginal Bleeding Hub',
        subtitle: 'Sick Check → Hemorrhage/Pregnancy/AUB → Rescue → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 18,
        entryNodeId: 'vb-start',
        type: 'hub',
        displayCategoryId: 'ob-gyn',
      },
      {
        id: 'crying-infant-hub',
        title: 'Crying Infant Hub',
        subtitle: 'Sick Check → Fever/GI/GU/Trauma/Pain → Rescue → Workup → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 18,
        entryNodeId: 'ci-start',
        type: 'hub',
        displayCategoryId: 'pediatrics',
      },
      {
        id: 'abdominal-pain-hub',
        ...
        type: 'hub',
        displayCategoryId: 'gastroenterology',
      },
      {
        id: 'acute-dyspepsia-epigastric-hub',
        title: 'Epigastric Pain / Dyspepsia Hub',
        subtitle: 'Sick Check → Rule In / Rule Out → Rescue → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 33,
        entryNodeId: 'dysp-start',
      ...
      {
        id: 'lymphadenopathy-hub',
        title: 'Lymphadenopathy Hub',
        subtitle: 'Sick Check → Rule In / Rule Out → Workup Bundle → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 26,
        entryNodeId: 'lad-start',
        type: 'hub',
        displayCategoryId: 'heme-onc',
      },
      {
        id: 'nonspecific-unwell-elderly-hub',
        title: 'Generally Unwell Elderly Hub',
        subtitle: 'Sick Check → Source Hunt → Initial Bundle → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 29,
        entryNodeId: 'unwell-start',
        type: 'hub',
      },
      {
        id: 'anorectal-bleeding-hub',
        title: 'Rectal Bleeding Hub',
        subtitle: 'Sick Check → Localize Source → Initial Bundle → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 27,
        entryNodeId: 'arb-start',
        type: 'hub',
        displayCategoryId: 'gastroenterology',
      },
      {
        id: 'hip-pain-hub',
        title: 'Hip Pain Hub',
        subtitle: 'Sick Check → Age-Anchored Exclusions → Initial Bundle → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 29,
        entryNodeId: 'hip-start',
        type: 'hub',
        displayCategoryId: 'orthopedics',
      },
      {
      ...
      {
        id: 'generalized-pruritus-hub',
        title: 'Generalized Pruritus Hub',
        subtitle: 'Sick Check \u2192 Rule In/Rule Out \u2192 Initial Bundle \u2192 Imaging \u2192 Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 27,
        entryNodeId: 'prur-sick-check',
        type: 'hub',
        displayCategoryId: 'dermatology',
      },
      {
        id: 'proximal-weakness-hub',
        title: 'Proximal Weakness Hub',
        subtitle: 'Sick Check \u2192 Rule In/Rule Out \u2192 Initial Bundle \u2192 Imaging \u2192 Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 27,
        entryNodeId: 'pmw-sick-check',
        type: 'hub',
        displayCategoryId: 'neurology',
      },
      {
        id: 'behavior-change-hub',
        title: 'Behavior Change Hub',
        subtitle: 'Sick Check \u2192 Rule In/Rule Out \u2192 Initial Bundle \u2192 Imaging \u2192 Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 35,
        entryNodeId: 'beh-sick-check',
        type: 'hub',
        displayCategoryId: 'psychiatry',
      },
      {
        ...
        version: '1.0',
        nodeCount: 32,
        entryNodeId: 'otalgia-sick-check',
        type: 'hub',
        displayCategoryId: 'ent',
      },
      {
        id: 'seizure-hub',
        title: 'Seizure Hub',
      ...
      {
        id: 'acute-monoarthritis-hub',
        title: 'Acute Monoarthritis Hub',
        subtitle: 'Sick Check → Time-Critical Exclusions → Initial Bundle → Arthrocentesis → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 15,
        entryNodeId: 'mono-start',
        type: 'hub',
        displayCategoryId: 'nephro-rheum-endo',
      },
      {
        id: 'sore-throat-hub',
        title: 'Sore Throat Hub',
        subtitle: 'Airway Check → Time-Critical Exclusions → Initial Bundle → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 15,
        entryNodeId: 'st-start',
        type: 'hub',
      },
      {
        id: 'palpitations-hub',
      ...
      },
      {
        id: 'gi-bleed-hub',
        title: 'GI Bleed Hub',
        subtitle: 'Sick Check → Source Pattern → Initial Bundle → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 19,
        entryNodeId: 'gib-start',
        type: 'hub',
        displayCategoryId: 'gastroenterology',
      },
      {
        id: 'acute-jaundice-hub',
        title: 'Acute Jaundice Hub',
        subtitle: 'Sick Check → Time-Critical Exclusions → Initial Bundle → Imaging → Dispo',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 21,
        entryNodeId: 'aj-start',
        type: 'hub',
        displayCategoryId: 'gastroenterology',
      },
      {
      ...
      {
        id: 'ptsd-screening',
        title: 'PTSD Screening in the ED',
        subtitle: 'Index Trauma → PC-PTSD-5/PCL-5 → ASD vs PTSD → Brief Intervention → Pharm Pearls → Referral',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 27,
        entryNodeId: 'ptsd-start',
      },
      {
      ...
      {
        id: 'cervical-spine-nontraumatic',
        title: 'Cervical Spine Pain (Non-Traumatic)',
        subtitle: 'Triage → Red Flags → Radiculopathy → Myelopathy → Imaging → Disposition',
        categoryId: 'emergency-medicine',
        version: '1.0',
        nodeCount: 23,
        entryNodeId: 'csnt-start',
      },
    ],
    isCustom: false,
  },
  {
    ...
    decisionTrees: [
      ...
      {
        id: 'rectal-prolapse-reduction',
        title: 'Rectal Prolapse Reduction',
        subtitle: 'Recognition → Viability Gate → Sugar Technique → Manual Reduction → Pediatric → Disposition',
        categoryId: 'gastroenterology',
        version: '1.0',
        nodeCount: 11,
        entryNodeId: 'rpr-start',
      },
      {
        id: 'esophageal-food-bolus',
        title: 'Esophageal Food Bolus',
        subtitle: 'Secretion Triage → Perforation Stop → Timing → Glucagon Bridge → Endoscopy → EoE Biopsy',
        categoryId: 'gastroenterology',
        version: '1.0',
        nodeCount: 11,
        entryNodeId: 'efb-start',
      },
      {
        id: 'ibd-flare',
        title: 'IBD Flare',
      ...
      {
        id: 'adult-appendicitis',
        title: 'Adult Appendicitis',
        subtitle: 'Recognition → AAS / Alvarado → Workup → Imaging → Antibiotics + Surgical Decision → Disposition',
        categoryId: 'gastroenterology',
        version: '1.0',
        nodeCount: 20,
        entryNodeId: 'aa-start',
      },
    ],
    isCustom: false,
  },
  {
    ...
    decisionTrees: [
      ...
      {
        id: 'oncological-emergencies',
        title: 'Oncological Emergencies',
        subtitle: 'Triage → Febrile Neutropenia → TLS → Hypercalcemia → Cord Compression → SVC → Leukostasis → Chemo Reference',
        categoryId: 'heme-onc',
        version: '1.0',
        nodeCount: 25,
        entryNodeId: 'onc-start',
      },
      {
        id: 'coagulation-cascade',
        title: 'Coagulation Cascade',
      ...
      {
        id: 'teg',
        title: 'Thromboelastography (TEG)',
        subtitle: 'When to Use \u2192 Read the Parameters \u2192 Goal-Directed Treatment \u2192 Special Scenarios \u2192 Reassess',
        categoryId: 'heme-onc',
        version: '1.0',
        nodeCount: 12,
        entryNodeId: 'teg-start',
      },
    ],
    isCustom: false,
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        ...
        title: 'Adult Pharyngitis (Strep Throat)',
        subtitle: 'Triage & Red Flags → Centor/McIsaac → GAS Treatment → Complications & Mimics → Disposition',
        categoryId: 'infectious-disease',
        version: '1.0',
        nodeCount: 18,
        entryNodeId: 'ap-start',
  ...
  { id: 'med-calc',             name: 'Med-Calc',              icon: 'med-calc.png',          decisionTrees: [], isCustom: false },
  {
    ...
    decisionTrees: [
      ...
      {
        id: 'calcium-disorders',
        title: 'Calcium Disorders',
        subtitle: 'HypoCa vs HyperCa \u2192 Severity \u2192 IV Therapy \u2192 Etiology \u2192 Renal/Phosphate Caveats',
        categoryId: 'nephro-rheum-endo',
        version: '1.0',
        nodeCount: 12,
        entryNodeId: 'ca-start',
      ...
      {
        id: 'phosphorus-disorders',
        title: 'Phosphorous Disorders',
        subtitle: 'HypoPhos vs HyperPhos \u2192 Replacement/Elimination \u2192 Refeeding/TLS \u2192 CKD/Dialysis',
        categoryId: 'nephro-rheum-endo',
        version: '1.0',
        nodeCount: 11,
        entryNodeId: 'phos-start',
      },
      {
        id: 'magnesium-disorders',
        title: 'Magnesium Disorders',
        subtitle: 'HypoMg vs HyperMg \u2192 Torsades/Replacement \u2192 Toxicity \u2192 Renal/Dialysis',
        categoryId: 'nephro-rheum-endo',
        version: '1.0',
        nodeCount: 12,
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        ...
        subtitle: 'Recognition → MRI Triggers → Burchiel → CBZ + HLA → Ladder → Surgical Referral → Dispo',
        categoryId: 'neurology',
        version: '1.0',
        nodeCount: 15,
        entryNodeId: 'tn-start',
      },
      {
        id: 'headache-hub',
        title: 'Headache Hub',
      ...
      {
        id: 'optic-neuropathy-hub',
        title: 'Optic Neuropathy Hub',
        subtitle: 'Sick Check → Time-Critical Exclusions → Rescue/Reassess → Imaging → Dispo',
        categoryId: 'ophthalmology',
        version: '1.0',
        nodeCount: 21,
        entryNodeId: 'on-hub-start',
        type: 'hub',
      },
      {
        id: 'guillain-barre',
      ...
      },
      {
        ...
        subtitle: 'Recognition \u2192 Simple vs Complex \u2192 Workup \u2192 Active Mgmt \u2192 Disposition \u2192 Mimics',
        categoryId: 'pediatrics',
        version: '1.0',
        nodeCount: 28,
        entryNodeId: 'febsz-start',
      },
      {
        id: 'seizure-hub',
        title: 'Seizure Hub',
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        ...
        subtitle: 'Confirm → Subtype (MS/NMOSD/MOG/Neuroretinitis) → MRI → IV Methylpred → Dispo',
        categoryId: 'ophthalmology',
        version: '1.0',
        nodeCount: 13,
        entryNodeId: 'on-confirm',
      },
    ],
    isCustom: false,
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        ...
        subtitle: 'Triage → Head/C-Spine → Shoulder → Knee → Ankle/Foot → Pediatric → RTP',
        categoryId: 'orthopedics',
        version: '1.0',
        nodeCount: 32,
        entryNodeId: 'sports-start',
      },
      {
        id: 'neck-pain-hub',
        title: 'Neck Pain Hub',
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        ...
        subtitle: 'Suspicion \u2192 TWIST \u2192 Imaging \u2192 Manual Detorsion \u2192 Pediatric \u2192 Atypical',
        categoryId: 'pediatrics',
        version: '1.0',
        nodeCount: 26,
        entryNodeId: 'tt-start',
      },
      {
        id: 'sports-injuries',
        title: 'Sports Injuries',
      ...
      },
      {
        ...
        title: 'Acute Asthma',
        subtitle: 'Triage/PRAM \u2192 Mild-Moderate Tx \u2192 Severe Escalation \u2192 Disposition \u2192 Mimics',
        categoryId: 'pediatrics',
        version: '1.0',
        nodeCount: 18,
        entryNodeId: 'paa-start',
      },
      {
        id: 'peds-dka',
        title: 'DKA with Cerebral Edema Protocol',
        subtitle: 'ISPAD Recognition \u2192 PECARN Fluids \u2192 Insulin (Hour 1) \u2192 Muir Cerebral Edema \u2192 Resolution',
        categoryId: 'pediatrics',
        version: '1.0',
        nodeCount: 19,
        entryNodeId: 'peds-dka-start',
      },
    ],
    isCustom: false,
  },
  {
    ...
    decisionTrees: [
      ...
      {
        id: 'vasopressor-extravasation',
        title: 'Peripheral Vasopressor Extravasation Rescue',
        subtitle: 'Recognition -> Stop/Aspirate -> Phentolamine -> Vasopressin Nuance -> Escalation',
        categoryId: 'pharmacist',
        version: '1.0',
        nodeCount: 16,
        entryNodeId: 'vex-start',
      },
      {
        id: 'high-dose-insulin',
        title: 'High Dose Insulin Protocol',
        subtitle: 'Indications -> Setup -> Insulin/Dextrose/K -> Titration -> Wean',
        categoryId: 'pharmacist',
        version: '1.0',
        nodeCount: 22,
        entryNodeId: 'hdi-start',
      },
      {
        id: 'potassium-infusion',
        title: 'Potassium Infusion Protocol',
        subtitle: 'Indication -> Contraindications -> Access/Rate -> Monitoring -> Disposition',
        categoryId: 'pharmacist',
        version: '1.0',
        nodeCount: 12,
        entryNodeId: 'kclinf-start',
      },
      {
        id: 'heparin-infusion',
        title: 'Unfractionated Heparin Infusion Protocol',
        subtitle: 'Indication -> Bolus Strategy -> Monitoring -> Reversal -> Transition',
        categoryId: 'pharmacist',
        version: '1.0',
        nodeCount: 12,
        entryNodeId: 'ufhinf-start',
      },
      {
        id: 'hypertonic-saline-protocol',
        title: 'Hypertonic Saline Protocol',
        subtitle: 'Herniation -> Hyponatremia -> Sodium Limits -> Access -> Disposition',
        categoryId: 'pharmacist',
        version: '1.0',
        nodeCount: 9,
        entryNodeId: 'hts-start',
      },
      {
        id: 'scape-nitroglycerin',
        title: 'SCAPE High-Dose Nitroglycerin',
        subtitle: 'Recognize -> NIV -> High-Dose Nitro -> Monitoring -> Nitroprusside Nuance',
        categoryId: 'pharmacist',
        version: '1.0',
        nodeCount: 12,
        entryNodeId: 'scape-start',
      },
      {
        id: 'thrombolytic-protocols',
        title: 'Thrombolytic Protocols',
        subtitle: 'Stroke -> STEMI -> Massive PE -> Arrest -> Bleeding Plan',
        categoryId: 'pharmacist',
        version: '1.0',
        nodeCount: 14,
        entryNodeId: 'lytics-start',
      },
      {
        id: 'sodium-bicarbonate-drip',
        title: 'Sodium Bicarbonate Drip Protocol',
        subtitle: 'Indications -> Recipe -> Tox Targets -> Monitoring -> Stop Criteria',
        categoryId: 'pharmacist',
        version: '1.0',
        nodeCount: 11,
        entryNodeId: 'bicarbdrip-start',
      },
    ],
    isCustom: false,
  },
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        ...
        subtitle: 'Readiness \u2192 Airway Setup \u2192 Agent Choice \u2192 Monitoring \u2192 Recovery',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 13,
        entryNodeId: 'ps-start',
      },
      {
        id: 'joint-arthrocentesis',
        title: 'Emergency Joint Arthrocentesis',
        subtitle: 'Indication \u2192 Safe Route \u2192 Tap Technique \u2192 Fluid Interpretation \u2192 Disposition',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 13,
        entryNodeId: 'arth-start',
      ...
      {
        id: 'difficult-vascular-access',
        title: 'Difficult Vascular Access',
        subtitle: 'US-Guided PIV \u2192 IO Access \u2192 Confirmation \u2192 Complications',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 13,
      ...
      },
      {
        ...
        version: '1.0',
        nodeCount: 13,
        entryNodeId: 'para-start',
      },
      {
        id: 'occipital-nerve-block',
        title: 'Greater Occipital Nerve Block',
        subtitle: 'Indication \u2192 Anatomy \u2192 Technique \u2192 Post-procedure \u2192 Complications',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 14,
        entryNodeId: 'onb-start',
        type: 'procedure',
      },
      {
        id: 'facial-nerve-block',
        title: 'Facial Peripheral Nerve Block',
        subtitle: 'Region \u2192 Pre-procedure \u2192 Block (8 sites) \u2192 Verify & Document',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 16,
        entryNodeId: 'fnb-start',
        type: 'procedure',
      },
      {
        id: 'dental-nerve-blocks',
        title: 'Dental / Intraoral Nerve Blocks',
        subtitle: 'Tooth/region \u2192 Pre-procedure \u2192 Maxillary & Mandibular blocks \u2192 Verify & Document',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 17,
        entryNodeId: 'dnb-start',
        type: 'procedure',
      },
      {
        id: 'ingrown-toenail-avulsion',
        title: 'Ingrown Toenail: Avulsion + Phenol',
        subtitle: 'Assess \u2192 Digital Block \u2192 Avulsion \u2192 Phenol Matrixectomy \u2192 Aftercare',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 15,
        entryNodeId: 'itn-start',
        type: 'procedure',
      },
      {
        id: 'tar-burn-removal',
        title: 'Tar / Asphalt Burn Removal',
        subtitle: 'Cool \u2192 Dissolve (don\u2019t peel) \u2192 Reassess Depth \u2192 Disposition',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 8,
        entryNodeId: 'tar-start',
        type: 'procedure',
      },
      {
        id: 'continuous-bladder-irrigation',
        title: 'Continuous Bladder Irrigation (Clot Retention)',
        subtitle: '3-Way Catheter \u2192 Manual Clot Evacuation \u2192 CBI Titration \u2192 Stop-Check',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 10,
        entryNodeId: 'cbi-start',
        type: 'procedure',
      },
      {
        id: 'tendon-sheath-injection',
        title: 'Tendon-Sheath Injection: de Quervain + Trigger Finger',
        subtitle: 'Diagnose \u2192 Select Target \u2192 Landmarks \u2192 Sheath Confirmation \u2192 Aftercare',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 11,
        entryNodeId: 'tsi-start',
        type: 'procedure',
      },
      {
        id: 'cyanoacrylate-removal',
        title: 'Super Glue (Cyanoacrylate) Removal',
        subtitle: 'Triage \u2192 Rule Out Globe Injury \u2192 De-adhesion \u2192 Fluorescein Check',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 9,
        entryNodeId: 'cya-start',
        type: 'procedure',
      },
      {
        id: 'extensor-tendon',
      ...
      {
        id: 'penile-zipper-release',
        title: 'Penile Zipper Entrapment Release',
        subtitle: 'Triage → Pain Control → Technique Selector → Wound Care → Tetanus → Urology Criteria',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 20,
        entryNodeId: 'pzr-start',
        type: 'procedure',
      },
    ],
    isCustom: false,
  },
  {
    ...
    decisionTrees: [
      ...
      {
        id: 'terrestrial-envenomation',
        title: 'Terrestrial Envenomations',
        subtitle: 'Triage → Identify Organism → Spider → Scorpion → Hymenoptera → Disposition',
        categoryId: 'toxicology',
        version: '1.0',
        nodeCount: 20,
        entryNodeId: 'te-start',
      },
      {
        id: 'unknown-ingestion-hub',
        title: 'Unknown Ingestion Hub',
        subtitle: 'Sick Check → Toxidrome Match → Resus/Decon/Antidote → Imaging → Disposition',
        categoryId: 'toxicology',
        version: '1.0',
        nodeCount: 22,
        entryNodeId: 'ui-start',
        type: 'hub',
        displayCategoryId: 'toxicology',
      },
    ],
    isCustom: false,
  },
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      },
      {
        ...
        subtitle: 'Recognize \u2192 Red Flags \u2192 Stage & Score \u2192 Acute Flare \u2192 Ladder \u2192 Comorbidities \u2192 Disposition',
...
export const CATEGORY_COLORS: Record<string, { card: string; iconBg: string; textColor?: string; outline?: string }> = {
  ...
  'dermatology':         { card: '#00897B', iconBg: '#00897B' },
  'ent':                 { card: '#5D4037', iconBg: '#5D4037' },
};
