...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    decisionTrees: [
      ...
      {
        id: 'auricular-hematoma-drainage',
        title: 'Auricular Hematoma Drainage',
        subtitle: 'Timing → Auriculotemporal Block → Aspirate vs I&D → Bolster → Antibiotics → ENT Followup',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 17,
        entryNodeId: 'ahd-start',
      },
      {
        id: 'corneal-fb-removal',
        title: 'Corneal Foreign Body Removal',
        subtitle: 'Seidel + VA → Anesthetic → Lid Eversion → Removal Ladder → Rust Ring → Drop Selector',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 16,
      ...
      },
      {
        ...
        subtitle: 'Closure Picker → Lido Max Dose → LET Topical → Site Specials → Tetanus + Antibiotics',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 24,
        entryNodeId: 'lac-start',
      },
      {
        id: 'ring-removal',
        title: 'Ring Removal',
        subtitle: 'Material ID → String-Wrap → Cutter Picker → Diamond Tool → Neurovascular Check',
        categoryId: 'procedures',
        version: '1.0',
        nodeCount: 17,
        entryNodeId: 'ring-start',
      },
    ],
    isCustom: false,
  },
