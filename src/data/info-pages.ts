...
const EPSS_MEASUREMENT_PAGE: InfoPage = {
  id: 'epss-measurement',
...
const UTI_STEPS_SUMMARY: InfoPage = {
  id: 'uti-steps',
  title: 'Adult UTI',
...
const UTI_UA_INTERPRETATION: InfoPage = {
...
const UTI_CLASSIFICATION_TABLE: InfoPage = {
...
const UTI_SPECIAL_POPULATIONS: InfoPage = {
  id: 'uti-special-pops',
...
const DIARRHEA_ETIOLOGY: InfoPage = {
...
const ANGIO_STEPS_SUMMARY: InfoPage = {
...
const ANGIO_DIFFERENTIATION: InfoPage = {
...
const ANGIO_ISHOO_STAGING: InfoPage = {
...
const ANGIO_HAE_TYPES: InfoPage = {
  id: 'angio-hae-types',
...
const ANGIO_DISCHARGE: InfoPage = {
  id: 'angio-discharge',
...
const ANGIO_ACEI_ALTERNATIVES: InfoPage = {
...
const SCD_STEPS_SUMMARY: InfoPage = {
...
const SCD_DIFFERENTIAL: InfoPage = {
  id: 'scd-differential',
...
const SCD_VOC_ALGORITHM: InfoPage = {
...
const SCD_TRANSFUSION: InfoPage = {
  id: 'scd-transfusion',
...
const SCD_SCT_COMPLICATIONS: InfoPage = {
...
const SAL_STEPS_SUMMARY: InfoPage = {
...
const SAL_ALKALINIZE_PROTOCOL: InfoPage = {
...
const SAL_DEATH_SPIRAL: InfoPage = {
  id: 'sal-death-spiral',
...
const SAL_CHRONIC_RECOGNITION: InfoPage = {
...
const SAL_LEVEL_INTERPRETATION: InfoPage = {
...
const TCA_STEPS_SUMMARY: InfoPage = {
...
const TCA_ECG_FINDINGS: InfoPage = {
  id: 'tca-ecg-findings',
...
const TCA_BICARB_PROTOCOL: InfoPage = {
...
const TCA_NA_BLOCKERS: InfoPage = {
  id: 'tca-na-blockers',
...
const TCA_DIFFERENTIAL: InfoPage = {
  id: 'tca-differential',
  title: 'Differential Diagnosis',
...
const TCA_SEIZURE_GUIDE: InfoPage = {
...
const TCA_DISPOSITION_CRITERIA: InfoPage = {
...
const SEPSIS_ABX_TABLE: InfoPage = {
  id: 'sepsis-abx-table',
...
const SEPSIS_SOURCE_CONTROL: InfoPage = {
...
const SEPSIS_VP_COMPARISON: InfoPage = {
...
const SEPSIS_FLUID_GUIDE: InfoPage = {
...
const SEPSIS_CARDIOMYOPATHY_PAGE: InfoPage = {
...
const SEPSIS_SEP1_BUNDLE: InfoPage = {
...
const OW_MEDS_COMPARE: InfoPage = {
  id: 'ow-meds-compare',
...
const AW_PHENOBARB_GUIDE: InfoPage = {
...
const AW_AUD_COMPARISON: InfoPage = {
...
const AW_SUPPORTIVE_CARE: InfoPage = {
...
const AW_WITHDRAWAL_TIMING: InfoPage = {
...
const AW_ICU_CRITERIA: InfoPage = {
  id: 'aw-icu-criteria',
...
const AW_PB_CONTRAINDICATIONS: InfoPage = {
...
const HEMO_COAG_CASCADE: InfoPage = {
...
const HEMO_FACTOR_PRODUCTS: InfoPage = {
...
const HEMO_INHIBITOR_GUIDE: InfoPage = {
...
const HEMO_VWF_DOSING: InfoPage = {
  id: 'hemo-vwf-dosing',
...
const HEMO_EMERGENT_DOSING: InfoPage = {
...
const TB_STEPS_SUMMARY: InfoPage = {
  id: 'tb-steps-summary',
...
const TB_AFB_NAA_ALGORITHM: InfoPage = {
...
const TB_TREATMENT_REGIMENS: InfoPage = {
...
const TB_HIV_CONSIDERATIONS: InfoPage = {
...
const TB_HEPATOTOX_GUIDE: InfoPage = {
...
const TB_PATIENT_INFO: InfoPage = {
  id: 'tb-patient-info',
...
const TB_RISK_FACTORS: InfoPage = {
  id: 'tb-risk-factors',
...
const ED_METHADONE_SUMMARY: InfoPage = {
...
const CHS_DISCHARGE_INSTRUCTIONS: InfoPage = {
...
const TDP_STEPS_SUMMARY: InfoPage = {
...
const TDP_QUICK_TREATMENT: InfoPage = {
...
const TDP_ECG_RECOGNITION: InfoPage = {
...
const CT_STEPS_SUMMARY: InfoPage = {
  id: 'ct-steps-summary',
...
const CT_RADIATION_DOSES: InfoPage = {
...
const CT_SPECIAL_POPULATIONS: InfoPage = {
...
const CT_DOCUMENTATION: InfoPage = {
  id: 'ct-documentation',
...
const CT_CHOOSING_WISELY: InfoPage = {
...
const DFSA_DETECTION_WINDOWS: InfoPage = {
...
const DFSA_SOFT_PANEL: InfoPage = {
  id: 'dfsa-soft-panel',
...
const DFSA_SPECIMEN_GUIDE: InfoPage = {
...
const DFSA_STI_REGIMENS: InfoPage = {
...
const DFSA_PATIENT_HANDOUT: InfoPage = {
...
const CA_NO_CPR_CRITERIA: InfoPage = {
...
const PEA_RUSH_PROTOCOL: InfoPage = {
...
const PEA_WIDE_NARROW: InfoPage = {
  id: 'pea-wide-narrow',
...
const LP_MIDLINE_STEPS: InfoPage = {
  id: 'lp-midline-steps',
...
const LP_PARAMEDIAN_STEPS: InfoPage = {
...
const MS_DMT_REFERENCE: InfoPage = {
  id: 'ms-dmt-reference',
...
const ASTHMA_STEPS_SUMMARY: InfoPage = {
  id: 'asthma-steps',
...
const ASTHMA_SEVERITY_TABLE: InfoPage = {
...
const ASTHMA_BIPAP_GUIDE: InfoPage = {
...
const ASTHMA_INTUBATION_APPROACH: InfoPage = {
...
const ASTHMA_VENT_STRATEGY: InfoPage = {
...
const TTP_STEPS_SUMMARY: InfoPage = {
  id: 'ttp-steps',
  title: 'TTP',
  subtitle: 'Key Steps Overview',
  sections: [
...
const TTP_TREATMENT_SUMMARY: InfoPage = {
  id: 'ttp-treatment',
