...
const LEARN_TX_MH_CODE: InfoPage = {
  id: 'learn-tx-mh-code',
...
const LEARN_LITHIUM_TOXICITY: InfoPage = {
...
const LEARN_TX_EDO_HANDOUT: InfoPage = {
...
const DRILL_SUICIDE_FEEDBACK: InfoPage = {
...
const DRILL_CAPACITY_FEEDBACK: InfoPage = {
...
const DRILL_SBIRT_FEEDBACK: InfoPage = {
...
export const LEARN_INFO_PAGES: Record<string, InfoPage> = {
...
export function getAllLearnInfoPages(): InfoPage[] {
