...
export const TOOLBAR_CONFIGS: Record<string, ToolbarItem[]> = {
  'hemoptysis-hub': [
  ...
  'abdominal-pain-hub': [
    { id: 'ap-alvarado', label: 'Alvarado', icon: '🧮', action: 'calculator', target: 'alvarado', pinned: true },
    { id: 'ap-bisap', label: 'BISAP', icon: '🧮', action: 'calculator', target: 'bisap', pinned: true },
    { id: 'ap-gbs', label: 'Glasgow-Blatchford', icon: '🧮', action: 'calculator', target: 'gbs', pinned: true },
    { id: 'ap-aims65', label: 'AIMS65', icon: '📊', action: 'calculator', target: 'aims65' },
    { id: 'ap-oakland', label: 'Oakland', icon: '📊', action: 'calculator', target: 'oakland-score' },
    { id: 'ap-triage', label: 'Rule In/Out', icon: '🚩', action: 'jump', target: 'ap-triage' },
  ...
  'acute-dyspepsia-epigastric-hub': [
    { id: 'dysp-heart', label: 'HEART', icon: '🧮', action: 'calculator', target: 'heart-score', pinned: true },
    { id: 'dysp-gbs', label: 'Glasgow-Blatchford', icon: '🧮', action: 'calculator', target: 'gbs', pinned: true },
    { id: 'dysp-aims65', label: 'AIMS65', icon: '📊', action: 'calculator', target: 'aims65' },
    { id: 'dysp-bisap', label: 'BISAP', icon: '📊', action: 'calculator', target: 'bisap' },
    { id: 'dysp-triage-btn', label: 'Rule In/Out', icon: '🚩', action: 'jump', target: 'dysp-triage' },
  ...
  'lymphadenopathy-hub': [
    { id: 'lad-qsofa', label: 'qSOFA', icon: '🧮', action: 'calculator', target: 'qsofa', pinned: true },
    { id: 'lad-triage-btn', label: 'Rule In/Out', icon: '🚩', action: 'jump', target: 'lad-triage' },
    { id: 'lad-rescue-btn', label: 'Workup', icon: '💉', action: 'jump', target: 'lad-rescue' },
    { id: 'lad-imaging-btn', label: 'Imaging', icon: '🔬', action: 'jump', target: 'lad-imaging' },
  ],
  'nonspecific-unwell-elderly-hub': [
    { id: 'unwell-qsofa', label: 'qSOFA', icon: '🧮', action: 'calculator', target: 'qsofa', pinned: true },
    { id: 'unwell-4at', label: '4AT', icon: '🧮', action: 'calculator', target: '4at', pinned: true },
    { id: 'unwell-shock', label: 'Shock Index', icon: '📊', action: 'calculator', target: 'shock-index' },
    { id: 'unwell-triage-btn', label: 'Source Hunt', icon: '🚩', action: 'jump', target: 'unwell-triage' },
    { id: 'unwell-rescue-btn', label: 'Bundle', icon: '💉', action: 'jump', target: 'unwell-rescue' },
    { id: 'unwell-imaging-btn', label: 'Imaging', icon: '🔬', action: 'jump', target: 'unwell-imaging' },
  ],
  ...
  'chest-pain-hub': [
    { id: 'cp-heart', label: 'HEART', icon: '🧮', action: 'calculator', target: 'heart-score', pinned: true },
    { id: 'cp-timi', label: 'TIMI', icon: '📊', action: 'calculator', target: 'timi', pinned: true },
    { id: 'cp-sgarbossa', label: 'Sgarbossa', icon: '📈', action: 'calculator', target: 'sgarbossa', pinned: true },
    { id: 'cp-add-rs', label: 'ADD-RS', icon: '🧮', action: 'calculator', target: 'aas-score' },
    { id: 'cp-wells-pe', label: 'Wells PE', icon: '🧮', action: 'calculator', target: 'wells-pe' },
    { id: 'cp-perc', label: 'PERC', icon: '✅', action: 'calculator', target: 'perc-rule' },
    { id: 'cp-triage', label: 'Rule In/Out', icon: '🚩', action: 'jump', target: 'cp-triage' },
    { id: 'cp-rescue-btn', label: 'Rescue', icon: '💉', action: 'jump', target: 'cp-rescue' },
    { id: 'cp-imaging-btn', label: 'Imaging', icon: '🔬', action: 'jump', target: 'cp-imaging' },
  ],
  'dyspnea-hub': [
    { id: 'dysp-wells-pe', label: 'Wells PE', icon: '🧮', action: 'calculator', target: 'wells-pe', pinned: true },
    { id: 'dysp-geneva', label: 'Geneva', icon: '🧮', action: 'calculator', target: 'revised-geneva', pinned: true },
    { id: 'dysp-perc', label: 'PERC', icon: '✅', action: 'calculator', target: 'perc-rule', pinned: true },
    { id: 'dysp-pesi', label: 'PESI', icon: '📊', action: 'calculator', target: 'pesi' },
    { id: 'dysp-curb65', label: 'CURB-65', icon: '🫁', action: 'calculator', target: 'curb-65' },
    { id: 'dysp-psi', label: 'PSI/PORT', icon: '🫁', action: 'calculator', target: 'psi-port' },
    { id: 'dysp-qsofa', label: 'qSOFA', icon: '⚠️', action: 'calculator', target: 'qsofa' },
  ...
  'transverse-myelitis': [
    { id: 'tm-mri', label: 'MRI Gate', icon: '🧲', action: 'jump', target: 'tm-mri-gate' },
    { id: 'tm-compress', label: 'Compression', icon: '🚨', action: 'jump', target: 'tm-compression' },
    { id: 'tm-workup', label: 'Workup', icon: '🧪', action: 'jump', target: 'tm-workup' },
    { id: 'tm-criteria', label: 'Criteria', icon: '📋', action: 'jump', target: 'tm-criteria-node' },
    { id: 'tm-tx', label: 'Treatment', icon: '💉', action: 'jump', target: 'tm-treatment' },
    { id: 'tm-ddx', label: 'DDx/Mimics', icon: '🔀', action: 'jump', target: 'tm-differential' },
    { id: 'tm-etiology', label: 'Etiology', icon: '🧬', action: 'jump', target: 'tm-etiology' },
  ],
  'tick-paralysis': [
    { id: 'tp-find', label: 'Find Tick', icon: '🔍', action: 'jump', target: 'tp-find' },
    { id: 'tp-remove', label: 'Removal', icon: '🪝', action: 'jump', target: 'tp-remove' },
    { id: 'tp-monitor', label: 'Monitor', icon: '🫁', action: 'jump', target: 'tp-monitor' },
    { id: 'tp-geography', label: 'Geography', icon: '🗺️', action: 'jump', target: 'tp-geography' },
    { id: 'tp-ddx', label: 'DDx/Mimics', icon: '🔀', action: 'jump', target: 'tp-differential' },
    { id: 'tp-dispo', label: 'Disposition', icon: '🏥', action: 'jump', target: 'tp-disposition' },
    { id: 'tp-prognosis', label: 'Prognosis', icon: '📈', action: 'jump', target: 'tp-prognosis' },
  ],
  'lambert-eaton': [
    { id: 'lems-delta-p', label: 'Cancer Risk', icon: '📊', action: 'calculator', target: 'lems-delta-p' },
    { id: 'lems-fvc', label: 'FVC/NIF', icon: '🫁', action: 'calculator', target: 'mg-fvc-nif' },
    { id: 'lems-avoid', label: 'Drugs Avoid', icon: '⛔', action: 'jump', target: 'lems-avoid' },
    { id: 'lems-mg', label: 'vs MG', icon: '🔀', action: 'jump', target: 'lems-mg-compare' },
    { id: 'lems-dx', label: 'Diagnosis', icon: '🧪', action: 'jump', target: 'lems-diagnosis' },
    { id: 'lems-triad', label: 'Triad', icon: '📋', action: 'jump', target: 'lems-triad' },
    { id: 'lems-cancer', label: 'Cancer Search', icon: '🎯', action: 'jump', target: 'lems-cancer' },
    { id: 'lems-tx', label: 'Treatment', icon: '💉', action: 'jump', target: 'lems-treatment' },
  ],
  'b12-deficiency': [
    { id: 'b12-gray-zone', label: 'Gray-Zone', icon: '🧮', action: 'calculator', target: 'b12-gray-zone' },
    { id: 'b12-dx', label: 'Diagnosis', icon: '🧪', action: 'jump', target: 'b12-diagnosis' },
    { id: 'b12-traps', label: 'Pitfalls', icon: '🚨', action: 'jump', target: 'b12-traps' },
    { id: 'b12-tx', label: 'Repletion', icon: '💊', action: 'jump', target: 'b12-treatment' },
    { id: 'b12-etiology', label: 'Etiology', icon: '🧬', action: 'jump', target: 'b12-etiology' },
    { id: 'b12-ddx', label: 'DDx/Mimics', icon: '🔀', action: 'jump', target: 'b12-differential' },
    { id: 'b12-dispo', label: 'Disposition', icon: '🏥', action: 'jump', target: 'b12-disposition' },
  ],
  'parkinson-ed': [
