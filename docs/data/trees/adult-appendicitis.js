...
export const ADULT_APPENDICITIS_NODES = [
    // ===================================================================
...
export const ADULT_APPENDICITIS_CITATIONS = [
    ...
    { num: 7, text: 'Brown JJS, Wilson C, Coleman S, Joypaul BV. Appendicitis in pregnancy: an ongoing diagnostic dilemma. Colorectal Dis. 2009;11(2):116-122. doi:10.1111/j.1463-1318.2008.01594.x. PMID 18513191.' },
    { num: 8, text: 'Chamisa I. A clinicopathological review of 324 appendices removed for acute appendicitis in Durban, South Africa: a retrospective analysis. Ann R Coll Surg Engl. 2009;91(8):688-692. doi:10.1308/003588409X12486167521677. PMID 19909612.' },
    ...
    { num: 16, text: 'CODA Collaborative; Flum DR, Davidson GH, Monsell SE, et al. A randomized trial comparing antibiotics with appendectomy for appendicitis. N Engl J Med. 2020;383(20):1907-1919. doi:10.1056/NEJMoa2014320. PMID 33017106.' },
    { num: 17, text: 'Mazuski JE, Tessier JM, May AK, et al. The Surgical Infection Society revised guidelines on the management of intra-abdominal infection. Surg Infect (Larchmt). 2017;18(1):1-76. doi:10.1089/sur.2016.261. PMID 28085573. (SIS 2017)' },
    { num: 18, text: 'CODA Collaborative; Davidson GH, Flum DR, Monsell SE, et al. Antibiotics versus appendectomy for acute appendicitis — longer-term outcomes. N Engl J Med. 2021;385(25):2395-2397. doi:10.1056/NEJMc2116018. PMID 34694761.' },
    { num: 19, text: 'Salminen P, Tuominen R, Paajanen H, et al. Five-year follow-up of antibiotic therapy for uncomplicated acute appendicitis in the APPAC randomized clinical trial. JAMA. 2018;320(12):1259-1265. doi:10.1001/jama.2018.13201. PMID 30264120. (APPAC)' },
    { num: 20, text: 'Klein AC, Rasel H, Kriege O, Bartsch F, Lang H, Lederer AK. Acute appendicitis in patients suffering from immunocompromising hematologic malignancies or chemotherapy-related leukopenia: a cohort study. BMC Cancer. 2025;25(1):1130. doi:10.1186/s12885-025-14493-2. PMID 40596935.' },
];
