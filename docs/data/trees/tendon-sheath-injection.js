...
export const TENDON_SHEATH_INJECTION_NODES = [
    // ============================================================
...
export const TENDON_SHEATH_INJECTION_CRITICAL_ACTIONS = [
    ...
    { text: 'Persistent or recurrent cases go to hand surgery; repeat injections have diminishing returns.', nodeId: 'tsi-aftercare' },
    { text: 'In de Quervain, watch for an EPB subcompartment septum \u2014 a cause of injection failure; ultrasound guidance improves accuracy if available.', nodeId: 'tsi-dq-landmark' },
];
export const TENDON_SHEATH_INJECTION_CITATIONS = [
    { num: 1, text: 'Tallia AF, Cardone DA. Diagnostic and therapeutic injection of the wrist and hand region. Am Fam Physician. 2003;67(4):745-750. PMID 12613728.' },
    { num: 2, text: 'Makkouk AH, Oetgen ME, Swigart CR, Dodds SD. Trigger finger: etiology, evaluation, and treatment. Curr Rev Musculoskelet Med. 2008;1(2):92-96. PMID 19468879.' },
    { num: 3, text: 'Kennedy CD, Huang JI, Hanel DP. In Brief: Kanavel\u2019s Signs and Pyogenic Flexor Tenosynovitis. Clin Orthop Relat Res. 2016;474(1):280-284. PMID 26022113.' },
    { num: 4, text: 'Birnbaumer DM, ed. Roberts and Hedges\u2019 Clinical Procedures in Emergency Medicine and Acute Care. 8th ed. Philadelphia: Elsevier; 2025. Ch. 53, Treatment of Bursitis, Tendinitis, and Trigger Points. ISBN 9780323779227.' },
    { num: 5, text: 'Goel R, Abzug JM. de Quervain\u2019s tenosynovitis: a review of the rehabilitative options. Hand (N Y). 2015;10(1):1-5. PMID 25762881.' },
    { num: 6, text: 'Peters-Veluthamaningal C, van der Windt DA, Winters JC, Meyboom-de Jong B. Corticosteroid injection for trigger finger in adults. Cochrane Database Syst Rev. 2009;2009(1):CD005617. PMID 19160256. (Not withdrawn and not updated since 2009; see reference 12 for the current synthesis.)' },
    { num: 7, text: 'Kamel SI, Rosas HG, Gorbachova T. Local and Systemic Side Effects of Corticosteroid Injections for Musculoskeletal Indications. AJR Am J Roentgenol. 2024;222(3):e2330458. PMID 38117096.' },
    { num: 8, text: 'Mardani-Kivi M, Karimi-Mobarakeh M, Babaei Jandaghi A, Keyhani S, Saheb-Ekhtiari K, Hashemi-Motlagh K. Intra-sheath versus extra-sheath ultrasound guided corticosteroid injection for trigger finger: a triple blinded randomized clinical trial. Phys Sportsmed. 2018;46(1):93-97. PMID 29125382.' },
    { num: 9, text: 'Cevik J, Keating N, Hornby A, Salehi O, Seth I, Rozen WM. Corticosteroid injection versus immobilisation for the treatment of De Quervain\u2019s tenosynovitis: A systematic review and meta-analysis. Hand Surg Rehabil. 2024;43(3):101694. PMID 38642740.' },
    { num: 10, text: 'Abi-Rafeh J, Mojtahed Jaberi M, Kazan R, Alabdulkarim A, Boily M, Thibaudeau S. Utility of Ultrasonography and Significance of Surgical Anatomy in the Management of de Quervain Disease: A Systematic Review. Plast Reconstr Surg. 2022;149(2):420-434. PMID 35077418.' },
    { num: 11, text: 'Akhtar S, Burke FD. Study to outline the efficacy and illustrate techniques for steroid injection for trigger finger and thumb. Postgrad Med J. 2006;82(973):763-766. PMID 17099099.' },
    { num: 12, text: 'Kuper G, Da Silva D, Carr M, Brown E. Comparative effectiveness of corticosteroid injections for trigger finger: A systematic review of randomized controlled trials. J Plast Reconstr Aesthet Surg. 2026;113:332-341. PMID 41352303.' },
];
