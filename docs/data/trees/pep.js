...
export const PEP_CRITICAL_ACTIONS = [
    ...
    { text: 'Preferred PEP regimen: tenofovir DF/emtricitabine + dolutegravir x 28 days', nodeId: 'pep-regimen' },
    { text: 'HIV transmission risk: receptive anal highest (1.4%), then insertive anal (0.11%), receptive vaginal (0.08%)', nodeId: 'pep-fluid' },
    { text: 'Baseline HIV rapid test + HepB/C, CBC, CMP, pregnancy test before starting PEP', nodeId: 'pep-workup' },
    { text: 'Source patient testing: rapid HIV test (if consents), HepB/C status', nodeId: 'pep-source' },
    { text: 'PEP reduces transmission risk by >80% when taken correctly', nodeId: 'pep-start' },
    { text: 'Follow-up HIV testing at 4-6 weeks, 3 months, and 6 months after exposure', nodeId: 'pep-followup' },
    { text: 'Do NOT wait for source patient HIV results to start PEP (can discontinue if source negative)', nodeId: 'pep-timing' },
    { text: 'Occupational exposure: sharps injury from HIV+ source = start PEP immediately', nodeId: 'pep-fluid' },
    { text: 'Common side effects: GI upset, headache, fatigue (usually resolve after first week)', nodeId: 'pep-regimen' },
];
// Evidence Citations
// -------------------------------------------------------------------
