...
// in the same commit.
export const OCCIPITAL_NERVE_BLOCK_NODES = [
    // ============================================================
...
export const OCCIPITAL_NERVE_BLOCK_CRITICAL_ACTIONS = [
    ...
    { text: 'Avoid steroid adjunct in pregnancy; limit repeated steroid blocks to ≤4 per year.', nodeId: 'onb-setup' },
];
export const OCCIPITAL_NERVE_BLOCK_CITATIONS = [
    { num: 1, text: 'Robbins MS, Starling AJ, Pringsheim TM, Becker WJ, Schwedt TJ. Treatment of Cluster Headache: The American Headache Society Evidence-Based Guidelines. Headache. 2016;56(7):1093-1106. (Confirm latest AHS cluster update at citation-freeze step per PLAN.md §13a.)' },
    ...
    { num: 3, text: 'Headache Classification Committee of the International Headache Society (IHS). The International Classification of Headache Disorders, 3rd edition. Cephalalgia. 2018;38(1):1-211. (ICHD-3)' },
    { num: 4, text: 'Horlocker TT, Vandermeuelen E, Kopp SL, Gogarten W, Leffert LR, Benzon HT. Regional Anesthesia in the Patient Receiving Antithrombotic or Thrombolytic Therapy: American Society of Regional Anesthesia and Pain Medicine Evidence-Based Guidelines (Fourth Edition). Reg Anesth Pain Med. 2018;43(3):263-309.' },
    { num: 5, text: 'Ailani J, Burch RC, Robbins MS; Board of Directors of the American Headache Society. The American Headache Society Consensus Statement: Update on integrating new migraine treatments into clinical practice. Headache. 2021;61(7):1021-1039.' },
    { num: 6, text: 'Tubbs RS, Salter EG, Wellons JC 3rd, Blount JP, Oakes WJ. Landmarks for the identification of the cutaneous nerves of the occiput and nuchal regions. Clin Anat. 2007;20(3):235-238.' },
    { num: 7, text: 'Loukas M, El-Sedfy A, Tubbs RS, et al. Identification of greater occipital nerve landmarks for the treatment of occipital neuralgia. Folia Morphol. 2006;65(4):337-342.' },
    { num: 8, text: 'Tobin J, Flitman S. Occipital nerve blocks: when and what to inject? Headache. 2009;49(10):1521-1533.' },
    { num: 9, text: 'Ashkenazi A, Matro R, Shaw JW, Abbas MA, Silberstein SD. Greater occipital nerve block using local anaesthetics alone or with triamcinolone for transformed migraine: a randomised comparative study. J Neurol Neurosurg Psychiatry. 2008;79(4):415-417.' },
    { num: 10, text: 'Cuadrado ML, Aledo-Serrano A, Navarro P, et al. Short-term effects of greater occipital nerve blocks in chronic migraine: A double-blind, randomised, placebo-controlled clinical trial. Cephalalgia. 2017;37(9):864-872.' },
    { num: 11, text: 'Lavin PJ, Workman R. Cushing syndrome induced by serial occipital nerve blocks containing corticosteroids. Headache. 2001;41(9):902-904.' },
    { num: 12, text: 'Levin M. Nerve blocks in the treatment of headache. Neurotherapeutics. 2010;7(2):197-203.' },
    { num: 13, text: 'Leroux E, Valade D, Taifas I, et al. Suboccipital steroid injections for transitional treatment of patients with more than two cluster headache attacks per day: a randomised, double-blind, placebo-controlled trial. Lancet Neurol. 2011;10(10):891-897.' },
];
