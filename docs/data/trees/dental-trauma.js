...
export const DENTAL_TRAUMA_NODES = [
    // =====================================================================
    ...
    },
    {
        ...
        body: '**Post-reimplantation care:** [1][2][9]\n\n**Antibiotics (strongly recommended) — IADT 2020:**\n• **First-line (all ages): [Amoxicillin](#/drug/amoxicillin/dental) 500 mg TID × 7 days** (peds: 25 mg/kg/day divided TID). Amoxicillin/penicillin are the IADT first choice — effective against oral flora, low side-effect profile. [1]\n• **PCN allergy: [Clindamycin](#/drug/clindamycin/dental) 300 mg TID × 7 days** (peds: 10 mg/kg/day divided TID)\n• **Doxycycline** (anti-resorptive option): 100 mg BID × 7 days — **only for age ≥12 years**. IADT 2020 does NOT recommend tetracyclines under 12 due to risk of permanent tooth discoloration. [1]\n\n**Tetanus:** Update if >5 years since last dose or dirty wound\n\n**Mouth care:**\n• Chlorhexidine 0.12% rinse BID × 1 week\n• Soft foods only\n• No chewing on reimplanted tooth\n\n**Follow-up:**\n• **Dental within 24-48 hours** — MANDATORY\n• Root canal typically needed within 2-4 weeks (mature/closed-apex teeth)\n• Long-term: ~50% survive 5+ years even with optimal care\n\n**Return precautions:** Increased looseness, fever, worsening pain',
        recommendation: 'Amoxicillin 500 mg TID × 7 days first-line (IADT 2020); doxycycline only if age ≥12. Tetanus update, mandatory dental follow-up 24-48h.',
        confidence: 'definitive',
        citation: [1, 2, 9],
        treatment: {
            firstLine: {
                drug: 'Amoxicillin',
                dose: '500 mg (adult) or 25 mg/kg/day divided (peds)',
                route: 'PO',
                frequency: 'TID',
                duration: '7 days',
                notes: 'IADT 2020 first-line (all ages). Penicillin/amoxicillin preferred over tetracyclines.',
            },
            alternative: {
                drug: 'Doxycycline (age ≥12 only)',
                dose: '100 mg',
                route: 'PO',
                frequency: 'BID',
                duration: '7 days',
                notes: 'Anti-resorptive option. NOT for age <12 — risk of permanent tooth discoloration. Clindamycin 300 mg TID if PCN-allergic.',
            },
            monitoring: 'Mandatory dental follow-up 24-48h. Root canal typically needed within 2-4 weeks.',
        },
        summary: 'Avulsion: amoxicillin 500 mg TID × 7d first-line (IADT 2020); doxycycline only if ≥12yo; tetanus; dental follow-up 24-48h',
    },
    // =====================================================================
    // MODULE 6: SPLINTING
    // =====================================================================
...
export const DENTAL_TRAUMA_CITATIONS = [
