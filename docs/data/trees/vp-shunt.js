...
export const VP_SHUNT_NODES = [
    ...
    },
    {
        ...
        summary: 'Cushing triad or pupil changes = impending herniation; caregiver concern for "like previous malfunction" is reliable',
    ...
    },
    {
        ...
        next: 'vps-imaging',
        summary: 'Pump reservoir to assess patency; shunt pumping has poor sensitivity/specificity — do not rely on it alone',
    },
    // =====================================================================
    ...
    },
    {
        ...
        summary: 'If high clinical suspicion persists despite normal imaging, consult neurosurgery — exam may be more reliable',
    },
    {
        ...
        images: [
            { src: 'images/vp-shunt/vp-shunt-pseudocyst-ultrasound.jpg', alt: 'Abdominal ultrasound showing a large intra-abdominal CSF pseudocyst around the distal ventriculoperitoneal shunt catheter', caption: 'Abdominal ultrasound showing large intra-abdominal pseudocyst around a VP shunt. Meyer et al. CC BY 4.0.' },
        ],
        citation: [1, 2, 6, 12, 14, 15, 16],
        next: 'vps-nsgy-consult',
    ...
    },
    {
        ...
        summary: 'Serum CBC/CRP/cultures; half of infected shunts have negative CSF cultures but positive hardware cultures',
    },
    {
    ...
    },
    {
        ...
        citation: [10, 11],
        next: 'vps-icp-medications',
        summary: 'Tiered ICP management: foundation (HOB, sedation), escalation (HTS, mild hyperventilation), refractory (barbiturate coma)',
    },
    {
        ...
        summary: '3% HTS preferred (can give peripherally); mannitol alternative (monitor osm <320); acetazolamide for adjunct only',
    },
    // =====================================================================
    // MODULE 5: SHUNT TAP
    // =====================================================================
    {
        ...
        summary: 'Ideally neurosurgery performs tap; EP may tap if critically ill and neurosurgery unavailable',
    },
    {
    ...
    },
    {
        ...
        citation: [1, 2, 7],
        next: 'vps-nsgy-consult',
        summary: 'Normal pressure 8-12mmHg; >15 = elevated; no flow = proximal obstruction; WBC >10 = concerning for infection',
    },
    // =====================================================================
    ...
    // =====================================================================
    {
        ...
        citation: [1, 2],
        next: 'vps-evd',
        summary: 'All suspected malfunction needs neurosurgery; provide imaging, neuro exam, shunt tap results, current interventions',
    },
    {
        id: 'vps-evd',
        type: 'info',
        ...
        summary: 'EVD temporizes while awaiting shunt revision; typical height 10-15 cmH2O; monitor hourly neuro checks and ICP',
        skippable: true,
    },
    {
        ...
        citation: [1, 2, 3],
        next: 'vps-intubation',
        summary: 'Slit ventricle syndrome: chronic overdrainage, positional headaches; MRI can reset programmable valve settings',
        skippable: true,
    },
    {
        id: 'vps-intubation',
    ...
    // =====================================================================
    {
        ...
        summary: 'ICU for herniation/EVD/declining status; floor for stable patients awaiting surgery; discharge is rare',
    },
    {
        id: 'vps-observation',
        type: 'info',
        ...
        citation: [1, 2],
        next: 'vps-summary',
        summary: 'Neuro checks q2-4h; minimum 24h observation; clear neurosurgery follow-up 24-72h before any discharge',
    },
    {
        ...
        citation: [10, 11],
        next: 'vps-summary',
        summary: 'ICU: continuous tele, arterial line if unstable, ICP via EVD, avoid high PEEP, NPO for surgery prep',
    },
    {
        id: 'vps-transfer',
        type: 'info',
        ...
        citation: [1, 2],
        next: 'vps-summary',
        summary: 'Secure airway, begin HTS, physician-to-physician handoff; send imaging, labs, and intervention details',
    },
    {
        id: 'vps-summary',
        type: 'result',
...
// Evidence Citations
// -------------------------------------------------------------------
export const VP_SHUNT_CITATIONS = [
