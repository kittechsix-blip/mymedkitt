...
export const ACUTE_MONOARTHRITIS_HUB_CRITICAL_ACTIONS = [
    { text: 'Exclude the SEPTIC joint in EVERY acute monoarthritis \u2014 arthrocentesis is the pivotal test; do not delay drainage.', nodeId: 'mono-exc-septic' },
...
export const ACUTE_MONOARTHRITIS_HUB_CITATIONS = [
    ...
    { num: 2, text: 'Long B, Koyfman A, Gottlieb M. Evaluation and Management of Septic Arthritis and its Mimics in the Emergency Department. West J Emerg Med. 2019;20(2):331-341.' },
    { num: 3, text: 'Osmon DR, Berbari EF, Berendt AR, et al. Diagnosis and management of prosthetic joint infection: clinical practice guidelines by the Infectious Diseases Society of America. Clin Infect Dis. 2013;56(1):e1-e25.' },
    { num: 4, text: 'St. Cyr S, Barbee L, Workowski KA, et al. Update to CDC\u2019s Treatment Guidelines for Gonococcal Infection, 2020. MMWR Morb Mortal Wkly Rep. 2020;69(50):1911-1916.' },
    { num: 5, text: 'FitzGerald JD, Dalbeth N, Mikuls T, et al. 2020 American College of Rheumatology Guideline for the Management of Gout. Arthritis Care Res. 2020;72(6):744-760.' },
    { num: 6, text: 'Lantos PM, Rumbaugh J, Bockenstedt LK, et al. Clinical Practice Guidelines for the Prevention, Diagnosis and Treatment of Lyme Disease. Clin Infect Dis. 2021;72(1):e1-e48.' },
    { num: 7, text: 'Genes N, Chisolm-Straker M. Monoarticular arthritis update: current evidence for diagnosis and treatment in the emergency department. Emerg Med Pract. 2012;14(5):1-19.' },
];
