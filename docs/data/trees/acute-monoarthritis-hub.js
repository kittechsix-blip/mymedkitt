...
export const ACUTE_MONOARTHRITIS_HUB_NODES = [
    // ============================================================
    // Module 1 — Sick Check
    // ============================================================
    {
    ...
    },
    {
        ...
        body: 'In endemic areas, Lyme disease is a cause of subacute/recurrent monoarthritis (classically a large joint, especially the knee) weeks to months after a tick bite \u2014 often with a large effusion but relatively modest pain. [6]\n\n**Recognize:**\n- Endemic exposure (Northeast/upper Midwest US, parts of Europe), prior erythema migrans or flu-like illness, recurrent knee swelling.\n- The effusion can be large; systemic toxicity is usually mild.\n\n**Next steps:**\n- **Two-tier Lyme serology** (ELISA \u2192 confirmatory immunoblot); Lyme is a late manifestation, so serology is usually strongly positive.\n- **If the joint is acutely hot / the patient is febrile, still arthrocentesis to exclude septic arthritis** \u2014 do not let \u201cLyme\u201d cause you to miss a bacterial joint.\n- **Treatment (once Lyme confirmed) \u2014 28 days of oral antibiotics, not the 10-14 days used for early Lyme.** Synovium and synovial fluid are hard for antibiotics to penetrate, which is why the course is longer. [6]\n  - **Doxycycline 100 mg PO BID \u00d7 28 days** \u2014 preferred, adults and children \u22658 years.\n  - **Amoxicillin 500 mg PO TID \u00d7 28 days** \u2014 alternative; the choice for children <8 years, pregnancy, or doxycycline intolerance.\n  - **Cefuroxime axetil 500 mg PO BID \u00d7 28 days** \u2014 second-line if neither above is tolerable.\n  - Pediatric: amoxicillin 50 mg/kg/day divided TID (max 500 mg/dose); cefuroxime 30 mg/kg/day divided BID (max 500 mg/dose); doxycycline 4 mg/kg/day divided BID (max 100 mg/dose) if \u22658 years.\n  - **Oral is the initial route of choice** unless there are concomitant neurologic abnormalities. If minimal/no response after the 28 days, IV ceftriaxone for 2-4 more weeks is considered \u2014 but joint inflammation resolves slowly even after the organism is cleared, so waiting several months before a second course is reasonable. Rheumatology for persistent post-antibiotic synovitis.\n\n\ud83d\uded1 Do not diagnose Lyme arthritis on exposure alone in a hot, febrile joint \u2014 exclude infection with a tap first. \ud83d\uded1 A negative Lyme serology in established Lyme arthritis is unusual \u2014 reconsider the diagnosis if seronegative.',
        recommendation: 'Consider Lyme for subacute recurrent knee monoarthritis in endemic areas; send two-tier serology. If acutely hot/febrile, tap to exclude septic arthritis first. Treat confirmed Lyme arthritis with 28 days of oral doxycycline 100 mg BID (or amoxicillin 500 mg TID) - longer than the 10-14 days used for early Lyme.',
        confidence: 'recommended',
        citation: [6],
    },
    // ============================================================
...
export const ACUTE_MONOARTHRITIS_HUB_CITATIONS = [
