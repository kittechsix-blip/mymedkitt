...
// and Acute Care (8th ed.), Ch. 30 "Local and Topical Anesthesia" and Ch. 64
// "Regional Nerve Blocks of the Head and Neck"; Tintinalli regional anesthesia;
// NYSORA head-and-neck block descriptions.
//
...
export const FACIAL_NERVE_BLOCK_NODES = [
    // ============================================================
...
export const FACIAL_NERVE_BLOCK_CRITICAL_ACTIONS = [
    ...
    { text: 'Calculate the maximum weight-based LA dose before drawing up — especially for high-volume ear ring blocks or when combining with infiltration.', nodeId: 'fnb-contra' },
    { text: 'ASPIRATE before every injection — the face is densely vascular (angular, infraorbital, superficial temporal, inferior alveolar vessels).', nodeId: 'fnb-shared-technique' },
    ...
    { text: 'For periorbital blocks (supraorbital, infratrochlear), keep the needle on the orbital rim and direct away from the globe.', nodeId: 'fnb-supraorbital' },
...
export const FACIAL_NERVE_BLOCK_CITATIONS = [
    ...
    { num: 2, text: 'Roberts JR, Custalow CB, Thomsen TW, eds. Roberts and Hedges\u2019 Clinical Procedures in Emergency Medicine and Acute Care. 8th ed. Philadelphia: Elsevier; 2023. Ch. 30, Local and Topical Anesthesia.' },
    { num: 3, text: 'Tintinalli JE, et al., eds. Tintinalli\u2019s Emergency Medicine: A Comprehensive Study Guide. 9th ed. New York: McGraw-Hill; 2020. Local and Regional Anesthesia.' },
    ...
    { num: 6, text: 'Salam GA. Regional anesthesia for office procedures: part I. Head and neck surgeries. Am Fam Physician. 2004;69(3):585-590.' },
    { num: 7, text: 'Eccles S, Voß T, et al. Anatomy of the infratrochlear nerve and its relevance to periorbital procedures. Clin Anat. 2018;31(1):46-52. (Confirm latest at citation-freeze step.)' },
    { num: 8, text: 'Lynch MT, Syverud SA, Schwab RA, Jenkins JM, Edlich R. Comparison of intraoral and percutaneous approaches for infraorbital nerve block. Acad Emerg Med. 1994;1(6):514-519.' },
    { num: 9, text: 'Han SK, Shin YW, Kim WK. Anatomy of the external nasal branch of the anterior ethmoidal nerve. Plast Reconstr Surg. 2004;114(5):1153-1156. (Confirm latest at citation-freeze step.)' },
    { num: 10, text: 'Syverud SA, Jenkins JM, Schwab RA, Lynch MT, Knoop K, Trott A. A comparative study of the percutaneous versus intraoral technique for mental nerve block. Acad Emerg Med. 1994;1(6):509-513.' },
    { num: 11, text: 'Malamed SF. Handbook of Local Anesthesia. 7th ed. St. Louis: Elsevier; 2020. Inferior Alveolar Nerve Block.' },
    { num: 12, text: 'NYSORA. Regional Anesthesia of the Head and Neck \u2014 Auriculotemporal Nerve Block. New York School of Regional Anesthesia. (Confirm current edition at citation-freeze step.)' },
    { num: 13, text: 'Sanchez TR, Quinn MR, et al. Auricular nerve blocks: ring block of the external ear. Emerg Med Clin North Am \u2014 wound and laceration management. (Confirm primary source at citation-freeze step per PLAN.md \u00a713a.)' },
    { num: 14, text: 'Weinberg GL. Lipid emulsion infusion: resuscitation for local anesthetic and other drug overdose. Anesthesiology. 2012;117(1):180-187.' },
];
