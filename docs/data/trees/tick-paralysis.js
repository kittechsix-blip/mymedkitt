...
export const TICK_PARALYSIS_NODES = [
    // =====================================================================
    ...
    // =====================================================================
    {
        ...
        images: [{
                src: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 240" font-family="sans-serif">'
    ...
    // =====================================================================
    {
        ...
        images: [{
                src: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 200" font-family="sans-serif">'
...
// Evidence Citations
// -------------------------------------------------------------------
export const TICK_PARALYSIS_CITATIONS = [
