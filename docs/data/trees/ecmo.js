...
export const ECMO_CRITICAL_ACTIONS = [
    ...
    { text: 'RESP score >3 predicts 75% survival on VV-ECMO | <-2 predicts 18% survival - use for triage', nodeId: 'ecmo-scores' },
