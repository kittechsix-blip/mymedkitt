...
export const CARDIOGENIC_SHOCK_CRITICAL_ACTIONS = [
    ...
    { text: 'ICU admission required for all cardiogenic shock patients', nodeId: 'cs-disposition' },
];
export const CARDIOGENIC_SHOCK_NODES = [
    // =====================================================================
...
export const CARDIOGENIC_SHOCK_CITATIONS = [
