...
// 28 nodes total.
export const CO_TOXICITY_CRITICAL_ACTIONS = [
    ...
    { text: 'Consider cyanide co-exposure in fire/smoke inhalation victims', nodeId: 'co-fire' },
    { text: 'Arrange hyperbaric oxygen (HBO) for severe cases: AMS, loss of consciousness, pregnancy, COHb >25%', nodeId: 'co-hbo-criteria' },
...
export const CO_TOXICITY_NODES = [
    // =====================================================================
...
export const CO_TOXICITY_CITATIONS = [
