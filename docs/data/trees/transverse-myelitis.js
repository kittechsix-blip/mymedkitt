...
export const TRANSVERSE_MYELITIS_NODES = [
    // =====================================================================
    ...
    // =====================================================================
    {
        ...
        images: [{
                src: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 260" font-family="sans-serif">'
    ...
    // =====================================================================
    {
        ...
        images: [{
                src: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 440 240" font-family="sans-serif">'
    ...
    // =====================================================================
    {
        ...
        images: [{
                src: 'data:image/svg+xml;utf8,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460 200" font-family="sans-serif">'
