...
import { clearPatientContext, subscribeToPatientContext, formatPatientContext, } from '../services/patient-context.js';
let headerContainer = null;
let unsubscribe = null;
// ---------------------------------------------------------------------------
// Render (call once when calculator view mounts)
// ---------------------------------------------------------------------------
export function renderStickyPatientHeader(parent) {
  ...
  `;
    ...
    const clearBtn = headerContainer.querySelector('.sticky-patient-clear');
...
// ---------------------------------------------------------------------------
export function cleanupStickyPatientHeader() {
    if (unsubscribe) {
        unsubscribe();
        unsubscribe = null;
    }
...
// ---------------------------------------------------------------------------
export function toggleStickyPatientHeader() {
    if (!headerContainer)
        return;
