...
Generated from myMedKitt `src/data` (registry: `scripts/tree-registry.mjs`). Disclaimer **v1.0**, effective **2026-05-29**. Specialties covered: Anesthesia / Airway, Cardiology, EM, GI (Gastroenterology), Heme/Onc, Infectious Disease, Med-Calc, Nephrology / Rheumatology / Endocrinology, Neurology/Neurosurgery, OB/GYN, Ophthalmology, Ortho, Pediatrics, Pharmacist, Pharmacy, Procedures, Psychiatry, Pulm/Critical Care, Toxicology, Trauma/Surg, U/S-Rads, Urology.
