...
const TREE_REGISTRY = {
  ...
  'pneumonia':            { prefix: 'PNEUMONIA',              entryNodeId: 'pna-start',      categoryId: 'infectious-disease' },
  ...
  'post-tonsillectomy-bleed': { prefix: 'PTH',                entryNodeId: 'pth-start',      categoryId: 'pediatrics' },
  ...
  'ear-fb':               { prefix: 'EAR_FB',               entryNodeId: 'earfb-start',      categoryId: 'procedures' },
