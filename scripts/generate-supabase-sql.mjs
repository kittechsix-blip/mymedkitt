...
const CROSS_LISTINGS = {
  ...
  'dysuria-hub': [{ categoryId: 'urology', displayTitle: null, displaySubtitle: null, entryNodeId: 'dys-start' }],
  'painless-scrotal-swelling-hub': [{ categoryId: 'urology', displayTitle: null, displaySubtitle: null, entryNodeId: 'psm-sick-check' }],
  'unilateral-leg-swelling-hub': [{ categoryId: 'vascular', displayTitle: null, displaySubtitle: null, entryNodeId: 'uls-sick-check' }],
  'generalized-pruritus-hub': [{ categoryId: 'dermatology', displayTitle: null, displaySubtitle: null, entryNodeId: 'prur-sick-check' }],
  'proximal-weakness-hub': [{ categoryId: 'neurology', displayTitle: null, displaySubtitle: null, entryNodeId: 'pmw-sick-check' }],
  'behavior-change-hub': [{ categoryId: 'psychiatry', displayTitle: null, displaySubtitle: null, entryNodeId: 'beh-sick-check' }],
  'otalgia-hub': [{ categoryId: 'ent', displayTitle: null, displaySubtitle: null, entryNodeId: 'otalgia-sick-check' }],
  ...
  'peds-electrolyte-emergencies': [{ categoryId: 'emergency-medicine' }],
  ...
  'wrist-injuries': [{ categoryId: 'procedures' }],
  'ct-decision-support': [{ categoryId: 'emergency-medicine' }],
  'cardiac-arrest':      [{ categoryId: 'cardiology' }],
