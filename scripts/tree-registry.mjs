...
export const TREE_REGISTRY = {
  ...
  'acetaminophen':    { prefix: 'ACETAMINOPHEN',       entryNodeId: 'apap-start',         categoryId: 'toxicology' },
  ...
  'suicide-risk-assessment': { prefix: 'SUICIDE_RISK_ASSESSMENT', entryNodeId: 'sra-start', categoryId: 'em' },
